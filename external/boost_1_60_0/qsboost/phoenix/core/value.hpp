...
==============================================================================*/
#ifndef QSBOOST_PHOENIX_CORE_VALUE_HPP
#define QSBOOST_PHOENIX_CORE_VALUE_HPP
...
#include <qsboost/phoenix/core/is_value.hpp>
  ...
  // In which case why is it here?
    ...
    struct custom_terminal<actor<Expr> >
    {
        ...
        struct result<This(Actor, Context)>
            : qsboost::remove_const<
                    typename qsboost::remove_reference<
        ...
        operator()(actor<Expr> const & expr, Context & ctx) const
        {
          ...
          result_type r = qsboost::phoenix::eval(expr, ctx);
