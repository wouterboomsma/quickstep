...
==============================================================================*/
#ifndef QSBOOST_PHOENIX_CORE_ENVIRONMENT_HPP
#define QSBOOST_PHOENIX_CORE_ENVIRONMENT_HPP
...
namespace qsboost { namespace phoenix 
{
        ...
        struct env
        {
            typedef
                typename fusion::result_of::at_c<
                    typename qsboost::remove_reference<Context>::type
                  , 0
                >::type
                type;
        };
        ...
        : proto::transform_impl<Expr, State, proto::empty_env>
    {
            typedef
                typename fusion::result_of::at_c<
                    typename qsboost::remove_reference<State>::type
                  , 0
                >::type
                result_type;
    ...
    #define M0(Z, N, D)                                                         \
        ...
        struct make_env<QSBOOST_PHOENIX_A(N)>                                     \
        {                                                                       \
            typedef QSBOOST_PP_CAT(vector, N)<QSBOOST_PHOENIX_A(N)> type;           \
        };                                                                      \
    /**/
...
#define M0(Z, N, D)                                                             \
    template <QSBOOST_PHOENIX_typename_A(N)>                                      \
    inline                                                                      \
    typename result_of::make_env<QSBOOST_PHOENIX_A_ref(N)>::type                  \
    make_env(QSBOOST_PHOENIX_A_ref_a(N))                                          \
    {                                                                           \
        typename result_of::make_env<QSBOOST_PHOENIX_A_ref(N)>::type              \
            env =                                                               \
            {                                                                   \
    ...
    template <QSBOOST_PHOENIX_typename_A(N)>                                      \
    inline                                                                      \
    typename result_of::make_env<QSBOOST_PHOENIX_A_const_ref(N)>::type            \
    make_env(QSBOOST_PHOENIX_A_const_ref_a(N))                                    \
    {                                                                           \
        typename result_of::make_env<QSBOOST_PHOENIX_A_const_ref(N)>::type        \
            env =                                                               \
            {                                                                   \
