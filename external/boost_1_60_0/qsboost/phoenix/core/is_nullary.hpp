...
==============================================================================*/
#ifndef QSBOOST_PHOENIX_CORE_IS_NULLARY_HPP
#define QSBOOST_PHOENIX_CORE_IS_NULLARY_HPP
...
namespace qsboost { namespace phoenix
{
    ...
    {
        QSBOOST_PROTO_TRANSFORM(is_nullary::when<rule::argument>)
    ...
    {
        QSBOOST_PROTO_TRANSFORM(is_nullary::when<rule::custom_terminal>)
    ...
    {
        QSBOOST_PROTO_TRANSFORM(is_nullary::when<rule::terminal>)
        template <typename Expr, typename State, typename Data>
        struct impl
        {
    ...
    namespace result_of
    {
        ...
        struct is_nullary
            : qsboost::phoenix::evaluator::impl<
                Expr const &
              , vector2<
                    mpl::true_
                  , qsboost::phoenix::is_nullary
                >
              , proto::empty_env
            >::result_type
        {};
        ...
        template <typename T>
        struct is_nullary<custom_terminal<qsboost::reference_wrapper<actor<T> > > >
        {
            QSBOOST_PROTO_TRANSFORM(is_nullary<custom_terminal<qsboost::reference_wrapper<actor<T> > > >)
            template <typename Expr, typename State, typename Data>
            struct impl
            {
        ...
        template <typename T>
        struct is_nullary<custom_terminal<qsboost::reference_wrapper<actor<T> const> > >
        {
            QSBOOST_PROTO_TRANSFORM(is_nullary<custom_terminal<qsboost::reference_wrapper<actor<T> const> > >)
            template <typename Expr, typename State, typename Data>
            struct impl
            {
