...
==============================================================================*/
#ifndef QSBOOST_PHOENIX_CORE_META_GRAMMAR_HPP
#define QSBOOST_PHOENIX_CORE_META_GRAMMAR_HPP
...
#include <qsboost/proto/transform/default.hpp>
...
namespace qsboost { namespace phoenix
{
    ...
    struct evaluator
    {
        QSBOOST_PROTO_TRANSFORM(evaluator)
    ...
    namespace result_of
    {
        ...
        struct eval
            : qsboost::result_of< ::qsboost::phoenix::evaluator(Expr, Context)>
        {};
    }
