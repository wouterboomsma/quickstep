...
==============================================================================*/
#ifndef QSBOOST_PHOENIX_SCOPE_LOCAL_VARIABLE_HPP
#define QSBOOST_PHOENIX_SCOPE_LOCAL_VARIABLE_HPP

#include <qsboost/phoenix/core/limits.hpp>
#include <qsboost/phoenix/core/call.hpp>
#include <qsboost/phoenix/core/expression.hpp>
#include <qsboost/phoenix/core/reference.hpp>
#include <qsboost/phoenix/core/value.hpp>
#include <qsboost/phoenix/scope/scoped_environment.hpp>
#include <qsboost/phoenix/scope/detail/local_variable.hpp>
#include <qsboost/phoenix/statement/sequence.hpp>
...
namespace qsboost { namespace phoenix
{
    ...
    namespace detail
    {
        struct scope_is_nullary_actions
        {
            ...
            struct when
                : qsboost::phoenix::is_nullary::when<Rule, Dummy>
            {};
        };

        template <typename Dummy>
        struct scope_is_nullary_actions::when<qsboost::phoenix::rule::custom_terminal, Dummy>
            : proto::or_<
                proto::when<qsboost::phoenix::rule::local_variable, mpl::true_()>
              , proto::otherwise<
                    is_nullary::when<qsboost::phoenix::rule::custom_terminal, Dummy>
                >
            >
        {};
