...
#ifndef QSBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
#define QSBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
...
namespace iterators {
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public qsboost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    qsboost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
...
#if !QSBOOST_WORKAROUND(__MWERKS__, QSBOOST_TESTED_AT(0x3003))
        // don't provide this constructor if UnaryFunc is a
        // function pointer type, since it will be 0.  Too dangerous.
        QSBOOST_STATIC_ASSERT(is_class<UnaryFunc>::value);
#endif
    }
