...
#ifndef QSBOOST_VARIANT_STATIC_VISITOR_HPP
#define QSBOOST_VARIANT_STATIC_VISITOR_HPP
...
template <typename R = ::qsboost::detail::static_visitor_default_return>
...
protected: // for use as base class only
    ...
    ~static_visitor() = default;
#else
    static_visitor()  QSBOOST_NOEXCEPT { }
    ~static_visitor()  QSBOOST_NOEXCEPT { }
#endif
};
...
template< typename T > struct is_static_visitor
	: public ::qsboost::integral_constant<bool,(::qsboost::detail::is_static_visitor_impl<T>::value)>
{
public:
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_static_visitor,(T))
};
