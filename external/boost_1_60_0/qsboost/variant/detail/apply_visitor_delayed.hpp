...
#ifndef QSBOOST_VARIANT_DETAIL_APPLY_VISITOR_DELAYED_HPP
#define QSBOOST_VARIANT_DETAIL_APPLY_VISITOR_DELAYED_HPP

#include "qsboost/variant/detail/generic_result_type.hpp"

#include "qsboost/variant/detail/apply_visitor_unary.hpp"
#include "qsboost/variant/detail/apply_visitor_binary.hpp"
...
public: // structors
    ...
    explicit apply_visitor_delayed_t(Visitor& visitor) QSBOOST_NOEXCEPT
      : visitor_(visitor)
    {
    }
    ...
    >::type apply_visitor(Visitor& visitor)
{
    ...
    && !defined(QSBOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
...
public: // structors
    ...
    explicit apply_visitor_delayed_cpp14_t(Visitor& visitor) QSBOOST_NOEXCEPT
      : visitor_(visitor)
    {
    }
...
template <typename Visitor>
inline  typename qsboost::disable_if<
        qsboost::detail::variant::has_result_type<Visitor>,
