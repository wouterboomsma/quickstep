...
#ifndef QSBOOST_VARIANT_DETAIL_GENERIC_RESULT_TYPE_HPP
#define QSBOOST_VARIANT_DETAIL_GENERIC_RESULT_TYPE_HPP
...
#define QSBOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(T) \
    T   \
    /**/

#define QSBOOST_VARIANT_AUX_RETURN_VOID  \
    /**/

#define QSBOOST_VARIANT_AUX_RETURN_VOID_TYPE \
    void    \
    /**/
...
#define QSBOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(T) \
    QSBOOST_DEDUCED_TYPENAME                                           \
        ::qsboost::detail::variant::no_void_returns_helper< T >::type  \
    /**/

#define QSBOOST_VARIANT_AUX_RETURN_VOID  \
    return ::qsboost::detail::variant::fake_return_void()     \
    /**/

#define QSBOOST_VARIANT_AUX_RETURN_VOID_TYPE  \
    ::qsboost::detail::variant::fake_return_void
