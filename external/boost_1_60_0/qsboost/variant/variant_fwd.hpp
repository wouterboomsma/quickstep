...
#ifndef QSBOOST_VARIANT_VARIANT_FWD_HPP
#define QSBOOST_VARIANT_VARIANT_FWD_HPP
...
//
 ...
 && !defined(QSBOOST_VARIANT_NO_REFERENCE_SUPPORT)
#   define QSBOOST_VARIANT_NO_REFERENCE_SUPPORT
#endif
...
#   define QSBOOST_VARIANT_NO_TYPE_SEQUENCE_SUPPORT
#endif
...
#include "qsboost/variant/detail/substitute_fwd.hpp"
  ...
  && !defined(QSBOOST_VARIANT_NO_FULL_RECURSIVE_VARIANT_SUPPORT)
#   define QSBOOST_VARIANT_NO_FULL_RECURSIVE_VARIANT_SUPPORT
#endif
...
*/
  ...
  || defined(QSBOOST_NO_USING_DECLARATION_OVERLOADS_FROM_TYPENAME_BASE) \
  || defined (QSBOOST_VARIANT_NO_TYPE_SEQUENCE_SUPPORT)

#ifndef QSBOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES
#   define QSBOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES
#endif
...
#define QSBOOST_VARIANT_CLASS_OR_TYPENAME_TO_SEQ_class class)(
#define QSBOOST_VARIANT_CLASS_OR_TYPENAME_TO_SEQ_typename typename)(

#define QSBOOST_VARIANT_CLASS_OR_TYPENAME_TO_VARIADIC_class class...
#define QSBOOST_VARIANT_CLASS_OR_TYPENAME_TO_VARIADIC_typename typename...

#define ARGS_VARIADER_1(x) x ## N...
#define ARGS_VARIADER_2(x) QSBOOST_VARIANT_CLASS_OR_TYPENAME_TO_VARIADIC_ ## x ## N

#define QSBOOST_VARIANT_MAKE_VARIADIC(sequence, x)        QSBOOST_VARIANT_MAKE_VARIADIC_I(QSBOOST_PP_SEQ_SIZE(sequence), x)
#define QSBOOST_VARIANT_MAKE_VARIADIC_I(argscount, x)     QSBOOST_VARIANT_MAKE_VARIADIC_II(argscount, x)
#define QSBOOST_VARIANT_MAKE_VARIADIC_II(argscount, orig) ARGS_VARIADER_ ## argscount(orig)
...
#define QSBOOST_VARIANT_ENUM_PARAMS(x) \
    x ## 0, \
    QSBOOST_VARIANT_MAKE_VARIADIC( (QSBOOST_VARIANT_CLASS_OR_TYPENAME_TO_SEQ_ ## x), x) \
    /**/

#define QSBOOST_VARIANT_ENUM_SHIFTED_PARAMS(x) \
    QSBOOST_VARIANT_MAKE_VARIADIC( (QSBOOST_VARIANT_CLASS_OR_TYPENAME_TO_SEQ_ ## x), x) \
    /**/
...
#define QSBOOST_VARIANT_LIMIT_TYPES \
    QSBOOST_MPL_LIMIT_LIST_SIZE
...
//
#include "qsboost/mpl/limits/arity.hpp"
#define QSBOOST_VARIANT_RECURSIVE_VARIANT_MAX_ARITY \
...
//
#define QSBOOST_VARIANT_ENUM_PARAMS( param )  \
    QSBOOST_PP_ENUM_PARAMS(QSBOOST_VARIANT_LIMIT_TYPES, param)
...
//
#define QSBOOST_VARIANT_ENUM_SHIFTED_PARAMS( param )  \
    QSBOOST_PP_ENUM_SHIFTED_PARAMS(QSBOOST_VARIANT_LIMIT_TYPES, param)
...
#define QSBOOST_VARIANT_DETAIL_DEFINE_VOID_N(z,N,_)          \
    struct QSBOOST_PP_CAT(void,N);                           \
                                                           \
    template <>                                            \
    struct convert_void< QSBOOST_PP_CAT(void,N) >            \
    {                                                      \
        typedef mpl::na type;                              \
    };                                                     \
    /**/
...
QSBOOST_PP_REPEAT(
    ...
    , QSBOOST_VARIANT_DETAIL_DEFINE_VOID_N
    , _
    )

#undef QSBOOST_VARIANT_DETAIL_DEFINE_VOID_N
...
#if !defined(QSBOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
#   define QSBOOST_VARIANT_AUX_DECLARE_PARAMS QSBOOST_VARIANT_ENUM_PARAMS(typename T)
#else // defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
...
#   define QSBOOST_VARIANT_AUX_DECLARE_PARAMS_IMPL(z, N, T) \
    typename QSBOOST_PP_CAT(T,N) = detail::variant::void_ \
    /**/

#else // defined(BOOST_NO_USING_DECLARATION_OVERLOADS_FROM_TYPENAME_BASE)

#   define QSBOOST_VARIANT_AUX_DECLARE_PARAMS_IMPL(z, N, T) \
    typename QSBOOST_PP_CAT(T,N) = QSBOOST_PP_CAT(detail::variant::void,N) \
    /**/

#endif // BOOST_NO_USING_DECLARATION_OVERLOADS_FROM_TYPENAME_BASE workaround

#define QSBOOST_VARIANT_AUX_DECLARE_PARAMS \
    QSBOOST_PP_ENUM( \
          QSBOOST_VARIANT_LIMIT_TYPES \
        , QSBOOST_VARIANT_AUX_DECLARE_PARAMS_IMPL \
        , T \
        ) \
    /**/
...
//
template < QSBOOST_VARIANT_AUX_DECLARE_PARAMS > class variant;
...
//
template < QSBOOST_VARIANT_AUX_DECLARE_PARAMS > struct make_recursive_variant;

#undef QSBOOST_VARIANT_AUX_DECLARE_PARAMS_IMPL
#undef QSBOOST_VARIANT_AUX_DECLARE_PARAMS
