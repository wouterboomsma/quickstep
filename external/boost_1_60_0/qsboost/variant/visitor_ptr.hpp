...
#ifndef QSBOOST_VARIANT_VISITOR_PTR_HPP
#define QSBOOST_VARIANT_VISITOR_PTR_HPP

#include "qsboost/variant/bad_visit.hpp"
...
public: // structors
    ...
    explicit visitor_ptr_t(visitor_t visitor) QSBOOST_NOEXCEPT
      : visitor_(visitor)
    {
    }
...
public: // static visitor interfaces
    ...
    {
        qsboost::throw_exception(bad_visit());
    }
