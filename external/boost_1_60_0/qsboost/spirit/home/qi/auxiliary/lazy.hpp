...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_LAZY_MARCH_27_2007_1002AM)
#define QSBOOST_SPIRIT_LAZY_MARCH_27_2007_1002AM
...
#include <qsboost/spirit/home/support/lazy.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    struct lazy_parser : parser<lazy_parser<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                qsboost::result_of<qi_modify(tag::lazy_eval, Modifiers)>::type
            modifier;

            typedef typename
                remove_reference<
                    typename qsboost::result_of<Function(unused_type, Context)>::type
                >::type
            expr_type;
            ...
            // expression.
            QSBOOST_SPIRIT_ASSERT_MATCH(qi::domain, expr_type);
