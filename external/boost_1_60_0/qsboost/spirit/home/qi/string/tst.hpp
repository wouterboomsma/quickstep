...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_TST_JUNE_03_2007_1031AM)
#define QSBOOST_SPIRIT_TST_JUNE_03_2007_1031AM

#if defined(_MSC_VER)
#pragma once
#endif

#include <qsboost/spirit/home/qi/string/detail/tst.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    private:
        ...
        T* new_data(typename qsboost::call_traits<T>::param_type val)
        {
            return new T(val);
        }
