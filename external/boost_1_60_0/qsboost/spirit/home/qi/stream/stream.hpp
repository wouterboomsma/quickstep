...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_STREAM_MAY_05_2007_1228PM)
#define QSBOOST_SPIRIT_STREAM_MAY_05_2007_1228PM
...
#include <qsboost/spirit/home/qi/stream/detail/match_manip.hpp>
#include <qsboost/spirit/home/qi/stream/detail/iterator_source.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
      ...
      : primitive_parser<stream_parser<Char, T> >
    {
          ...
          , Attribute& attr_) const
        {
            ...
            typedef qsboost::iostreams::stream<source_device> instream;
