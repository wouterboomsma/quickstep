...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_ITERATOR_ISTREAM_MAY_05_2007_0110PM)
#define QSBOOST_SPIRIT_ITERATOR_ISTREAM_MAY_05_2007_0110PM

#if defined(_MSC_VER)
#pragma once
#endif

#include <qsboost/iostreams/stream.hpp>
...
namespace qsboost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct iterator_source
    {
        ...
        char_type;
        typedef qsboost::iostreams::seekable_device_tag category;
        ...
        {
            QSBOOST_ASSERT(false);    // not supported
            return -1;
        }

        std::streampos seek(qsboost::iostreams::stream_offset, std::ios_base::seekdir way)
        {
            QSBOOST_ASSERT(way == std::ios_base::cur);    // only support queries
