...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_MATCH_MANIP_MAY_05_2007_1203PM)
#define QSBOOST_SPIRIT_MATCH_MANIP_MAY_05_2007_1203PM
...
#include <qsboost/spirit/home/support/iterators/istream_iterator.hpp>
...
namespace qsboost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct match_manip
    {
        ...
        QSBOOST_SPIRIT_ASSERT_MSG(!CopyExpr::value || !CopyAttr::value
        ...
        match_manip(Expr const& xpr, Skipper const& s
            , QSBOOST_SCOPED_ENUM(skip_flag) ps, Attribute& a)
          : expr(xpr), skipper(s), attr(a), post_skip(ps) {}

        Expr const& expr;
        Skipper const& skipper;
        Attribute& attr;
        QSBOOST_SCOPED_ENUM(skip_flag) const post_skip;
