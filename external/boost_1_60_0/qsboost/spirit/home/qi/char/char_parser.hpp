...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_CHAR_PARSER_APR_16_2006_0906AM)
#define QSBOOST_SPIRIT_CHAR_PARSER_APR_16_2006_0906AM
...
namespace qsboost { namespace spirit { namespace traits // classification
{
    namespace detail
    {
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(char_parser_id)
    }
