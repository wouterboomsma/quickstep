...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_CHAR_CLASS_APRIL_16_2006_1051AM)
#define QSBOOST_SPIRIT_CHAR_CLASS_APRIL_16_2006_1051AM
...
#include <qsboost/spirit/home/support/modify.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    // same name
    namespace ascii { using namespace qsboost::spirit::ascii; }
    namespace iso8859_1 { using namespace qsboost::spirit::iso8859_1; }
    namespace standard { using namespace qsboost::spirit::standard; }
    namespace standard_wide { using namespace qsboost::spirit::standard_wide; }
#if defined(QSBOOST_SPIRIT_UNICODE)
    namespace unicode { using namespace qsboost::spirit::unicode; }
#endif
    ...
    using namespace qsboost::spirit::standard;
