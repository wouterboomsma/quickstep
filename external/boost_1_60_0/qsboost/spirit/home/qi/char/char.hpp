...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_CHAR_APRIL_16_2006_1051AM)
#define QSBOOST_SPIRIT_CHAR_APRIL_16_2006_1051AM
...
#include <qsboost/spirit/home/support/string_traits.hpp>
#include <qsboost/spirit/home/support/info.hpp>
#include <qsboost/spirit/home/support/detail/get_encoding.hpp>
#include <qsboost/spirit/home/support/char_set/basic_chset.hpp>
#include <qsboost/spirit/home/qi/char/char_parser.hpp>
#include <qsboost/spirit/home/qi/char/char_class.hpp>
#include <qsboost/spirit/home/qi/meta_compiler.hpp>
#include <qsboost/spirit/home/qi/auxiliary/lazy.hpp>
#include <qsboost/spirit/home/qi/detail/enable_lit.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
      ...
      : char_parser<char_range<CharEncoding, false>, typename CharEncoding::char_type>
    {
        ...
        info what(Context& /*context*/) const
        {
            ...
            qsboost::get<std::string>(result.value) += '-';
            qsboost::get<std::string>(result.value) += to_utf8(char_encoding::toucs4(to));
            return result;
        }
      ...
      : char_parser<char_range<CharEncoding, true>, typename CharEncoding::char_type>
    {
        ...
        info what(Context& /*context*/) const
        {
            ...
            qsboost::get<std::string>(result.value) += '-';
            qsboost::get<std::string>(result.value) += to_utf8(char_encoding::toucs4(to_lo));
            return result;
        }
