...
#include <qsboost/spirit/home/qi/detail/permute_function.hpp>
#include <qsboost/spirit/home/qi/detail/attributes.hpp>
#include <qsboost/spirit/home/support/algorithm/any_if_ns.hpp>
#include <qsboost/spirit/home/support/detail/what_function.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    struct permutation : nary_parser<permutation<Elements> >
    {
          ...
          , Attribute& attr_) const
        {
            ...
            qsboost::array<bool, fusion::result_of::size<Elements>::value> flags;
            QSBOOST_FOREACH(bool& taken, flags)
            {
                taken = false;
            }
