...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_PARSER_OCTOBER_16_2008_0254PM)
#define QSBOOST_SPIRIT_PARSER_OCTOBER_16_2008_0254PM
...
namespace qsboost { namespace spirit { namespace traits // classification
{
    namespace detail
    {
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(parser_id)
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(primitive_parser_id)
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(nary_parser_id)
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(unary_parser_id)
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(binary_parser_id)
    }
