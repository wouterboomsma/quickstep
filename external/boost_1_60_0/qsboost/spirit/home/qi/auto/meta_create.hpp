...
#if !defined(QSBOOST_SPIRIT_QI_META_CREATE_NOV_21_2009_0432PM)
#define QSBOOST_SPIRIT_QI_META_CREATE_NOV_21_2009_0432PM
...
#include <qsboost/spirit/home/support/auto/meta_create.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    // optional
    template <typename T>
    struct meta_create<qsboost::optional<T> >
    {
        typedef make_unary_proto_expr<
    ...
    struct meta_create<qsboost::variant<QSBOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        typedef make_nary_proto_expr<
            typename qsboost::variant<QSBOOST_VARIANT_ENUM_PARAMS(T)>::types
    ...
    template <>
    struct meta_create<qsboost::long_long_type>
    {
        typedef spirit::long_long_type type;
        static type call() { return type(); }
    };
    template <>
    struct meta_create<qsboost::ulong_long_type>
    {
