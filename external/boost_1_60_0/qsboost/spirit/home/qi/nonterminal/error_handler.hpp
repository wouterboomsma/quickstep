...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_ERROR_HANDLER_APRIL_29_2007_1042PM)
#define QSBOOST_SPIRIT_ERROR_HANDLER_APRIL_29_2007_1042PM
...
#include <qsboost/spirit/home/support/multi_pass_wrapper.hpp>
            ...
            for(;;)
            {
                ...
                catch (expectation_failure<Iterator> const& x)
                {
                    ...
                    switch (r)
                    {
                        ...
                        case rethrow: qsboost::throw_exception(x);
                    }
                }
            }
            return false;
