...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_PARAMETERIZED_AUGUST_09_2009_0539AM)
#define QSBOOST_SPIRIT_PARAMETERIZED_AUGUST_09_2009_0539AM
...
namespace qsboost { namespace spirit { namespace qi
{
      ...
      : parser<parameterized_nonterminal<Subject, Params> >
    {
        ...
        qsboost::reference_wrapper<Subject const> ref;
        Params params;
    };
}}}
