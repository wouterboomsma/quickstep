...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_DEBUG_HANDLER_DECEMBER_05_2008_0734PM)
#define QSBOOST_SPIRIT_DEBUG_HANDLER_DECEMBER_05_2008_0734PM
...
#include <qsboost/spirit/home/qi/nonterminal/rule.hpp>
#include <qsboost/spirit/home/qi/nonterminal/debug_handler_state.hpp>
#include <qsboost/spirit/home/qi/operator/expect.hpp>
#include <qsboost/function.hpp>
#include <qsboost/fusion/include/at.hpp>
#include <qsboost/fusion/include/vector.hpp>
#include <qsboost/fusion/include/out.hpp>
#include <iostream>
...
#if !defined(QSBOOST_SPIRIT_DEBUG_NODE)
  #if defined(QSBOOST_SPIRIT_DEBUG) || defined(QSBOOST_SPIRIT_QI_DEBUG)
    #define QSBOOST_SPIRIT_DEBUG_NODE(r)  r.name(#r); debug(r)
  #else
    #define QSBOOST_SPIRIT_DEBUG_NODE(r)  r.name(#r)
  #endif
#endif

#define QSBOOST_SPIRIT_DEBUG_NODE_A(r, _, name)                                   \
    QSBOOST_SPIRIT_DEBUG_NODE(name);                                              \
    /***/

#define QSBOOST_SPIRIT_DEBUG_NODES(seq)                                           \
    QSBOOST_PP_SEQ_FOR_EACH(QSBOOST_SPIRIT_DEBUG_NODE_A, _, seq)                    \
    /***/
