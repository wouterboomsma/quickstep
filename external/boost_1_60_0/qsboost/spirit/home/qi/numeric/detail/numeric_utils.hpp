...
#include <qsboost/spirit/home/support/numeric_traits.hpp>
...
#include <qsboost/integer_traits.hpp>
...
#define QSBOOST_SPIRIT_LOG2 (#error)(#error)                                    \
...
#define QSBOOST_PP_LOCAL_MACRO(Radix)                                           \
    template <typename T> struct digits_traits<T, Radix>                      \
    {                                                                         \
        typedef std::numeric_limits<T> numeric_limits_type;                   \
        QSBOOST_STATIC_CONSTANT(int, value = static_cast<int>(                  \
            (numeric_limits_type::digits * 1000000) /                         \
                QSBOOST_PP_SEQ_ELEM(Radix, QSBOOST_SPIRIT_LOG2)));                \
    };                                                                        \
    /***/

#define QSBOOST_PP_LOCAL_LIMITS (2, 36)
#include QSBOOST_PP_LOCAL_ITERATE()

#undef QSBOOST_SPIRIT_LOG2
    ...
    {
        QSBOOST_STATIC_CONSTEXPR T value = Val; 
    };
    ...
    struct positive_accumulator
    {
        ...
        inline static bool add(T& n, Char ch, mpl::true_) // checked add
        {
            ...
            typedef constexpr_int<T, qsboost::integer_traits<T>::const_max> max;
    ...
    struct negative_accumulator
    {
        ...
        inline static bool add(T& n, Char ch, mpl::true_) // checked subtract
        {
            ...
            typedef constexpr_int<T, qsboost::integer_traits<T>::const_min> min;
...
# pragma warning(disable: 4127)   // conditional expression is constant
          ...
          , Attribute& attr)
        {
            ...
            typedef typename
                qsboost::detail::iterator_traits<Iterator>::value_type
            char_type;
