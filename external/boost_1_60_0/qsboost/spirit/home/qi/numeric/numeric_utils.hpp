...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_NUMERIC_UTILS_APRIL_17_2006_0830AM)
#define QSBOOST_SPIRIT_NUMERIC_UTILS_APRIL_17_2006_0830AM
...
#include <qsboost/spirit/home/qi/numeric/detail/numeric_utils.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    extract_sign(Iterator& first, Iterator const& last)
    {
        ...
        QSBOOST_ASSERT(first != last); // precondition
