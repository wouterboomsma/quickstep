...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_INT_APR_17_2006_0830AM)
#define QSBOOST_SPIRIT_INT_APR_17_2006_0830AM
...
#include <qsboost/spirit/home/qi/numeric/numeric_utils.hpp>
...
namespace qsboost { namespace spirit
{
    ...
    struct use_terminal<qi::domain
        , terminal_ex<tag::lit, fusion::vector1<A0> >
        , typename enable_if<is_same<A0, qsboost::long_long_type> >::type>
      : mpl::true_ {};
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    struct make_primitive<
          terminal_ex<tag::lit, fusion::vector1<A0> >
        , Modifiers, typename enable_if<is_same<A0, qsboost::long_long_type> >::type>
      : make_literal_int<qsboost::long_long_type> {};
#endif
    ...
    struct make_primitive<tag::long_long, Modifiers>
      : make_int<qsboost::long_long_type> {};
    //]
    ...
    struct make_primitive<
      ...
      , fusion::vector1<A0> > , Modifiers>
      : make_direct_int<qsboost::long_long_type> {};
#endif
}}}
