...
#include <qsboost/spirit/home/qi/operator/kleene.hpp>
...
#include <qsboost/spirit/home/qi/detail/fail_function.hpp>
#include <qsboost/spirit/home/qi/detail/pass_container.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    struct finite_iterator // handles repeat(min, max)[p]
    {
        finite_iterator(T const min_, T const max_)
          : min QSBOOST_PREVENT_MACRO_SUBSTITUTION (min_)
          , max QSBOOST_PREVENT_MACRO_SUBSTITUTION (max_) {}
