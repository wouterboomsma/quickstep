...
namespace qsboost { namespace spirit { namespace qi { namespace detail
{
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
                Container, ValueType, qsboost::optional<Attribute>, Sequence>
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, qsboost::optional<ValueType>, qsboost::optional<Attribute>
          , Sequence>
    ...
    template <typename Container, typename ValueType, typename Sequence
      , typename T>
    struct pass_through_container<Container, ValueType, qsboost::variant<T>
          , Sequence>
    ...
    struct pass_through_container<Container, ValueType
          , qsboost::variant<T0, TN...>, Sequence>
      : mpl::bool_<pass_through_container<
            Container, ValueType, T0, Sequence
            >::type::value || pass_through_container<
                Container, ValueType, qsboost::variant<TN...>, Sequence
            >::type::value>
    {};
#else
#define QSBOOST_SPIRIT_PASS_THROUGH_CONTAINER(z, N, _)                          \
    pass_through_container<Container, ValueType,                              \
        QSBOOST_PP_CAT(T, N), Sequence>::type::value ||                         \
    /***/

    // make sure unused variant parameters do not affect the outcome
    template <typename Container, typename ValueType, typename Sequence>
    struct pass_through_container<Container, ValueType
          , qsboost::detail::variant::void_, Sequence>
      : mpl::false_
    {};
    ...
    struct pass_through_container<Container, ValueType
          , qsboost::variant<QSBOOST_VARIANT_ENUM_PARAMS(T)>, Sequence>
      : mpl::bool_<QSBOOST_PP_REPEAT(QSBOOST_VARIANT_LIMIT_TYPES
          , QSBOOST_SPIRIT_PASS_THROUGH_CONTAINER, _) false>
    {};

#undef QSBOOST_SPIRIT_PASS_THROUGH_CONTAINER
#endif
}}}}
