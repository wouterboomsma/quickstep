...
=============================================================================*/
#if !defined(QSBOOST_SPIRIT_ASSIGN_TO_APR_16_2006_0812PM)
#define QSBOOST_SPIRIT_ASSIGN_TO_APR_16_2006_0812PM

#if defined(_MSC_VER)
#pragma once
#endif

#include <qsboost/spirit/home/qi/detail/construct.hpp>
...
#include <qsboost/fusion/include/copy.hpp>
...
namespace qsboost { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        ...
        template <typename I>
        struct is_iter_range<qsboost::iterator_range<I> > : mpl::true_ {};
    ...
    template <typename Attribute, typename Iterator>
    struct assign_to_attribute_from_iterators<
        qsboost::optional<Attribute>, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last
          , qsboost::optional<Attribute>& attr)
        {
            Attribute val;
    ...
    template <typename Attribute, typename T>
    struct assign_to_attribute_from_value<Attribute, qsboost::optional<T>
      , typename disable_if<is_same<Attribute, qsboost::optional<T> > >::type>
    {
        static void
        call(qsboost::optional<T> const& val, Attribute& attr)
        {
            assign_to(val.get(), attr);
        }
    };
    ...
    template <typename Attribute, typename T>
    struct assign_to_container_from_value<Attribute, qsboost::optional<T>
      , typename disable_if<is_same<Attribute, qsboost::optional<T> > >::type>
    {
        static void
        call(qsboost::optional<T> const& val, Attribute& attr)
