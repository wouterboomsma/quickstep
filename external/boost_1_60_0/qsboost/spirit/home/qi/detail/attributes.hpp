...
#include <qsboost/spirit/home/support/utree/utree_traits_fwd.hpp>
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    template <typename Exposed, typename Transformed>
    struct transform_attribute<qsboost::optional<Exposed>, Transformed
      , typename disable_if<is_same<qsboost::optional<Exposed>, Transformed> >::type>
    {
        typedef Transformed& type;
        static Transformed& pre(qsboost::optional<Exposed>& val)
        {
            if (!val)
                val = Transformed();
            return qsboost::get<Transformed>(val);
        }
        static void post(qsboost::optional<Exposed>&, Transformed const&) {}
        static void fail(qsboost::optional<Exposed>& val)
        {
