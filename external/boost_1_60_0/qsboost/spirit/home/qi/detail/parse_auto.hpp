...
=============================================================================*/
#if !defined(QSBOOST_SPIRIT_DETAIL_PARSE_AUTO_DEC_02_2009_0426PM)
#define QSBOOST_SPIRIT_DETAIL_PARSE_AUTO_DEC_02_2009_0426PM
...
namespace qsboost { namespace spirit { namespace qi { namespace detail
{
        ...
        >::type>
    {
        ...
        static bool call(Iterator& first, Iterator last, Expr& expr
          , Skipper const& skipper, QSBOOST_SCOPED_ENUM(skip_flag) post_skip)
        {
...
namespace qsboost { namespace spirit { namespace qi
{
    ...
    phrase_parse(
      ...
      , QSBOOST_SCOPED_ENUM(skip_flag) post_skip = skip_flag::postskip)
    {
        // Make sure the iterator is at least a forward_iterator. If you got a 
        // compilation error here, then you are using an input_iterator while
        // calling this function, you need to supply at least a 
