...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_RANGE_RUN_MAY_16_2006_0801_PM)
#define QSBOOST_SPIRIT_RANGE_RUN_MAY_16_2006_0801_PM

#if defined(_MSC_VER)
#pragma once
#endif

#include <qsboost/spirit/home/support/char_set/range.hpp>
#include <vector>

namespace qsboost { namespace spirit { namespace support { namespace detail
{
    ///////////////////////////////////////////////////////////////////////////
    //  range_run
    //
...
#include <qsboost/spirit/home/support/char_set/range_run_impl.hpp>
#endif
