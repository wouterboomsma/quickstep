...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_ATTRIBUTES_JANUARY_29_2007_0954AM)
#define QSBOOST_SPIRIT_ATTRIBUTES_JANUARY_29_2007_0954AM
...
#include <qsboost/spirit/home/support/attributes_fwd.hpp>
#include <qsboost/spirit/home/support/container.hpp>
#include <qsboost/spirit/home/support/detail/hold_any.hpp>
#include <qsboost/spirit/home/support/detail/as_variant.hpp>
#include <qsboost/optional/optional.hpp>
#include <qsboost/fusion/include/transform.hpp>
#include <qsboost/fusion/include/filter_if.hpp>
...
#include <qsboost/fusion/include/is_sequence.hpp>
#include <qsboost/fusion/include/for_each.hpp>
#include <qsboost/fusion/include/is_view.hpp>
#include <qsboost/fusion/include/mpl.hpp>
#include <qsboost/foreach.hpp>
#include <qsboost/utility/value_init.hpp>
...
//        {};
    ...
    template <typename T, typename Expected>
    struct is_weak_substitute<qsboost::variant<T>, Expected>
      : is_weak_substitute<T, Expected>
    {};

    template <typename T0, typename T1, typename ...TN, typename Expected>
    struct is_weak_substitute<qsboost::variant<T0, T1, TN...>,
            Expected>
      : mpl::bool_<is_weak_substitute<T0, Expected>::type::value &&
            is_weak_substitute<qsboost::variant<T1, TN...>, Expected>::type::value>
    {};
#else
#define QSBOOST_SPIRIT_IS_WEAK_SUBSTITUTE(z, N, _)                              \
    is_weak_substitute<QSBOOST_PP_CAT(T, N), Expected>::type::value &&          \
    /***/

    // make sure unused variant parameters do not affect the outcome
    template <typename Expected>
    struct is_weak_substitute<qsboost::detail::variant::void_, Expected>
      : mpl::true_
    {};

    template <QSBOOST_VARIANT_ENUM_PARAMS(typename T), typename Expected>
    struct is_weak_substitute<
            qsboost::variant<QSBOOST_VARIANT_ENUM_PARAMS(T)>, Expected>
      : mpl::bool_<QSBOOST_PP_REPEAT(QSBOOST_VARIANT_LIMIT_TYPES
          , QSBOOST_SPIRIT_IS_WEAK_SUBSTITUTE, _) true>
    {};

#undef QSBOOST_SPIRIT_IS_WEAK_SUBSTITUTE
#endif
    ...
    namespace detail
    {
        ...
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(adapted_variant_tag)
    }
    ...
    template <QSBOOST_VARIANT_ENUM_PARAMS(typename T), typename Domain>
    struct not_is_variant<qsboost::variant<QSBOOST_VARIANT_ENUM_PARAMS(T)>, Domain>
      : mpl::false_
    {};

    template <typename T, typename Domain>
    struct not_is_variant<qsboost::optional<T>, Domain>
    ...
    template <typename T>
    struct variant_type<qsboost::optional<T> >
      : variant_type<T>
    {};
    ...
    namespace detail
    {
        ...
        template <typename Expected, typename Attribute>
        struct attribute_is_compatible<Expected, qsboost::optional<Attribute> >
          : is_convertible<Attribute, Expected>
        {};
    ...
    namespace detail
    {
        QSBOOST_MPL_HAS_XXX_TRAIT_DEF(types)
    }
    ...
    struct variant_which<qsboost::variant<QSBOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        static int call(qsboost::variant<QSBOOST_VARIANT_ENUM_PARAMS(T)> const& v)
        {
            return v.which();
        }
    };
    ...
    template <typename T, typename Domain>
    struct not_is_optional<qsboost::optional<T>, Domain>
      : mpl::false_
    {};
    ...
    template <QSBOOST_VARIANT_ENUM_PARAMS(typename T)>
    struct attribute_size<variant<QSBOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        typedef std::size_t type;

        static type call(variant<QSBOOST_VARIANT_ENUM_PARAMS(T)> const& val)
        {
    ...
    {
        typedef typename qsboost::detail::iterator_traits<Iterator>::
            difference_type type;

        static type call(iterator_range<Iterator> const& r)
        {
            return qsboost::detail::distance(r.begin(), r.end());
        }
    };
    ...
    {
        typedef qsboost::optional<T> type;
    };

    template <typename T>
    struct build_optional<qsboost::optional<T> >
    {
        typedef qsboost::optional<T> type;
    };
    ...
    pre_transform(Exposed& attr QSBOOST_PROTO_DISABLE_IF_IS_CONST(Exposed))
    {
    ...
    struct make_attribute
    {
        ...
        static Attribute call(unused_type)
        {
            ...
            return qsboost::get(value_initialized<attribute_type>());
        }
    ...
    // optionals
    template <typename T>
    struct clear_value<qsboost::optional<T> >
    {
        static void call(qsboost::optional<T>& val)
        {
            if (val)
    ...
    // variants
    template <QSBOOST_VARIANT_ENUM_PARAMS(typename T)>
    struct clear_value<variant<QSBOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        static void call(variant<QSBOOST_VARIANT_ENUM_PARAMS(T)>& val)
        {
    ...
    struct print_attribute_debug<Out, qsboost::optional<T> >
    {
        static void call(Out& out, qsboost::optional<T> const& val)
        {
            if (val)
                spirit::traits::print_attribute(out, *val);
            else
