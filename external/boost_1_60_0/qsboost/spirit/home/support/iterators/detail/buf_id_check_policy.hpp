...
#if !defined(QSBOOST_SPIRIT_ITERATOR_BUF_ID_CHECK_POLICY_MAR_16_2007_1108AM)
#define QSBOOST_SPIRIT_ITERATOR_BUF_ID_CHECK_POLICY_MAR_16_2007_1108AM
        ...
        struct unique //: detail::default_checking_policy
        {
            ...
            static void docheck(MultiPass const& mp) 
            {
                if (mp.buf_id != mp.shared()->shared_buf_id)
                    qsboost::throw_exception(illegal_backtracking());
            }
