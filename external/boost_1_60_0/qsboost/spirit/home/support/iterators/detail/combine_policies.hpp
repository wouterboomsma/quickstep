...
#if !defined(QSBOOST_SPIRIT_ITERATOR_COMBINE_POLICIES_APR_06_2008_0136PM)
#define QSBOOST_SPIRIT_ITERATOR_COMBINE_POLICIES_APR_06_2008_0136PM
...
namespace qsboost { namespace spirit { namespace iterator_policies
{
    ...
    template <typename T
      ...
      , bool OwnershipIsEmpty = qsboost::is_empty<Ownership>::value
      , bool CheckingIsEmpty = qsboost::is_empty<Checking>::value
      , bool InputIsEmpty = qsboost::is_empty<Input>::value>
    ...
    struct default_policy
    {
        ...
        struct unique : multi_pass_unique<T
          ...
          , typename Input::QSBOOST_NESTED_TEMPLATE unique<T>
          , typename Storage::QSBOOST_NESTED_TEMPLATE unique<
                typename Input::QSBOOST_NESTED_TEMPLATE unique<T>::value_type> >
        {
            typedef typename Ownership::unique ownership_policy;
            typedef typename Checking::unique checking_policy;
            typedef typename Input::QSBOOST_NESTED_TEMPLATE unique<T>
                input_policy;
            typedef typename Storage::QSBOOST_NESTED_TEMPLATE unique<
        ...
        struct shared : multi_pass_shared<T
          ...
          , typename Input::QSBOOST_NESTED_TEMPLATE shared<T>
          , typename Storage::QSBOOST_NESTED_TEMPLATE shared<
                typename Input::QSBOOST_NESTED_TEMPLATE unique<T>::value_type> >
        {
            typedef typename Ownership::shared ownership_policy;
            typedef typename Checking::shared checking_policy;
            typedef typename Input::QSBOOST_NESTED_TEMPLATE shared<T>
                input_policy;
            typedef typename Storage::QSBOOST_NESTED_TEMPLATE shared<
                typename Input::QSBOOST_NESTED_TEMPLATE unique<T>::value_type>
            storage_policy;
