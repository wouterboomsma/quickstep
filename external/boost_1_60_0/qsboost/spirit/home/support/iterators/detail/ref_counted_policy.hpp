...
#if !defined(QSBOOST_SPIRIT_ITERATOR_REF_COUNTED_POLICY_MAR_16_2007_1108AM)
#define QSBOOST_SPIRIT_ITERATOR_REF_COUNTED_POLICY_MAR_16_2007_1108AM
...
#include <qsboost/detail/atomic_count.hpp>
#endif
#include <cstdlib>
...
#if defined(QSBOOST_HAS_THREADS)
            qsboost::detail::atomic_count count;
#else
            std::size_t count;
#endif
        };
