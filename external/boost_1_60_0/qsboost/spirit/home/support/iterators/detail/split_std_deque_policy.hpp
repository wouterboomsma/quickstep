...
#if !defined(QSBOOST_SPIRIT_ITERATOR_SPLIT_DEQUE_POLICY_APR_06_2008_0138PM)
#define QSBOOST_SPIRIT_ITERATOR_SPLIT_DEQUE_POLICY_APR_06_2008_0138PM
...
namespace qsboost { namespace spirit { namespace iterator_policies
{
    ...
    struct split_std_deque
    {
        ...
        protected:
            ...
            void swap(unique& x)
            {
                qsboost::swap(queued_position, x.queued_position);
            }
            ...
            dereference(MultiPass const& mp)
            {
                ...
                QSBOOST_ASSERT(mp.queued_position <= size);
