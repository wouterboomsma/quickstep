...
#if !defined(QSBOOST_SPIRIT_ITERATOR_MULTI_PASS_MAR_16_2007_1124AM)
#define QSBOOST_SPIRIT_ITERATOR_MULTI_PASS_MAR_16_2007_1124AM
...
namespace qsboost { namespace spirit
{
    ...
    class multi_pass
      : private qsboost::base_from_member<
            typename Policies::QSBOOST_NESTED_TEMPLATE shared<T>*>
      , public Policies::QSBOOST_NESTED_TEMPLATE unique<T>
    {
    private:
        // unique and shared data types
        typedef typename Policies::QSBOOST_NESTED_TEMPLATE unique<T>
            policies_base_type;
        typedef typename Policies::QSBOOST_NESTED_TEMPLATE shared<T>
            shared_data_type;

        typedef qsboost::base_from_member<shared_data_type*> member_base;
    ...
    public:
        ...
        {
            qsboost::swap(this->member, x.member);
        ...
        void clear_queue(QSBOOST_SCOPED_ENUM(traits::clear_mode) mode =
    ...
    namespace traits
    {
        ...
        void clear_queue(multi_pass<T, Policies>& mp
          , QSBOOST_SCOPED_ENUM(traits::clear_mode) mode)
        {
            mp.clear_queue(mode);
        }
