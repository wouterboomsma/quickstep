...
=============================================================================*/
#if !defined(QSBOOST_SPIRIT_STANDARD_WIDE_NOVEMBER_10_2006_0913AM)
#define QSBOOST_SPIRIT_STANDARD_WIDE_NOVEMBER_10_2006_0913AM
...
namespace qsboost { namespace spirit { namespace traits
{
    ...
    struct wchar_t_size
    {
        QSBOOST_SPIRIT_ASSERT_MSG(N == 1 || N == 2 || N == 4,
...
namespace qsboost { namespace spirit { namespace char_encoding
{
    ...
    struct standard_wide
    {
        ...
        static bool
        isblank QSBOOST_PREVENT_MACRO_SUBSTITUTION (wchar_t ch)
        {
            return (ch == L' ' || ch == L'\t');
        }
