...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_UNICODE_QUERY_FEBRUARY_2_2010)
#define QSBOOST_SPIRIT_UNICODE_QUERY_FEBRUARY_2_2010
...
namespace qsboost { namespace spirit { namespace ucd
{
    ...
    inline bool is_graph(::qsboost::uint32_t ch)
    {
        return !(   is_white_space(ch)
    ...
    inline bool is_print(::qsboost::uint32_t ch)
    {
        return (is_graph(ch) || is_blank(ch)) && !is_control(ch);
    }

    inline bool is_noncharacter_code_point(::qsboost::uint32_t ch)
    {
        return (detail::category_lookup(ch) & properties::noncharacter_code_point) != 0;
    }

    inline bool is_default_ignorable_code_point(::qsboost::uint32_t ch)
    {
        return (detail::category_lookup(ch) & properties::default_ignorable_code_point) != 0;
    }

    inline properties::script get_script(::qsboost::uint32_t ch)
    {
        return static_cast<properties::script>(detail::script_lookup(ch) & 0x7F);
    }

    inline ::qsboost::uint32_t to_lowercase(::qsboost::uint32_t ch)
    {
        // The table returns 0 to signal that this code maps to itself
        ::qsboost::uint32_t r = detail::lowercase_lookup(ch);
        return (r == 0)? ch : r;
    }

    inline ::qsboost::uint32_t to_uppercase(::qsboost::uint32_t ch)
    {
        // The table returns 0 to signal that this code maps to itself
        ::qsboost::uint32_t r = detail::uppercase_lookup(ch);
        return (r == 0)? ch : r;
    }
}}}
