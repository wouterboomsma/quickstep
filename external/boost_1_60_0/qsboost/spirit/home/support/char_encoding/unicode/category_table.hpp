...
{
    static const ::qsboost::uint8_t category_stage1[] = {
    ...
    static const ::qsboost::uint16_t category_stage2[] = {
    ...
    inline ::qsboost::uint16_t category_lookup(::qsboost::uint32_t ch)
    {
        ::qsboost::uint32_t block_offset = category_stage1[ch / 256] * 256;
