...
{
    static const ::qsboost::uint8_t lowercase_stage1[] = {
    ...
    static const ::qsboost::uint32_t lowercase_stage2[] = {
    ...
    inline ::qsboost::uint32_t lowercase_lookup(::qsboost::uint32_t ch)
    {
        ::qsboost::uint32_t block_offset = lowercase_stage1[ch / 256] * 256;
