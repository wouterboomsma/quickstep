...
================================================_==============================*/
#if !defined(QSBOOST_SPIRIT_STRING_TRAITS_OCTOBER_2008_1252PM)
#define QSBOOST_SPIRIT_STRING_TRAITS_OCTOBER_2008_1252PM
...
// gcc 3.x.x has problems resolving ambiguities here
    ...
    get_begin(Str& str QSBOOST_PROTO_DISABLE_IF_IS_CONST(Str))
    { return str.begin(); }
    ...
    template <typename T, typename Str>
    inline typename Str::iterator
    get_end(Str& str QSBOOST_PROTO_DISABLE_IF_IS_CONST(Str))
    { return str.end(); }
