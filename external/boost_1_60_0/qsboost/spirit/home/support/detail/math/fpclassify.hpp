...
#ifndef QSBOOST_SPIRIT_MATH_FPCLASSIFY_HPP
#define QSBOOST_SPIRIT_MATH_FPCLASSIFY_HPP
...
template<class T> bool (isinf)(T x)
{
    typedef QSBOOST_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::isinf_impl(x, QSBOOST_DEDUCED_TYPENAME traits::coverage());
}
...
template<class T> bool (isnan)(T x)
{
    typedef QSBOOST_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::isnan_impl(x, QSBOOST_DEDUCED_TYPENAME traits::coverage());
}
...
template<class T> int (fpclassify)(T x)
{
    typedef QSBOOST_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::fpclassify_impl(x, QSBOOST_DEDUCED_TYPENAME traits::coverage());
}
