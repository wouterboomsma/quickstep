...
#include <qsboost/spirit/home/support/detail/math/fpclassify.hpp>
#include <qsboost/spirit/home/support/detail/math/signbit.hpp>
#else
...
namespace qsboost { namespace spirit { namespace detail
{
    ...
    {
        return (qsboost::spirit::math::signbit)(x);
    }

    template<typename T> 
    inline T (changesign)(T x)
    {
        return (qsboost::spirit::math::changesign)(x);
    }
#else
    template<typename T> 
    inline bool (signbit)(T x)
    {
        return (qsboost::math::signbit)(x) ? true : false;
    }
