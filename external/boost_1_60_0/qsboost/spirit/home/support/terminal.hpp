...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_TERMINAL_NOVEMBER_04_2008_0906AM)
#define QSBOOST_SPIRIT_TERMINAL_NOVEMBER_04_2008_0906AM
...
#include <qsboost/spirit/include/phoenix_function.hpp>
#include <qsboost/proto/proto.hpp>
#include <qsboost/spirit/home/support/meta_compiler.hpp>
#include <qsboost/spirit/home/support/detail/make_vector.hpp>
...
#include <qsboost/spirit/home/support/terminal_expression.hpp>
...
namespace qsboost { namespace phoenix
{
    ...
    {
#ifndef QSBOOST_PHOENIX_NO_SPECIALIZE_CUSTOM_TERMINAL
...
#define QSBOOST_SPIRIT_TERMINAL_X(x, y) ((x, y)) QSBOOST_SPIRIT_TERMINAL_Y
#define QSBOOST_SPIRIT_TERMINAL_Y(x, y) ((x, y)) QSBOOST_SPIRIT_TERMINAL_X
#define QSBOOST_SPIRIT_TERMINAL_X0
#define QSBOOST_SPIRIT_TERMINAL_Y0

#ifndef QSBOOST_SPIRIT_NO_PREDEFINED_TERMINALS

#define QSBOOST_SPIRIT_TERMINAL_NAME(name, type_name)                             \
    namespace tag { struct name { QSBOOST_SPIRIT_IS_TAG() }; }                    \
    typedef qsboost::proto::terminal<tag::name>::type type_name;                  \
    type_name const name = {{}};                                                \
    inline void QSBOOST_PP_CAT(silence_unused_warnings_, name)() { (void) name; } \
    /***/
...
#define QSBOOST_SPIRIT_TERMINAL(name)                                             \
    QSBOOST_SPIRIT_TERMINAL_NAME(name, name ## _type)                             \
    /***/

#define QSBOOST_SPIRIT_DEFINE_TERMINALS_NAME_A(r, _, names)                       \
    QSBOOST_SPIRIT_TERMINAL_NAME(                                                 \
        QSBOOST_PP_TUPLE_ELEM(2, 0, names),                                       \
        QSBOOST_PP_TUPLE_ELEM(2, 1, names)                                        \
    )                                                                           \
    /***/

#define QSBOOST_SPIRIT_DEFINE_TERMINALS_NAME(seq)                                 \
    QSBOOST_PP_SEQ_FOR_EACH(QSBOOST_SPIRIT_DEFINE_TERMINALS_NAME_A, _,              \
        QSBOOST_PP_CAT(QSBOOST_SPIRIT_TERMINAL_X seq, 0))                           \
    /***/
...
#define QSBOOST_SPIRIT_TERMINAL_NAME_EX(name, type_name)                          \
    namespace tag { struct name { QSBOOST_SPIRIT_IS_TAG() }; }                    \
    typedef qsboost::spirit::terminal<tag::name> type_name;                       \
...
#define QSBOOST_SPIRIT_TERMINAL_EX(name)                                          \
    QSBOOST_SPIRIT_TERMINAL_NAME_EX(name, name ## _type)                          \
    /***/

#define QSBOOST_SPIRIT_DEFINE_TERMINALS_NAME_EX_A(r, _, names)                    \
    QSBOOST_SPIRIT_TERMINAL_NAME_EX(                                              \
        QSBOOST_PP_TUPLE_ELEM(2, 0, names),                                       \
        QSBOOST_PP_TUPLE_ELEM(2, 1, names)                                        \
    )                                                                           \
    /***/

#define QSBOOST_SPIRIT_DEFINE_TERMINALS_NAME_EX(seq)                              \
    QSBOOST_PP_SEQ_FOR_EACH(QSBOOST_SPIRIT_DEFINE_TERMINALS_NAME_EX_A, _,           \
        QSBOOST_PP_CAT(QSBOOST_SPIRIT_TERMINAL_X seq, 0))                           \
    /***/
