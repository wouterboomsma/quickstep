...
#if !defined(QSBOOST_SPIRIT_NUMERIC_TRAITS_JAN_07_2011_0722AM)
#define QSBOOST_SPIRIT_NUMERIC_TRAITS_JAN_07_2011_0722AM
...
namespace qsboost { namespace spirit { namespace traits
{
    ...
    template <>
    struct is_int<qsboost::long_long_type> : mpl::true_ {};
#endif
...
#ifdef QSBOOST_HAS_LONG_LONG
    template <>
    struct is_uint<qsboost::ulong_long_type> : mpl::true_ {};
#endif
