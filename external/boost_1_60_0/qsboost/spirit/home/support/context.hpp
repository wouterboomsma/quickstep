...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_CONTEXT_OCTOBER_31_2008_0654PM)
#define QSBOOST_SPIRIT_CONTEXT_OCTOBER_31_2008_0654PM
...
#include <qsboost/spirit/home/support/nonterminal/expand_arg.hpp>
...
#define SPIRIT_DECLARE_ATTRIBUTE(z, n, data)                                   \
    typedef phoenix::actor<attribute<n> >                                      \
        QSBOOST_PP_CAT(QSBOOST_PP_CAT(_r, n), _type);                              \
    phoenix::actor<attribute<n> > const                                        \
        QSBOOST_PP_CAT(_r, n) = QSBOOST_PP_CAT(QSBOOST_PP_CAT(_r, n), _type)();
    /***/
#define SPIRIT_USING_ATTRIBUTE(z, n, data)                                     \
    using spirit::QSBOOST_PP_CAT(QSBOOST_PP_CAT(_r, n), _type);                    \
    using spirit::QSBOOST_PP_CAT(_r, n);                                         \
    /***/
...
QSBOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , qsboost::spirit::local_variable<N>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            qsboost::spirit::local_variable<N>()
