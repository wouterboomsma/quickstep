...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_INFO_NOVEMBER_22_2008_1132AM)
#define QSBOOST_SPIRIT_INFO_NOVEMBER_22_2008_1132AM
...
#include <qsboost/variant/recursive_variant.hpp>
#include <qsboost/variant/apply_visitor.hpp>
#include <qsboost/foreach.hpp>
#include <qsboost/spirit/home/support/utf8.hpp>
#include <list>
#include <iterator>
#include <utility>
...
namespace qsboost { namespace spirit
{
    ...
    struct basic_info_walker
    {
        ...
        {
            callback.element(tag, "", depth);
            QSBOOST_FOREACH(info const& what, l)
            {
                qsboost::apply_visitor(
                    this_type(callback, what.tag, depth+1), what.value);
            }
    ...
    Out& operator<<(Out& out, info const& what)
    {
        ...
        qsboost::apply_visitor(walker, what.value);
        return out;
    }
}}
