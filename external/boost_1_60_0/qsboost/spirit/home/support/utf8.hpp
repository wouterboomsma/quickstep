...
==============================================================================*/
#if !defined(QSBOOST_SPIRIT_UC_TYPES_NOVEMBER_23_2008_0840PM)
#define QSBOOST_SPIRIT_UC_TYPES_NOVEMBER_23_2008_0840PM
...
#include <qsboost/regex/pending/unicode_iterator.hpp>
#include <qsboost/type_traits/make_unsigned.hpp>
#include <string>

namespace qsboost { namespace spirit
{
    typedef ::qsboost::uint32_t ucs4_char;
