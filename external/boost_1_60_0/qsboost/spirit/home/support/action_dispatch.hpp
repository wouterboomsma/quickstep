...
=============================================================================*/
#if !defined(QSBOOST_SPIRIT_ACTION_DISPATCH_APRIL_18_2008_0720AM)
#define QSBOOST_SPIRIT_ACTION_DISPATCH_APRIL_18_2008_0720AM
...
#if !defined(QSBOOST_NO_CXX11_RVALUE_REFERENCES) && !defined(QSBOOST_NO_CXX11_LAMBDAS) && \
    !defined(QSBOOST_NO_CXX11_VARIADIC_TEMPLATES) && !defined(QSBOOST_NO_CXX11_DECLTYPE)
#include <utility>
#include <type_traits>
#endif
...
#define QSBOOST_SPIRIT_FAKE_CALL(T) (*(T*)0)
        ...
        static auto do_call(F && f, fwd_tag<A>, ...)
           -> typename fwd_storage<decltype(f(QSBOOST_SPIRIT_FAKE_CALL(A)))
                 , fwd_attrib>::type
        {
            return {};
        }
        ...
        static auto do_call(F && f, fwd_tag<A>, fwd_tag<B>, ...)
           -> typename fwd_storage<
                    decltype(f(QSBOOST_SPIRIT_FAKE_CALL(A), QSBOOST_SPIRIT_FAKE_CALL(B)))
...
#undef QSBOOST_SPIRIT_FAKE_CALL
