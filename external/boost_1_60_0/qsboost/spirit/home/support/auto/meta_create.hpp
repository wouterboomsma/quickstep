...
#if !defined(QSBOOST_SPIRIT_SUPPORT_META_CREATE_NOV_21_2009_0327PM)
#define QSBOOST_SPIRIT_SUPPORT_META_CREATE_NOV_21_2009_0327PM
...
#include <qsboost/fusion/include/fold.hpp>
...
// problems with the following template specialization
            ...
            {
                QSBOOST_STATIC_ASSERT((is_same<F, nary_proto_expr_function>::value));
#else
