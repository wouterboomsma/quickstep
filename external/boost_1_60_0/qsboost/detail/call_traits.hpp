...
#ifndef QSBOOST_DETAIL_CALL_TRAITS_HPP
#define QSBOOST_DETAIL_CALL_TRAITS_HPP
...
public:
   ...
   typedef typename qsboost::detail::ct_imp<
      T,
      ::qsboost::is_pointer<T>::value,
      ::qsboost::is_arithmetic<T>::value,
      ::qsboost::is_enum<T>::value
...
#if QSBOOST_WORKAROUND( __BORLANDC__,  < 0x5A0 )
