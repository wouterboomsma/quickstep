#ifndef QSBOOST_SERIALIZATION_COLLECTION_SIZE_TYPE_HPP
#define QSBOOST_SERIALIZATION_COLLECTION_SIZE_TYPE_HPP
...
#include <qsboost/serialization/strong_typedef.hpp>
#include <qsboost/serialization/level.hpp>
#include <qsboost/serialization/split_free.hpp>
#include <qsboost/serialization/is_bitwise_serializable.hpp>
...
QSBOOST_CLASS_IMPLEMENTATION(collection_size_type, primitive_type)
QSBOOST_IS_BITWISE_SERIALIZABLE(collection_size_type)
