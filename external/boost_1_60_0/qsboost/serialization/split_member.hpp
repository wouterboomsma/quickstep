#ifndef QSBOOST_SERIALIZATION_SPLIT_MEMBER_HPP
#define QSBOOST_SERIALIZATION_SPLIT_MEMBER_HPP
...
#define QSBOOST_SERIALIZATION_SPLIT_MEMBER()                       \
template<class Archive>                                          \
void serialize(                                                  \
    Archive &ar,                                                 \
    const unsigned int file_version                              \
){                                                               \
    qsboost::serialization::split_member(ar, *this, file_version); \
}                                                                \
/**/
