#ifndef QSBOOST_SERIALIZATION_TRAITS_HPP
#define QSBOOST_SERIALIZATION_TRAITS_HPP
...
struct traits : public basic_traits {
    QSBOOST_STATIC_ASSERT(Version == 0 || Level >= object_class_info);
    QSBOOST_STATIC_ASSERT(Tracking == track_never || Level >= object_serializable);
