#ifndef QSBOOST_SERIALIZATION_FORCE_INCLUDE_HPP
#define QSBOOST_SERIALIZATION_FORCE_INCLUDE_HPP
...
#if defined(QSBOOST_HAS_DECLSPEC) && !defined(__COMO__)
#   define QSBOOST_DLLEXPORT __declspec(dllexport)
#elif ! defined(_WIN32) && ! defined(_WIN64)
#   if defined(__MWERKS__)
#       define QSBOOST_DLLEXPORT __declspec(dllexport)
#   elif defined(__GNUC__) && (__GNUC__ >= 3)
#       define QSBOOST_USED __attribute__ ((__used__))
#   elif defined(__IBMCPP__) && (__IBMCPP__ >= 1110)
#       define QSBOOST_USED __attribute__ ((__used__))
#   elif defined(__INTEL_COMPILER) && (QSBOOST_INTEL_CXX_VERSION >= 800)
#       define QSBOOST_USED __attribute__ ((__used__))
#   endif
#endif
...
#ifndef QSBOOST_DLLEXPORT
#    define QSBOOST_DLLEXPORT
#endif
