#ifndef QSBOOST_SERIALIZATION_WRAPPER_HPP
#define QSBOOST_SERIALIZATION_WRAPPER_HPP
...
namespace qsboost { namespace serialization {
...
struct is_wrapper_impl :
    qsboost::mpl::eval_if<
      qsboost::is_base_and_derived<basic_traits,T>,
      qsboost::mpl::true_,
      qsboost::mpl::false_
    >::type
{};
...
#define QSBOOST_CLASS_IS_WRAPPER(T)                       \
namespace qsboost {                                       \
namespace serialization {                               \
template<>                                              \
struct is_wrapper_impl<const T> : qsboost::mpl::true_ {}; \
}                                                       \
}                                                       \
/**/
