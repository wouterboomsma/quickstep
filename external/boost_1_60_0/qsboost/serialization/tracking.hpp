#ifndef QSBOOST_SERIALIZATION_TRACKING_HPP
#define QSBOOST_SERIALIZATION_TRACKING_HPP
...
#include <qsboost/mpl/greater.hpp>
...
#include <qsboost/serialization/tracking_enum.hpp>
#include <qsboost/serialization/type_info_implementation.hpp>
...
// without problem.
#define QSBOOST_CLASS_TRACKING(T, E)           \
namespace qsboost {                            \
namespace serialization {                    \
template<>                                   \
