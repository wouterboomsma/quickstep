#ifndef QSBOOST_SERIALIZATION_BASE_OBJECT_HPP
#define QSBOOST_SERIALIZATION_BASE_OBJECT_HPP
...
#include <qsboost/serialization/access.hpp>
#include <qsboost/serialization/force_include.hpp>
#include <qsboost/serialization/void_cast_fwd.hpp>
...
namespace detail
{
    ...
    struct base_cast
    {
        ...
        mpl::if_<
            ...
            B
        >::type type;
        QSBOOST_STATIC_ASSERT(is_const<type>::value == is_const<D>::value);
    };
...
{
    QSBOOST_STATIC_ASSERT(( is_base_and_derived<Base,Derived>::value));
    QSBOOST_STATIC_ASSERT(! is_pointer<Derived>::value);
