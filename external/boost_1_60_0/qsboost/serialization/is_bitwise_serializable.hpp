...
#ifndef QSBOOST_SERIALIZATION_IS_BITWISE_SERIALIZABLE_HPP
#define QSBOOST_SERIALIZATION_IS_BITWISE_SERIALIZABLE_HPP
...
#define QSBOOST_IS_BITWISE_SERIALIZABLE(T)              \
namespace qsboost {                                     \
namespace serialization {                             \
template<>                                            \
