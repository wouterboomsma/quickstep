...
#ifndef QSBOOST_MOVE_DETAIL_META_UTILS_HPP
#define QSBOOST_MOVE_DETAIL_META_UTILS_HPP
...
#  pragma once
#endif
#include <qsboost/move/detail/meta_utils_core.hpp>
...
{
   return ::qsboost::move_detail::addressof_impl<T>::f
      ( ::qsboost::move_detail::addr_impl_ref<T>( v ), 0 );
}
...
#if defined(QSBOOST_GCC) && (QSBOOST_GCC <= 40000)
#define QSBOOST_MOVE_HELPERS_RETURN_SFINAE_BROKEN
#endif
...
template<class T>
struct has_move_emulation_enabled_impl< ::qsboost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< qsboost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const qsboost::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::qsboost::rv<T>& type; };
} // namespace detail_add_rvalue_reference
