...
#ifndef QSBOOST_MOVE_ALGORITHM_HPP
#define QSBOOST_MOVE_ALGORITHM_HPP
...
#include <qsboost/move/iterator.hpp>
   ...
   )
{
   ...
   QSBOOST_TRY{
      while (f != l) {
         void * const addr = static_cast<void*>(::qsboost::move_detail::addressof(*r));
         ::new(addr) input_value_type(::qsboost::move(*f));
         ++f; ++r;
      }
   }
   QSBOOST_CATCH(...){
...
{
   return ::qsboost::uninitialized_move(f, l, r);
}
/*
template
<typename I,   // I models InputIterator
...
inline F uninitialized_copy_or_move(I f, I l, F r,
                             typename ::qsboost::move_detail::enable_if< move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::qsboost::move_detail::uninitialized_move_move_iterator(f, l, r);
}
...
inline F copy_or_move(I f, I l, F r,
                             typename ::qsboost::move_detail::enable_if< move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::qsboost::move_detail::move_move_iterator(f, l, r);
}
...
inline F uninitialized_copy_or_move(I f, I l, F r
   /// @cond
   ,typename ::qsboost::move_detail::disable_if< move_detail::is_move_iterator<I> >::type* = 0
   /// @endcond
   )
{
   return std::uninitialized_copy(f, l, r);
