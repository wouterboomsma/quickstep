...
#if defined(__GNUC__) && !defined(QSBOOST_NO_SWPRINTF)
...
#  define QSBOOST_SYMBOL_EXPORT __declspec(dllexport)
#  define QSBOOST_SYMBOL_IMPORT __declspec(dllimport)
#endif
...
#  define QSBOOST_NO_ANSI_APIS
// Windows CE does not have a conforming signature for swprintf
#  define QSBOOST_NO_SWPRINTF
#else
#  define QSBOOST_HAS_GETSYSTEMTIMEASFILETIME
#  define QSBOOST_HAS_THREADEX
#  define QSBOOST_HAS_GETSYSTEMTIMEASFILETIME
#endif
...
#ifndef QSBOOST_DISABLE_WIN32
// WEK: Added
#define QSBOOST_HAS_FTIME
#define QSBOOST_WINDOWS 1
