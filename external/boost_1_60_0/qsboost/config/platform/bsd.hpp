...
#ifdef __FreeBSD__
#define QSBOOST_PLATFORM "FreeBSD " QSBOOST_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define QSBOOST_PLATFORM "NetBSD " QSBOOST_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define QSBOOST_PLATFORM "OpenBSD " QSBOOST_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define QSBOOST_PLATFORM "DragonFly " QSBOOST_STRINGIZE(__DragonFly__)
#endif
...
#  define QSBOOST_NO_CTYPE_FUNCTIONS
#endif
