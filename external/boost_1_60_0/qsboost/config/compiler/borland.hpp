...
#  define QSBOOST_BCB_WITH_ROGUE_WAVE
#elif __BORLANDC__ < 0x570
#  define QSBOOST_BCB_WITH_STLPORT
#else
#  define QSBOOST_BCB_WITH_DINKUMWARE
#endif
...
#  define QSBOOST_NO_DEDUCED_TYPENAME
...
#  define QSBOOST_NO_MEMBER_FUNCTION_SPECIALIZATIONS
#endif
...
#  define QSBOOST_NO_PRIVATE_IN_AGGREGATE
...
#     pragma defineonoption QSBOOST_CPPUNWIND -x
#  endif
#endif
...
#  define QSBOOST_NO_FUNCTION_TYPE_SPECIALIZATIONS
#  define QSBOOST_NO_USING_TEMPLATE
#  define QSBOOST_SP_NO_SP_CONVERTIBLE

// Temporary workaround
#define QSBOOST_MPL_CFG_NO_PREPROCESSED_HEADERS
#endif
...
#  define QSBOOST_NO_USING_DECLARATION_OVERLOADS_FROM_TYPENAME_BASE
#  define QSBOOST_NO_NESTED_FRIENDSHIP
#  define QSBOOST_NO_TYPENAME_WITH_CTOR
#if (__BORLANDC__ < 0x600)
#  define QSBOOST_ILLEGAL_CV_REFERENCES
#endif
...
#  pragma defineonoption QSBOOST_CODEGEAR_0X_SUPPORT -Ax
#endif
//
// C++0x Macros:
//
#if !defined( QSBOOST_CODEGEAR_0X_SUPPORT ) || (__BORLANDC__ < 0x610)
...
#else
#  define QSBOOST_HAS_ALIGNOF
#  define QSBOOST_HAS_CHAR16_T
#  define QSBOOST_HAS_CHAR32_T
#  define QSBOOST_HAS_DECLTYPE
#  define QSBOOST_HAS_EXPLICIT_CONVERSION_OPS
#  define QSBOOST_HAS_REF_QUALIFIER
...
#define QSBOOST_NO_CXX11_UNICODE_LITERALS    // UTF-8 still not supported
...
#if defined( QSBOOST_BCB_WITH_ROGUE_WAVE )
...
//
#if !defined(_CPPUNWIND) && !defined(QSBOOST_CPPUNWIND) && !defined(__EXCEPTIONS) && !defined(QSBOOST_NO_EXCEPTIONS)
...
#ifndef QSBOOST_ABI_PREFIX
#  define QSBOOST_ABI_PREFIX "qsboost/config/abi/borland_prefix.hpp"
#endif
#ifndef QSBOOST_ABI_SUFFIX
#  define QSBOOST_ABI_SUFFIX "qsboost/config/abi/borland_suffix.hpp"
#endif
#endif
//
...
//
#if __BORLANDC__ < 0x600
#  pragma defineonoption QSBOOST_DISABLE_WIN32 -A
...
#define QSBOOST_COMPILER "Borland C++ version " QSBOOST_STRINGIZE(__BORLANDC__)
