...
#  define QSBOOST_MSVC_FULL_VER _MSC_FULL_VER
#else
#  define QSBOOST_MSVC_FULL_VER (_MSC_FULL_VER * 10)
#endif
...
// turned off:
//
#if !defined(_MSC_EXTENSIONS) && !defined(QSBOOST_DISABLE_WIN32)
#  define QSBOOST_DISABLE_WIN32
#endif
#if !defined(_CPPRTTI) && !defined(QSBOOST_NO_RTTI)
...
#  define QSBOOST_ABI_PREFIX "qsboost/config/abi/msvc_prefix.hpp"
#endif
#ifndef QSBOOST_ABI_SUFFIX
#  define QSBOOST_ABI_SUFFIX "qsboost/config/abi/msvc_suffix.hpp"
#endif
...
#      endif
#   elif _MSC_VER < 1500
#     define QSBOOST_COMPILER_VERSION evc8
#   elif _MSC_VER < 1600
#     define QSBOOST_COMPILER_VERSION evc9
#   elif _MSC_VER < 1700
#     define QSBOOST_COMPILER_VERSION evc10
#   elif _MSC_VER < 1800 
#     define QSBOOST_COMPILER_VERSION evc11 
#   elif _MSC_VER < 1900 
#     define QSBOOST_COMPILER_VERSION evc12
#   elif _MSC_VER < 2000  
#     define QSBOOST_COMPILER_VERSION evc14
#   else
#      if defined(QSBOOST_ASSERT_CONFIG)
#         error "Unknown EVC++ compiler version - please run the configure tests and report the results"
#      else
...
#     define QSBOOST_COMPILER_VERSION 5.0
#   elif _MSC_VER < 1300
#     define QSBOOST_COMPILER_VERSION 6.0
#   elif _MSC_VER < 1310
#     define QSBOOST_COMPILER_VERSION 7.0
#   elif _MSC_VER < 1400
#     define QSBOOST_COMPILER_VERSION 7.1
#   elif _MSC_VER < 1500
#     define QSBOOST_COMPILER_VERSION 8.0
#   elif _MSC_VER < 1600
#     define QSBOOST_COMPILER_VERSION 9.0
#   elif _MSC_VER < 1700
#     define QSBOOST_COMPILER_VERSION 10.0
#   elif _MSC_VER < 1800 
#     define QSBOOST_COMPILER_VERSION 11.0
#   elif _MSC_VER < 1900
#     define QSBOOST_COMPILER_VERSION 12.0
#   elif _MSC_VER < 2000
#     define QSBOOST_COMPILER_VERSION 14.0
#   else
#     define QSBOOST_COMPILER_VERSION _MSC_VER
#   endif
# endif

#  define QSBOOST_COMPILER "Microsoft Visual C++ version " QSBOOST_STRINGIZE(QSBOOST_COMPILER_VERSION)
#endif
