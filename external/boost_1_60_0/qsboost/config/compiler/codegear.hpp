...
#if !defined( QSBOOST_WITH_CODEGEAR_WARNINGS )
...
#if (__CODEGEARC__ <= 0x621)
#  define QSBOOST_NO_TYPENAME_WITH_CTOR    // Cannot use typename keyword when making temporaries of a dependant type
#  define QSBOOST_FUNCTION_SCOPE_USING_DECLARATION_BREAKS_ADL
#  define QSBOOST_NO_MEMBER_TEMPLATE_FRIENDS
#  define QSBOOST_NO_NESTED_FRIENDSHIP     // TC1 gives nested classes access rights as any other member
...
#define QSBOOST_HAS_SCOPED_ENUM
// #define BOOST_HAS_STATIC_ASSERT
#define QSBOOST_HAS_STD_TYPE_TRAITS
...
#define QSBOOST_HAS_TR1_TYPE_TRAITS
...
#define QSBOOST_COMPILER "CodeGear C++ version " QSBOOST_STRINGIZE(__CODEGEARC__)
