...
#      define QSBOOST_NO_MEMBER_TEMPLATES
...
//
#if __SUNPRO_CC > 0x500
#  define QSBOOST_SYMBOL_EXPORT __global
#  define QSBOOST_SYMBOL_IMPORT __global
#  define QSBOOST_SYMBOL_VISIBLE __global
#endif
...
#define QSBOOST_COMPILER "Sun compiler version " QSBOOST_STRINGIZE(__SUNPRO_CC)
