...
#     define QSBOOST_NO_FUNCTION_TEMPLATE_ORDERING
#     define QSBOOST_NO_POINTER_TO_MEMBER_CONST
#     define QSBOOST_NO_DEPENDENT_TYPES_IN_TEMPLATE_VALUE_PARAMETERS
#     define QSBOOST_NO_MEMBER_TEMPLATE_KEYWORD
#   endif
...
// tested version *only*:
#   if(__MWERKS__ <= 0x3207) || !defined(QSBOOST_STRICT_CONFIG) // 9.6
...
#if !__option(exceptions) && !defined(QSBOOST_NO_EXCEPTIONS)
...
#     define QSBOOST_COMPILER_VERSION 8.1
#   elif __MWERKS__ == 0x3002
#     define QSBOOST_COMPILER_VERSION 8.2
#   elif __MWERKS__ == 0x3003
#     define QSBOOST_COMPILER_VERSION 8.3
#   elif __MWERKS__ == 0x3200
#     define QSBOOST_COMPILER_VERSION 9.0
#   elif __MWERKS__ == 0x3201
#     define QSBOOST_COMPILER_VERSION 9.1
#   elif __MWERKS__ == 0x3202
#     define QSBOOST_COMPILER_VERSION 9.2
#   elif __MWERKS__ == 0x3204
#     define QSBOOST_COMPILER_VERSION 9.3
#   elif __MWERKS__ == 0x3205
#     define QSBOOST_COMPILER_VERSION 9.4
#   elif __MWERKS__ == 0x3206
#     define QSBOOST_COMPILER_VERSION 9.5
#   elif __MWERKS__ == 0x3207
#     define QSBOOST_COMPILER_VERSION 9.6
#   else
#     define QSBOOST_COMPILER_VERSION __MWERKS__
#   endif
#else
#  define QSBOOST_COMPILER_VERSION __MWERKS__
#endif
...
#define QSBOOST_COMPILER "Metrowerks CodeWarrior C++ version " QSBOOST_STRINGIZE(QSBOOST_COMPILER_VERSION)
