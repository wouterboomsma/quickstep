...
//
#ifndef _RWSTD_VER
#  define QSBOOST_RWSTD_VER 0x010000
#elif _RWSTD_VER < 0x010000
#  define QSBOOST_RWSTD_VER (_RWSTD_VER << 8)
#else
#  define QSBOOST_RWSTD_VER _RWSTD_VER
#endif

#ifndef _RWSTD_VER
#  define QSBOOST_STDLIB "Rogue Wave standard library version (Unknown version)"
#elif _RWSTD_VER < 0x04010200
 #  define QSBOOST_STDLIB "Rogue Wave standard library version " QSBOOST_STRINGIZE(_RWSTD_VER)
#else
#  ifdef _RWSTD_VER_STR
#    define QSBOOST_STDLIB "Apache STDCXX standard library version " _RWSTD_VER_STR
#  else
#    define QSBOOST_STDLIB "Apache STDCXX standard library version " QSBOOST_STRINGIZE(_RWSTD_VER)
#  endif
#endif
...
// template do:
//
#if QSBOOST_RWSTD_VER < 0x020200
#  define QSBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
#endif

// Sun CC 5.5 patch 113817-07 adds long long specialization, but does not change the
// library version number (http://sunsolve6.sun.com/search/document.do?assetkey=1-21-113817):
#if QSBOOST_RWSTD_VER <= 0x020101 && (!defined(__SUNPRO_CC) || (__SUNPRO_CC < 0x550))
...
//
#if defined(_RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || defined(RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || (QSBOOST_RWSTD_VER < 0x020000)
...
//
#if defined(_RWSTD_NO_TEMPLATE_ON_RETURN_TYPE) && !defined(QSBOOST_NO_STD_LOCALE)
...
//
#if (QSBOOST_RWSTD_VER < 0x020000) || defined(_RWSTD_NO_CLASS_PARTIAL_SPEC)
    #define QSBOOST_NO_STD_DISTANCE
#endif
...
//
#if !defined(_RWSTD_LONG_LONG) && defined(QSBOOST_HAS_LONG_LONG)
...
//
#if defined(__HP_aCC) && (QSBOOST_RWSTD_VER == 0x02020100)
