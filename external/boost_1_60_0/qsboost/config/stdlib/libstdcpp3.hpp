...
#define QSBOOST_GNU_STDLIB 1

#ifdef __GLIBCXX__
#define QSBOOST_STDLIB "GNU libstdc++ version " QSBOOST_STRINGIZE(__GLIBCXX__)
#else
#define QSBOOST_STDLIB "GNU libstdc++ version " QSBOOST_STRINGIZE(__GLIBCPP__)
#endif
...
#  define QSBOOST_HAS_THREADS
    ...
    && defined(QSBOOST_HAS_LONG_LONG)
// May have been set by compiler/*.hpp, but "long long" without library
// support is useless.
#  undef QSBOOST_HAS_LONG_LONG
#endif
...
#  define QSBOOST_STD_EXTENSION_NAMESPACE __gnu_cxx
#  define QSBOOST_HAS_SLIST
#  define QSBOOST_HAS_HASH
#  define QSBOOST_SLIST_HEADER <ext/slist>
# if !defined(__GNUC__) || __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 3)
#   define QSBOOST_HASH_SET_HEADER <ext/hash_set>
#   define QSBOOST_HASH_MAP_HEADER <ext/hash_map>
# else
#   define QSBOOST_HASH_SET_HEADER <backward/hash_set>
#   define QSBOOST_HASH_MAP_HEADER <backward/hash_map>
# endif
#endif
...
#  define QSBOOST_LIBSTDCXX_VERSION 50100
#elif __has_include(<shared_mutex>)
#  define QSBOOST_LIBSTDCXX_VERSION 40900
#elif __has_include(<ext/cmath>)
#  define QSBOOST_LIBSTDCXX_VERSION 40800
#elif __has_include(<scoped_allocator>)
#  define QSBOOST_LIBSTDCXX_VERSION 40700
#elif __has_include(<typeindex>)
#  define QSBOOST_LIBSTDCXX_VERSION 40600
#elif __has_include(<future>)
#  define QSBOOST_LIBSTDCXX_VERSION 40500
#elif  __has_include(<ratio>)
#  define QSBOOST_LIBSTDCXX_VERSION 40400
#elif __has_include(<array>)
#  define QSBOOST_LIBSTDCXX_VERSION 40300
#endif
//
...
#if !defined(QSBOOST_LIBSTDCXX_VERSION)
#  define QSBOOST_LIBSTDCXX_VERSION (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#endif

//  C++0x headers in GCC 4.3.0 and later
//
#if (QSBOOST_LIBSTDCXX_VERSION < 40300) || !defined(QSBOOST_LIBSTDCXX11)
...
//
#if (QSBOOST_LIBSTDCXX_VERSION < 40400) || !defined(QSBOOST_LIBSTDCXX11)
...
#else
#  define QSBOOST_HAS_TR1_COMPLEX_INVERSE_TRIG 
#  define QSBOOST_HAS_TR1_COMPLEX_OVERLOADS 
#endif

//  C++0x features in GCC 4.5.0 and later
//
#if (QSBOOST_LIBSTDCXX_VERSION < 40500) || !defined(QSBOOST_LIBSTDCXX11)
...
//
#if (QSBOOST_LIBSTDCXX_VERSION < 40600) || !defined(QSBOOST_LIBSTDCXX11)
...
//
#if (QSBOOST_LIBSTDCXX_VERSION < 40700) || !defined(QSBOOST_LIBSTDCXX11)
...
//
#if (QSBOOST_LIBSTDCXX_VERSION < 40800) || !defined(QSBOOST_LIBSTDCXX11)
...
//
#if (QSBOOST_LIBSTDCXX_VERSION < 40900) || !defined(QSBOOST_LIBSTDCXX11)
...
//
#if (QSBOOST_LIBSTDCXX_VERSION < 50100) || !defined(QSBOOST_LIBSTDCXX11)
...
#  define QSBOOST_NO_CXX14_HDR_SHARED_MUTEX
#endif
#elif __cplusplus < 201402 || (QSBOOST_LIBSTDCXX_VERSION < 40900) || !defined(QSBOOST_LIBSTDCXX11)
#  define QSBOOST_NO_CXX14_HDR_SHARED_MUTEX
#endif
...
#  ifndef QSBOOST_NO_CXX11_HDR_CONDITION_VARIABLE
#     define QSBOOST_NO_CXX11_HDR_CONDITION_VARIABLE
#  endif
#  ifndef QSBOOST_NO_CXX11_HDR_MUTEX
#     define QSBOOST_NO_CXX11_HDR_MUTEX
#  endif
#  ifndef QSBOOST_NO_CXX11_HDR_THREAD
#     define QSBOOST_NO_CXX11_HDR_THREAD
#  endif
#  ifndef QSBOOST_NO_CXX14_HDR_SHARED_MUTEX
#     define QSBOOST_NO_CXX14_HDR_SHARED_MUTEX
#  endif
#endif

#if (!defined(_GTHREAD_USE_MUTEX_TIMEDLOCK) || (_GTHREAD_USE_MUTEX_TIMEDLOCK == 0)) && !defined(QSBOOST_NO_CXX11_HDR_MUTEX)
