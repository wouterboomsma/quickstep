...
#ifndef QSBOOST_MPL_INSERT_HPP_INCLUDED
#define QSBOOST_MPL_INSERT_HPP_INCLUDED
...
#include <qsboost/mpl/insert_fwd.hpp>
#include <qsboost/mpl/sequence_tag.hpp>
#include <qsboost/mpl/aux_/insert_impl.hpp>
...
template<
    ...
    , typename QSBOOST_MPL_AUX_NA_PARAM(Pos_or_T)
...
{
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(3,insert,(Sequence,Pos_or_T,T))
};

QSBOOST_MPL_AUX_NA_SPEC(3, insert)
