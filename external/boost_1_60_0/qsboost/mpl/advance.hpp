...
#ifndef QSBOOST_MPL_ADVANCE_HPP_INCLUDED
#define QSBOOST_MPL_ADVANCE_HPP_INCLUDED
...
#include <qsboost/mpl/aux_/advance_forward.hpp>
#include <qsboost/mpl/aux_/advance_backward.hpp>
...
struct advance_impl
{
    template< typename Iterator, typename N > struct apply
    {
        ...
        typedef typename if_<
              backward_
            , aux::advance_backward< QSBOOST_MPL_AUX_VALUE_WKND(offset_)::value >
            , aux::advance_forward< QSBOOST_MPL_AUX_VALUE_WKND(offset_)::value >
            >::type f_;
...
QSBOOST_MPL_AUX_NA_SPEC(2, advance)
