...
#ifndef QSBOOST_MPL_SIZEOF_HPP_INCLUDED
#define QSBOOST_MPL_SIZEOF_HPP_INCLUDED
...
struct sizeof_
    : mpl::size_t< sizeof(T) >
{
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(1,sizeof_,(T))
};

QSBOOST_MPL_AUX_NA_SPEC_NO_ETI(1, sizeof_)
