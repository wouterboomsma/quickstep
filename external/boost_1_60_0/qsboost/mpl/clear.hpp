...
#ifndef QSBOOST_MPL_CLEAR_HPP_INCLUDED
#define QSBOOST_MPL_CLEAR_HPP_INCLUDED
...
#include <qsboost/mpl/aux_/clear_impl.hpp>
...
{
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(1,clear,(Sequence))
};

QSBOOST_MPL_AUX_NA_SPEC(1, clear)
