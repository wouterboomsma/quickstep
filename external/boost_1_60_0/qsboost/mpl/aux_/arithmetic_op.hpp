...
#   include <qsboost/mpl/aux_/largest_int.hpp>
...
#include <qsboost/mpl/aux_/numeric_op.hpp>
...
#   define QSBOOST_MPL_PREPROCESSED_HEADER AUX778076_OP_PREFIX.hpp
...
struct QSBOOST_PP_CAT(AUX778076_OP_PREFIX,_wknd)
{
    QSBOOST_STATIC_CONSTANT(T, value = (n1 AUX778076_OP_TOKEN n2));
    ...
    template< typename N1, typename N2 > struct apply
        ...
        : integral_c<
              typename aux::largest_int<
                ...
                >::type
            , ( QSBOOST_MPL_AUX_VALUE_WKND(N1)::value
                  AUX778076_OP_TOKEN QSBOOST_MPL_AUX_VALUE_WKND(N2)::value
                )
            >
#else
        : aux::QSBOOST_PP_CAT(AUX778076_OP_PREFIX,_wknd)<
              typename aux::largest_int<
                  typename N1::value_type
                , typename N2::value_type
                >::type
