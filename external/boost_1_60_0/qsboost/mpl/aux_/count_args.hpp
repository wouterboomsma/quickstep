...
#include <qsboost/preprocessor/expr_if.hpp>
...
#   define AUX778076_COUNT_ARGS_REPEAT QSBOOST_MPL_PP_REPEAT
...
#   define AUX778076_COUNT_ARGS_REPEAT QSBOOST_PP_REPEAT
#   define AUX778076_COUNT_ARGS_PARAMS(param) \
    QSBOOST_PP_ENUM_SHIFTED_PARAMS( \
          QSBOOST_PP_INC(AUX778076_COUNT_ARGS_ARITY) \
        , param \
        ) \
    /**/
...
#define AUX778076_IS_ARG_TEMPLATE_NAME \
    QSBOOST_PP_CAT(is_,QSBOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_arg)) \
/**/

#define AUX778076_COUNT_ARGS_FUNC(unused, i, param) \
    QSBOOST_PP_EXPR_IF(i, +) \
    AUX778076_IS_ARG_TEMPLATE_NAME<QSBOOST_PP_CAT(param,QSBOOST_PP_INC(i))>::value \
/**/
...
template<
    ...
    >
struct QSBOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_count_args)
{
    QSBOOST_STATIC_CONSTANT(int, value = AUX778076_COUNT_ARGS_REPEAT(
          AUX778076_COUNT_ARGS_ARITY
