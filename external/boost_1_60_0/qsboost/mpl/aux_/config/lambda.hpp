...
#ifndef QSBOOST_MPL_AUX_CONFIG_LAMBDA_HPP_INCLUDED
#define QSBOOST_MPL_AUX_CONFIG_LAMBDA_HPP_INCLUDED
...
// template template parameters _and_ partial specialization
    ...
    && (   defined(QSBOOST_MPL_CFG_NO_TEMPLATE_TEMPLATE_PARAMETERS) \
        || defined(QSBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) \
        )

#   define QSBOOST_MPL_CFG_NO_FULL_LAMBDA_SUPPORT
