...
#ifndef QSBOOST_MPL_AUX_CONFIG_DMC_AMBIGUOUS_CTPS_HPP_INCLUDED
#define QSBOOST_MPL_AUX_CONFIG_DMC_AMBIGUOUS_CTPS_HPP_INCLUDED
...
#   define QSBOOST_MPL_CFG_DMC_AMBIGUOUS_CTPS
