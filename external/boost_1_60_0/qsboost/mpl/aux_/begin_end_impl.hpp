...
#ifndef QSBOOST_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
#define QSBOOST_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
...
QSBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,begin_impl)
QSBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,end_impl)
