...
#ifndef QSBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
#define QSBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
...
template< typename T > struct msvc_eti_base
    : T
{
#if QSBOOST_WORKAROUND(QSBOOST_MPL_CFG_GCC, QSBOOST_TESTED_AT(0x0304))
    msvc_eti_base();
#endif
    typedef T type;
};
