...
#ifndef QSBOOST_MPL_AUX_VALUE_WKND_HPP_INCLUDED
#define QSBOOST_MPL_AUX_VALUE_WKND_HPP_INCLUDED
...
#if !defined(QSBOOST_MPL_CFG_MSVC_60_ETI_BUG)
#   define QSBOOST_MPL_AUX_VALUE_WKND(C) \
    ::QSBOOST_MPL_AUX_ADL_BARRIER_NAMESPACE::aux::value_wknd< C > \
/**/
#    define QSBOOST_MPL_AUX_MSVC_VALUE_WKND(C) QSBOOST_MPL_AUX_VALUE_WKND(C)
#else
#   define QSBOOST_MPL_AUX_VALUE_WKND(C) C
#   define QSBOOST_MPL_AUX_MSVC_VALUE_WKND(C) \
    ::qsboost::mpl::aux::value_wknd< C > \
/**/
#endif
...
#   define QSBOOST_MPL_AUX_VALUE_WKND(C) C
#   define QSBOOST_MPL_AUX_MSVC_VALUE_WKND(C) C

#endif

#if QSBOOST_WORKAROUND(__EDG_VERSION__, <= 238)
#   define QSBOOST_MPL_AUX_NESTED_VALUE_WKND(T, C) \
    QSBOOST_MPL_AUX_STATIC_CAST(T, C::value) \
/**/
#else
#   define QSBOOST_MPL_AUX_NESTED_VALUE_WKND(T, C) \
    QSBOOST_MPL_AUX_VALUE_WKND(C)::value \
/**/
#endif
