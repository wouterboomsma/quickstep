...
#ifndef QSBOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
#define QSBOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
...
struct push_back_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        QSBOOST_MPL_ASSERT_MSG(
              ( qsboost::is_same< T, has_push_back_arg >::value )
...
QSBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, push_back_impl)
QSBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, has_push_back_impl)
