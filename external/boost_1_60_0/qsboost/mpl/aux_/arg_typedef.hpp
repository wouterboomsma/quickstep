...
#ifndef QSBOOST_MPL_AUX_ARG_TYPEDEF_HPP_INCLUDED
#define QSBOOST_MPL_AUX_ARG_TYPEDEF_HPP_INCLUDED
...
#   define QSBOOST_MPL_AUX_ARG_TYPEDEF(T, name) typedef T name;

#else

#   define QSBOOST_MPL_AUX_ARG_TYPEDEF(T, name) /**/
