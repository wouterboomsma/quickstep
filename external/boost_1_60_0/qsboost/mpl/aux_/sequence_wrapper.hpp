...
#   include <qsboost/preprocessor/enum_params_with_a_default.hpp>
...
#   define AUX778076_SEQUENCE_NAME_N(n) \
    QSBOOST_PP_CAT(AUX778076_SEQUENCE_BASE_NAME,n) \
    /**/
...
#   define AUX778076_SEQUENCE_N_PARAMS(n) \
    QSBOOST_PP_ENUM_PARAMS(n, AUX778076_SEQUENCE_TEMPLATE_PARAM) \
    /**/
...
#   define AUX778076_SEQUENCE_N_PARTIAL_SPEC_ARGS(n) \
    ...
    QSBOOST_PP_ENUM( \
          QSBOOST_PP_SUB_D(1,AUX778076_SEQUENCE_LIMIT,n) \
        , QSBOOST_PP_TUPLE_ELEM_3_2 \
        , AUX778076_SEQUENCE_DEFAULT \
        ) \
    /**/
...
#   define AUX778076_SEQUENCE_TEMPLATE_PARAM QSBOOST_MPL_AUX_NTTP_DECL(long, C)
#   define AUX778076_SEQUENCE_DEFAULT LONG_MAX

#   define AUX778076_SEQUENCE_PARAMS() \
    typename T, QSBOOST_PP_ENUM_PARAMS( \
          AUX778076_SEQUENCE_LIMIT \
        , AUX778076_SEQUENCE_TEMPLATE_PARAM \
        ) \
    /**/
...
#   define AUX778076_SEQUENCE_N_PARAMS(n) \
    typename T QSBOOST_PP_COMMA_IF(n) \
    QSBOOST_PP_ENUM_PARAMS(n, AUX778076_SEQUENCE_TEMPLATE_PARAM) \
    /**/

#   if !defined(AUX778076_SEQUENCE_CONVERT_CN_TO)
#       define AUX778076_SEQUENCE_CONVERT_CN_TO(z,n,TARGET) QSBOOST_PP_CAT(C,n)
#   endif

#   define AUX778076_SEQUENCE_N_ARGS(n) \
    T QSBOOST_PP_COMMA_IF(n) \
    QSBOOST_PP_ENUM(n,AUX778076_SEQUENCE_CONVERT_CN_TO,T) \
    /**/

#   define AUX778076_SEQUENCE_N_PARTIAL_SPEC_ARGS(n) \
    T, QSBOOST_PP_ENUM_PARAMS(n, C) \
    QSBOOST_PP_COMMA_IF(n) \
    QSBOOST_PP_ENUM( \
          QSBOOST_PP_SUB_D(1,AUX778076_SEQUENCE_LIMIT,n) \
        , QSBOOST_PP_TUPLE_ELEM_3_2 \
...
struct QSBOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser);
}
#endif

#define QSBOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, AUX778076_SEQUENCE_LIMIT, <qsboost/mpl/aux_/sequence_wrapper.hpp>))
...
template<
    ...
    >
struct QSBOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_impl)
{
    typedef aux::QSBOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_count_args)<
          QSBOOST_PP_ENUM_PARAMS(AUX778076_SEQUENCE_LIMIT, AUX778076_SEQUENCE_PARAM_NAME)
        > arg_num_;
    
    typedef typename aux::QSBOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser)< arg_num_::value >
...
template<
    ...
    >
struct AUX778076_SEQUENCE_NAME
    : aux::QSBOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_impl)<
          AUX778076_SEQUENCE_ARGS()
        >::type
{
    typedef typename aux::QSBOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_impl)<
          AUX778076_SEQUENCE_ARGS()
        >::type type;
};
...
template<>
struct QSBOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser)<i_>
{
    template<
          AUX778076_SEQUENCE_PARAMS()
        >
