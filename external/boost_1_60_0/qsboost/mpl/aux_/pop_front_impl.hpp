...
#ifndef QSBOOST_MPL_AUX_POP_FRONT_IMPL_HPP_INCLUDED
#define QSBOOST_MPL_AUX_POP_FRONT_IMPL_HPP_INCLUDED
...
QSBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, pop_front_impl)
