...
#ifndef QSBOOST_MPL_AUX778076_ADVANCE_BACKWARD_HPP_INCLUDED
#define QSBOOST_MPL_AUX778076_ADVANCE_BACKWARD_HPP_INCLUDED
...
#   define QSBOOST_MPL_PREPROCESSED_HEADER advance_backward.hpp
...
// forward declaration
template< QSBOOST_MPL_AUX_NTTP_DECL(long, N) > struct advance_backward;

#   define QSBOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, QSBOOST_MPL_LIMIT_UNROLLING, <qsboost/mpl/aux_/advance_backward.hpp>))
...
struct advance_backward
{
    template< typename Iterator > struct apply
    {
        typedef typename apply_wrap1<
              advance_backward<QSBOOST_MPL_LIMIT_UNROLLING>
            , Iterator
            >::type chunk_result_;
...
template<>
struct advance_backward< QSBOOST_PP_FRAME_ITERATION(1) >
{
    template< typename Iterator > struct apply
    {
...
#   define QSBOOST_PP_ITERATION_PARAMS_2 \
    (3,(1, QSBOOST_PP_FRAME_ITERATION(1), <qsboost/mpl/aux_/advance_backward.hpp>))
#   include QSBOOST_PP_ITERATE()
#endif

        typedef QSBOOST_PP_CAT(iter,QSBOOST_PP_FRAME_ITERATION(1)) type;
    };
