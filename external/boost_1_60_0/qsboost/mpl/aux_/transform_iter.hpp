...
#ifndef QSBOOST_MPL_AUX_TRANSFORM_ITER_HPP_INCLUDED
#define QSBOOST_MPL_AUX_TRANSFORM_ITER_HPP_INCLUDED
...
struct transform_iter
    : transform_iter_impl<
          ::qsboost::is_same<Iterator,LastIterator>::value
...
QSBOOST_MPL_AUX_PASS_THROUGH_LAMBDA_SPEC(3, aux::transform_iter)
