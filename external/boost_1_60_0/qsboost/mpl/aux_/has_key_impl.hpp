...
#ifndef QSBOOST_MPL_AUX_HAS_KEY_IMPL_HPP_INCLUDED
#define QSBOOST_MPL_AUX_HAS_KEY_IMPL_HPP_INCLUDED
...
QSBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2,has_key_impl)
