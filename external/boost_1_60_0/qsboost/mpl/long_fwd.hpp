...
#ifndef QSBOOST_MPL_LONG_FWD_HPP_INCLUDED
#define QSBOOST_MPL_LONG_FWD_HPP_INCLUDED
...
template< QSBOOST_MPL_AUX_NTTP_DECL(long, N) > struct long_;

QSBOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
QSBOOST_MPL_AUX_ADL_BARRIER_DECL(long_)
