...
#ifndef QSBOOST_MPL_LIST_HPP_INCLUDED
#define QSBOOST_MPL_LIST_HPP_INCLUDED
...
#   define AUX778076_LIST_HEADER \
    QSBOOST_PP_CAT(list,QSBOOST_MPL_LIMIT_LIST_SIZE).hpp \
    /**/
#else
#   define AUX778076_LIST_HEADER \
    QSBOOST_PP_CAT(list,QSBOOST_MPL_LIMIT_LIST_SIZE)##.hpp \
...
#   include QSBOOST_PP_STRINGIZE(qsboost/mpl/list/AUX778076_LIST_HEADER)
...
#   define QSBOOST_MPL_PREPROCESSED_HEADER list.hpp
...
#   define AUX778076_SEQUENCE_LIMIT QSBOOST_MPL_LIMIT_LIST_SIZE
