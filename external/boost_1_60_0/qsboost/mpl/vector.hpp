...
#ifndef QSBOOST_MPL_VECTOR_HPP_INCLUDED
#define QSBOOST_MPL_VECTOR_HPP_INCLUDED
...
#   include <qsboost/mpl/limits/vector.hpp>
...
#   define AUX778076_VECTOR_HEADER \
    QSBOOST_PP_CAT(vector, QSBOOST_MPL_LIMIT_VECTOR_SIZE).hpp \
    /**/
#else
#   define AUX778076_VECTOR_HEADER \
    QSBOOST_PP_CAT(vector, QSBOOST_MPL_LIMIT_VECTOR_SIZE)##.hpp \
...
#   include QSBOOST_PP_STRINGIZE(qsboost/mpl/vector/AUX778076_VECTOR_HEADER)
...
#   define QSBOOST_MPL_PREPROCESSED_HEADER vector.hpp
...
#   define AUX778076_SEQUENCE_LIMIT QSBOOST_MPL_LIMIT_VECTOR_SIZE
