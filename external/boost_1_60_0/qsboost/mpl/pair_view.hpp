...
#ifndef QSBOOST_MPL_PAIR_VIEW_HPP_INCLUDED
#define QSBOOST_MPL_PAIR_VIEW_HPP_INCLUDED
...
#include <qsboost/mpl/iterator_category.hpp>
...
#include <qsboost/mpl/min_max.hpp>
...
template<
      typename QSBOOST_MPL_AUX_NA_PARAM(Sequence1)
    , typename QSBOOST_MPL_AUX_NA_PARAM(Sequence2)
    >
struct pair_view
{
...
QSBOOST_MPL_AUX_NA_SPEC(2, pair_view)
