...
#ifndef QSBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
#define QSBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
...
#include <qsboost/mpl/aux_/joint_iter.hpp>
...
template<
      typename QSBOOST_MPL_AUX_NA_PARAM(Sequence1_)
    , typename QSBOOST_MPL_AUX_NA_PARAM(Sequence2_)
    >
struct joint_view
{
...
QSBOOST_MPL_AUX_NA_SPEC(2, joint_view)
