...
#ifndef QSBOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
#define QSBOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
...
template< 
      typename Map
    , QSBOOST_MPL_AUX_NTTP_DECL(long, order)
    , QSBOOST_MPL_AUX_NTTP_DECL(long, max_order)
    >
struct next_order;
