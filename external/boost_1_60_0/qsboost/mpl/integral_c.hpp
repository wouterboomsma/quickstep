...
#ifndef QSBOOST_MPL_INTEGRAL_C_HPP_INCLUDED
#define QSBOOST_MPL_INTEGRAL_C_HPP_INCLUDED
...
#include <qsboost/mpl/integral_c_fwd.hpp>
...
#if QSBOOST_WORKAROUND(__HP_aCC, <= 53800)
...
#include <qsboost/mpl/aux_/integral_wrapper.hpp>


#if !defined(QSBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) \
 && !QSBOOST_WORKAROUND(__BORLANDC__, <= 0x551)
