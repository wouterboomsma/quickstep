...
#ifndef QSBOOST_MPL_FOLD_HPP_INCLUDED
#define QSBOOST_MPL_FOLD_HPP_INCLUDED
...
#include <qsboost/mpl/aux_/fold_impl.hpp>
...
struct fold
{
    ...
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(3,fold,(Sequence,State,ForwardOp))
};

QSBOOST_MPL_AUX_NA_SPEC(3, fold)
