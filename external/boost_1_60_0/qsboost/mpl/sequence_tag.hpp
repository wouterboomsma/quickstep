...
#ifndef QSBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
#define QSBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
...
#include <qsboost/mpl/aux_/is_msvc_eti_arg.hpp>
...
struct sequence_tag
    : aux::sequence_tag_impl<
          ::qsboost::mpl::aux::has_tag<Sequence>::value
        , ::qsboost::mpl::aux::has_begin<Sequence>::value
...
QSBOOST_MPL_AUX_NA_SPEC(1, sequence_tag)
