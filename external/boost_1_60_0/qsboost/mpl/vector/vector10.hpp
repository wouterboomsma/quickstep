...
#ifndef QSBOOST_MPL_VECTOR_VECTOR10_HPP_INCLUDED
#define QSBOOST_MPL_VECTOR_VECTOR10_HPP_INCLUDED
...
#   define QSBOOST_MPL_PREPROCESSED_HEADER vector10.hpp
...
#   define QSBOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, 10, <qsboost/mpl/vector/aux_/numbered.hpp>))
