...
#ifndef QSBOOST_MPL_ERASE_KEY_HPP_INCLUDED
#define QSBOOST_MPL_ERASE_KEY_HPP_INCLUDED
...
#include <qsboost/mpl/aux_/erase_key_impl.hpp>
...
{
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(2,erase_key,(Sequence,Key))
};

QSBOOST_MPL_AUX_NA_SPEC(2,erase_key)
