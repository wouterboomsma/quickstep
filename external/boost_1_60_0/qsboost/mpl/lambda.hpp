...
#ifndef QSBOOST_MPL_LAMBDA_HPP_INCLUDED
#define QSBOOST_MPL_LAMBDA_HPP_INCLUDED
...
#   include <qsboost/mpl/aux_/full_lambda.hpp>
#else
#   include <qsboost/mpl/aux_/lambda_no_ctps.hpp>
