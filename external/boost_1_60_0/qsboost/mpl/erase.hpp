...
#ifndef QSBOOST_MPL_ERASE_HPP_INCLUDED
#define QSBOOST_MPL_ERASE_HPP_INCLUDED
...
#include <qsboost/mpl/erase_fwd.hpp>
#include <qsboost/mpl/sequence_tag.hpp>
#include <qsboost/mpl/aux_/erase_impl.hpp>
...
{
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(3,erase,(Sequence,First,Last))
};

QSBOOST_MPL_AUX_NA_SPEC(3,erase)
