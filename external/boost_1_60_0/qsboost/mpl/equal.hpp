...
#ifndef QSBOOST_MPL_EQUAL_HPP_INCLUDED
#define QSBOOST_MPL_EQUAL_HPP_INCLUDED
...
struct equal
    : aux::msvc_eti_base< 
        ...
        >::type
{
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(2,equal,(Sequence1,Sequence2))
};

QSBOOST_MPL_AUX_NA_SPEC(2, equal)
