...
#ifndef QSBOOST_MPL_BEGIN_END_HPP_INCLUDED
#define QSBOOST_MPL_BEGIN_END_HPP_INCLUDED
...
#include <qsboost/mpl/aux_/begin_end_impl.hpp>
...
struct begin
{
    ...
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(1,begin,(Sequence))
};
...
struct end
{
    ...
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(1,end,(Sequence))
};

QSBOOST_MPL_AUX_NA_SPEC(1, begin)
QSBOOST_MPL_AUX_NA_SPEC(1, end)
