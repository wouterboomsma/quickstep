...
#ifndef QSBOOST_FT_DETAIL_CLASS_TRANSFORM_HPP_INCLUDED
#define QSBOOST_FT_DETAIL_CLASS_TRANSFORM_HPP_INCLUDED
...
{ typedef typename qsboost::remove_cv<T>::type type; };
