...
#ifndef QSBOOST_FT_DETAIL_TAGS_HPP_INCLUDED
#define QSBOOST_FT_DETAIL_TAGS_HPP_INCLUDED

#include <cstddef>

#include <qsboost/type_traits/integral_constant.hpp>
#include <qsboost/mpl/bitxor.hpp>
...
namespace detail 
{
  ...
  template<bits_t Value> struct constant 
    : qsboost::integral_constant<bits_t,Value> 
  { };
  ...
  template<bits_t Bits, bits_t CCID> struct encode_bits
    : constant< 
        ::qsboost::function_types::detail::encode_bits_impl<Bits,CCID>::value 
      >
  { };
  ...
  {
    typedef constant<
      ::qsboost::function_types::detail::tag_ice
        < ::qsboost::function_types::detail::bits<LHS>::value
        , ::qsboost::function_types::detail::mask<LHS>::value
        , ::qsboost::function_types::detail::bits<RHS>::value
        , ::qsboost::function_types::detail::mask<RHS>::value
        >::combined_bits 
    > bits;
  ...
  template<class Tag, class QueryTag> struct represents_impl
    : qsboost::integral_constant<bool,
        ::qsboost::function_types::detail::tag_ice
          < ::qsboost::function_types::detail::bits<Tag>::value
          , ::qsboost::function_types::detail::mask<Tag>::value
          , ::qsboost::function_types::detail::bits<QueryTag>::value
          , ::qsboost::function_types::detail::mask<QueryTag>::value
          >::match
      >
  { };
...
#include <qsboost/function_types/detail/pp_tags/preprocessed.hpp>

namespace qsboost { namespace function_types {
#define QSBOOST_FT_cc_file <qsboost/function_types/detail/pp_tags/cc_tag.hpp>
