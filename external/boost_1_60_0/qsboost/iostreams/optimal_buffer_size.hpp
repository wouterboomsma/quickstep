...
#ifndef QSBOOST_IOSTREAMS_OPTIMAL_BUFFER_SIZE_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_OPTIMAL_BUFFER_SIZE_HPP_INCLUDED
...
#include <qsboost/iostreams/constants.hpp>  // constants.
