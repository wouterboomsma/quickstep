...
#ifndef QSBOOST_IOSTREAMS_NULL_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_NULL_HPP_INCLUDED
...
#include <qsboost/iostreams/detail/ios.hpp> // openmode, streamsize.
...
public:
    ...
    std::streampos seek( stream_offset, QSBOOST_IOS::seekdir,
