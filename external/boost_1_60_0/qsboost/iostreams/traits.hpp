...
#ifndef QSBOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
...
#include <qsboost/config.hpp>  // partial spec, deduced typename.
...
#include <qsboost/iostreams/detail/select_by_size.hpp>      
#include <qsboost/iostreams/detail/wrap_unwrap.hpp>       
#include <qsboost/iostreams/traits_fwd.hpp> 
...
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::basic_istream, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::basic_ostream, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::basic_iostream, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::basic_streambuf, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ifstream, std::basic_ifstream, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ofstream, std::basic_ofstream, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_fstream, std::basic_fstream, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_filebuf, std::basic_filebuf, 2)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istringstream, std::basic_istringstream, 3)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostringstream, std::basic_ostringstream, 3)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringstream, std::basic_stringstream, 3)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringbuf, std::basic_stringbuf, 3)

#else // #ifndef BOOST_IOSTREAMS_NO_STREAM_TEMPLATES //-----------------------//

QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::istream, 0)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::ostream, 0)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::iostream, 0)
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::streambuf, 0)
...
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_qsboost_stream,
                                qsboost::iostreams::stream,
                                3 )
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_qsboost_stream_buffer,
                                qsboost::iostreams::stream_buffer,
                                4 )
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_stream_impl,
                                qsboost::iostreams::filtering_stream,
                                5 )
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstream_impl,
                                qsboost::iostreams::wfiltering_stream,
                                5 )
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_streambuf_impl,
                                qsboost::iostreams::filtering_streambuf,
                                5 )
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstreambuf_impl,
                                qsboost::iostreams::filtering_wstreambuf,
                                5 )
QSBOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_linked, linked_streambuf, 2)
...
#ifndef QSBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION //---------------------------//
# ifndef QSBOOST_IOSTREAMS_NO_STREAM_TEMPLATES //-------------------------------//
...
struct char_type_of {
    ...
    typedef typename 
            mpl::eval_if<
                ...
                get_value_type<T>,
                detail::member_char_type<
                    QSBOOST_DEDUCED_TYPENAME detail::unwrapped_type<T>::type
                >
            >::type type;
};
...
#define QSBOOST_IOSTREAMS_MODE_HELPER(tag_, id_) \
    case_<id_> io_mode_impl_helper(tag_); \
    template<> struct io_mode_impl<id_> { typedef tag_ type; }; \
    /**/
QSBOOST_IOSTREAMS_MODE_HELPER(input, 1)
QSBOOST_IOSTREAMS_MODE_HELPER(output, 2)
QSBOOST_IOSTREAMS_MODE_HELPER(bidirectional, 3)
QSBOOST_IOSTREAMS_MODE_HELPER(input_seekable, 4)
QSBOOST_IOSTREAMS_MODE_HELPER(output_seekable, 5)
QSBOOST_IOSTREAMS_MODE_HELPER(seekable, 6)
QSBOOST_IOSTREAMS_MODE_HELPER(dual_seekable, 7)
QSBOOST_IOSTREAMS_MODE_HELPER(bidirectional_seekable, 8)
QSBOOST_IOSTREAMS_MODE_HELPER(dual_use, 9)
#undef QSBOOST_IOSTREAMS_MODE_HELPER

template<typename T>
struct io_mode_id {
    typedef typename category_of<T>::type category;
    QSBOOST_SELECT_BY_SIZE(int, value, detail::io_mode_impl_helper(category()));
};
...
struct has_trait_impl {
    typedef typename category_of<T>::type category;
    QSBOOST_STATIC_CONSTANT(bool, value = (is_convertible<category, Tag>::value));
};
...
#define QSBOOST_IOSTREAMS_STREAMBUF_TYPEDEFS(Tr) \
