...
#ifndef QSBOOST_IOSTREAMS_FLUSH_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_FLUSH_HPP_INCLUDED
...
struct flush_device_impl<ostream_tag> {
    ...
    { return t.rdbuf()->QSBOOST_IOSTREAMS_PUBSYNC() == 0; }
};
...
struct flush_device_impl<streambuf_tag> {
    template<typename T>
    static bool flush(T& t)
    { return t.QSBOOST_IOSTREAMS_PUBSYNC() == 0; }
};
