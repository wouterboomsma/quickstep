...
#ifndef QSBOOST_IOSTREAMS_IO_TRAITS_FWD_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_IO_TRAITS_FWD_HPP_INCLUDED
...
template<typename T>
struct is_qsboost_stream;

template<typename T>
struct is_qsboost_stream_buffer;
