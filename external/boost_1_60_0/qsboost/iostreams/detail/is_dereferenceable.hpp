...
#ifndef QSBOOST_IOSTREAMS_DETAIL_IS_DEREFERENCEABLE_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_IS_DEREFERENCEABLE_HPP_INCLUDED

# include <qsboost/type_traits/detail/bool_trait_def.hpp>
...
# endif 
  ...
  struct impl
  {
      ...
      QSBOOST_STATIC_CONSTANT(
          bool
        , value = sizeof(is_dereferenceable_::check_increment(QSBOOST_comma(*x,0))) == 1
      );
  };
}
...
struct is_dereferenceable 
    QSBOOST_TT_AUX_BOOL_C_BASE(is_dereferenceable_::impl<T>::value)
{ 
    QSBOOST_TT_AUX_BOOL_TRAIT_VALUE_DECL(is_dereferenceable_::impl<T>::value)
    QSBOOST_MPL_AUX_LAMBDA_SUPPORT(1,is_dereferenceable,(T))
};

} } 

QSBOOST_TT_AUX_TEMPLATE_ARITY_SPEC(1, ::qsboost::iostreams::detail::is_dereferenceable)
