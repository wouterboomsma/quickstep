...
#ifndef QSBOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
...
# include <qsboost/config.hpp> // Make sure size_t is in std.
# include <cstddef>
# include <cstring>
# include <cstdio>
#endif
...
# define QSBOOST_IOSTREAMS_CHAR_TRAITS(ch) std::char_traits< ch >
#else
# define QSBOOST_IOSTREAMS_CHAR_TRAITS(ch) qsboost::iostreams::detail::char_traits
