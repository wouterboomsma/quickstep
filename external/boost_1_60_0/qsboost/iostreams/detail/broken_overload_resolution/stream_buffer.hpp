...
#ifndef QSBOOST_IOSTREAMS_DETAIL_BROKEN_OVERLOAD_RESOLUTION_STREAM_BUFFER_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_BROKEN_OVERLOAD_RESOLUTION_STREAM_BUFFER_HPP_INCLUDED
...
private:
    ...
    {
        if (this->is_open()) 
            qsboost::throw_exception(QSBOOST_IOSTREAMS_FAILURE("already open"));
    }
};
