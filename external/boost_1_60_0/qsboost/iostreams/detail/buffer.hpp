...
#ifndef QSBOOST_IOSTREAMS_DETAIL_BUFFERS_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_BUFFERS_HPP_INCLUDED
...
#include <qsboost/config.hpp>                    // member templates.
#include <qsboost/iostreams/char_traits.hpp>
#include <qsboost/iostreams/detail/ios.hpp>      // streamsize.
#include <qsboost/iostreams/read.hpp>
#include <qsboost/iostreams/traits.hpp>          // int_type_of.
#include <qsboost/iostreams/checked_operations.hpp>
...
class basic_buffer {
private:
#ifndef QSBOOST_NO_STD_ALLOCATOR
...
inline basic_buffer<Ch, Alloc>::~basic_buffer()
{
    if (buf_) {
        allocator_type().deallocate(buf_,
            static_cast<QSBOOST_DEDUCED_TYPENAME Alloc::size_type>(size_));
    }
}
