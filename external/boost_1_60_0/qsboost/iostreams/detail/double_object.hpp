...
#ifndef QSBOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
...
#else
    typedef qsboost::call_traits<T>                  traits_type;
#endif
