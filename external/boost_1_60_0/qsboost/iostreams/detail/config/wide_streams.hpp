...
#ifndef QSBOOST_IOSTREAMS_DETAIL_CONFIG_WIDE_STREAMS_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_CONFIG_WIDE_STREAMS_HPP_INCLUDED
...
# if defined(__STL_CONFIG_H) && \
    ...
    /**/
#  define QSBOOST_IOSTREAMS_NO_STREAM_TEMPLATES
# endif
#endif // #ifndef BOOST_IOSTREAMS_NO_STREAM_TEMPLATES

//------------------Wide stream support---------------------------------------//

#ifndef QSBOOST_IOSTREAMS_NO_WIDE_STREAMS
# if defined(QSBOOST_IOSTREAMS_NO_STREAM_TEMPLATES) || \
     defined (QSBOOST_NO_STD_WSTREAMBUF) && \
     ( !defined(__MSL_CPP__) || defined(_MSL_NO_WCHART_CPP_SUPPORT) ) \
     /**/
#  define QSBOOST_IOSTREAMS_NO_WIDE_STREAMS
# endif
...
# if defined(QSBOOST_NO_STD_LOCALE) || \
     ...
     ( !defined(__MSL_CPP__) || defined(_MSL_NO_WCHART_CPP_SUPPORT) ) \
     /**/
#  define QSBOOST_IOSTREAMS_NO_LOCALE
# endif
