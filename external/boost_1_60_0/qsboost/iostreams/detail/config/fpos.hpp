...
#ifndef QSBOOST_IOSTREAMS_DETAIL_CONFIG_FPOS_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_CONFIG_FPOS_HPP_INCLUDED
...
# if (defined(_YVALS) || defined(_CPPLIB_VER)) && !defined(__SGI_STL_PORT) && \
     ...
     /**/
#  define QSBOOST_IOSTREAMS_HAS_DINKUMWARE_FPOS
# endif
