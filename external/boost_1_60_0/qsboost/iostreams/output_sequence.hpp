...
#ifndef QSBOOST_IOSTREAMS_OUTPUT_SEQUENCE_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_OUTPUT_SEQUENCE_HPP_INCLUDED
...
#include <qsboost/iostreams/operations_fwd.hpp>  // is_custom 
...
struct output_sequence_impl<direct_tag> {
    template<typename U>
    static std::pair<
        QSBOOST_DEDUCED_TYPENAME char_type_of<U>::type*,
        QSBOOST_DEDUCED_TYPENAME char_type_of<U>::type*
    >
