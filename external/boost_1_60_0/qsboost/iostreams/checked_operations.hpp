...
#ifndef QSBOOST_IOSTREAMS_DETAIL_CHECKED_OPERATIONS_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_DETAIL_CHECKED_OPERATIONS_HPP_INCLUDED
...
#include <qsboost/iostreams/get.hpp>
#include <qsboost/iostreams/put.hpp>
#include <qsboost/iostreams/read.hpp>
#include <qsboost/iostreams/seek.hpp>
#include <qsboost/iostreams/traits.hpp>
#include <qsboost/iostreams/write.hpp>
...
seek_if( T& t, stream_offset off, QSBOOST_IOS::seekdir way, 
         QSBOOST_IOS::openmode which = QSBOOST_IOS::in | QSBOOST_IOS::out )
{ 
...
struct read_write_if_impl<input> {
    ...
    { qsboost::throw_exception(cant_write());
      QSBOOST_IOSTREAMS_UNREACHABLE_RETURN(false) }
...
struct seek_if_impl<random_access> {
    ...
    seek( T& t, stream_offset off, QSBOOST_IOS::seekdir way, 
...
struct seek_if_impl<any_tag> {
    template<typename T>
    static std::streampos 
    seek(T&, stream_offset, QSBOOST_IOS::seekdir, QSBOOST_IOS::openmode)
    { qsboost::throw_exception(cant_seek());
      QSBOOST_IOSTREAMS_UNREACHABLE_RETURN(std::streampos()) }
};
