...
#ifndef QSBOOST_IOSTREAMS_CHAR_TRAITS_HPP_INCLUDED
#define QSBOOST_IOSTREAMS_CHAR_TRAITS_HPP_INCLUDED
...
#if (defined(__QNX__) && defined(QSBOOST_DINKUMWARE_STDLIB))  \
    || defined(__SUNPRO_CC)
using ::std::wint_t;
#endif
...
template<>
struct char_traits<char> : QSBOOST_IOSTREAMS_CHAR_TRAITS(char) {
