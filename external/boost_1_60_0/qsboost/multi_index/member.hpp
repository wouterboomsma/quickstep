...
#ifndef QSBOOST_MULTI_INDEX_MEMBER_HPP
#define QSBOOST_MULTI_INDEX_MEMBER_HPP
...
#if defined(QSBOOST_NO_POINTER_TO_MEMBER_TEMPLATE_PARAMETERS)
#define QSBOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::qsboost::multi_index::member_offset< Class,Type,offsetof(Class,MemberName) >
#else
#define QSBOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::qsboost::multi_index::member< Class,Type,&Class::MemberName >
#endif
