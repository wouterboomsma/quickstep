...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_ORD_INDEX_ARGS_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_ORD_INDEX_ARGS_HPP
...
#include <qsboost/multi_index/tag.hpp>
...
struct ordered_index_args
{
  ...
  QSBOOST_STATIC_ASSERT(is_tag<tag_list_type>::value);
  QSBOOST_STATIC_ASSERT(!mpl::is_na<key_from_value_type>::value);
  QSBOOST_STATIC_ASSERT(!mpl::is_na<compare_type>::value);
};
