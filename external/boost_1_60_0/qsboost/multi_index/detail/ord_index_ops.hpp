...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_ORD_INDEX_OPS_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_ORD_INDEX_OPS_HPP
...
#include <qsboost/multi_index/detail/promotes_arg.hpp>
#include <utility>
...
inline Node* ordered_index_find(
  ...
  const QSBOOST_DEDUCED_TYPENAME KeyFromValue::result_type& x,
