...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_SERIALIZATION_VERSION_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_SERIALIZATION_VERSION_HPP
...
struct serialization_version
{
  serialization_version():
    value(qsboost::serialization::version<serialization_version>::value){}
...
template<typename T>
struct version<qsboost::multi_index::detail::serialization_version<T> >
{
  QSBOOST_STATIC_CONSTANT(int,value=version<T>::value);
};
} /* namespace serialization */
