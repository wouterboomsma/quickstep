...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_SCOPE_GUARD_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_SCOPE_GUARD_HPP
...
{
    typedef typename qsboost::mpl::if_c<cond,T,null_guard>::type type;
};
