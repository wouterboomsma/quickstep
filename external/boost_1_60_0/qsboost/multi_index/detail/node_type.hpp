...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_NODE_TYPE_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_NODE_TYPE_HPP
...
#include <qsboost/mpl/reverse_iter_fold.hpp>
...
struct index_node_applier
{
  ...
  struct apply
  {
    ...
    typedef typename index_specifier::
      QSBOOST_NESTED_TEMPLATE node_class<Super>::type type;
  }; 
};
