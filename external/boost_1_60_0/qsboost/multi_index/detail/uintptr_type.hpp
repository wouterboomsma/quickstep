...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
...
template<>struct uintptr_candidates<3> {typedef qsboost::ulong_long_type type;};
#else
...
struct uintptr_aux
{
  QSBOOST_STATIC_CONSTANT(int,index=
  ...
  QSBOOST_STATIC_CONSTANT(bool,has_uintptr_type=(index>=0));
