...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_INDEX_NODE_BASE_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_INDEX_NODE_BASE_HPP
...
#if defined(QSBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
...
inline void load_construct_data(
  Archive&,qsboost::multi_index::detail::index_node_base<Value,Allocator>*,
  const unsigned int)
{
  throw_exception(
