...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_HAS_TAG_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_HAS_TAG_HPP
...
struct has_tag
{
  ...
  struct apply:mpl::contains<QSBOOST_DEDUCED_TYPENAME Index::tag_list,Tag>
  {
  }; 
};
