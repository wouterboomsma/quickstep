...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_IS_TRANSPARENT_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_IS_TRANSPARENT_HPP
...
#if !defined(QSBOOST_NO_SFINAE)&&!defined(QSBOOST_NO_SFINAE_EXPR)&& \
    !defined(QSBOOST_NO_CXX11_DECLTYPE)&& \
    (defined(QSBOOST_NO_CXX11_FINAL)||defined(QSBOOST_IS_FINAL))
...
#include <qsboost/type_traits/is_final.hpp>
