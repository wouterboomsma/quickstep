...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_NO_DUPLICATE_TAGS_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_NO_DUPLICATE_TAGS_HPP
...
#include <qsboost/mpl/set/set0.hpp>
...
struct duplicate_tag_list_marker
{
  ...
  struct apply:mpl::fold<
    QSBOOST_DEDUCED_TYPENAME Index::tag_list,
    MplSet,
    duplicate_tag_marker>
  {
  };
