...
#ifndef QSBOOST_MULTI_INDEX_DETAIL_SEQ_INDEX_OPS_HPP
#define QSBOOST_MULTI_INDEX_DETAIL_SEQ_INDEX_OPS_HPP
...
void sequenced_index_collate(
  QSBOOST_DEDUCED_TYPENAME Node::impl_type* x,
  QSBOOST_DEDUCED_TYPENAME Node::impl_type* y,
  Compare comp)
{
