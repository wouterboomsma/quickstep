...
#ifndef QSBOOST_IDENTITY_TYPE_HPP_
#define QSBOOST_IDENTITY_TYPE_HPP_
...
*/
#define QSBOOST_IDENTITY_TYPE(parenthesized_type) \
    /* must NOT prefix this with `::` to work with parenthesized syntax */ \
    qsboost::function_traits< void parenthesized_type >::arg1_type
