...
#ifndef QSBOOST_STRING_FORMATTER_HPP
#define QSBOOST_STRING_FORMATTER_HPP
...
#include <qsboost/algorithm/string/detail/formatter.hpp>
        ...
        */
        ...
        const_formatter(const RangeT& Format)
        {
            return detail::const_formatF<
                iterator_range<
                    QSBOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> >(::qsboost::as_literal(Format));
        }
