...
#ifndef QSBOOST_STRING_FIND_ITERATOR_HPP
#define QSBOOST_STRING_FIND_ITERATOR_HPP
...
#include <qsboost/algorithm/string/detail/find_iterator.hpp>
...
//  find_iterator -----------------------------------------------//
        ...
        */
        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<QSBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::qsboost::as_literal(Col));
                m_Match=::qsboost::make_iterator_range(::qsboost::begin(lit_col), ::qsboost::begin(lit_col));
                m_End=::qsboost::end(lit_col);
        ...
        make_find_iterator(
            ...
            FinderT Finder)
        {
            return find_iterator<QSBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<QSBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::qsboost::as_literal(Col));
                m_Match=make_iterator_range(::qsboost::begin(lit_col), ::qsboost::begin(lit_col));
                m_Next=::qsboost::begin(lit_col);
                m_End=::qsboost::end(lit_col);
        ...
        make_split_iterator(
            ...
            FinderT Finder)
        {
            return split_iterator<QSBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
