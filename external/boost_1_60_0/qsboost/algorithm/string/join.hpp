...
#ifndef QSBOOST_STRING_JOIN_HPP
#define QSBOOST_STRING_JOIN_HPP
...
//  join --------------------------------------------------------------//
        ...
        */
            ...
            const Range1T& Separator)
        {
            ...
            // Parse input
            InputIteratorT itBegin=::qsboost::begin(Input);
            InputIteratorT itEnd=::qsboost::end(Input);
            ...
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::qsboost::end(Result), *itBegin);
                ++itBegin;
            }
            ...
            {
                // Add separator
                detail::insert(Result, ::qsboost::end(Result), ::qsboost::as_literal(Separator));
                // Add element
                detail::insert(Result, ::qsboost::end(Result), *itBegin);
            }
