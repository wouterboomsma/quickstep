...
#ifndef QSBOOST_STRING_REPLACE_HPP
#define QSBOOST_STRING_REPLACE_HPP
...
#include <qsboost/algorithm/string/find_format.hpp>
#include <qsboost/algorithm/string/finder.hpp>
#include <qsboost/algorithm/string/formatter.hpp>
...
//  replace_range --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::range_finder(SearchRange),
                ::qsboost::algorithm::const_formatter(Format));
        }
        ...
        */
            ...
            const Range3T& Format)
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::first_finder(Search),
                ::qsboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::first_finder(Search, is_iequal(Loc)),
                ::qsboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::last_finder(Search),
                ::qsboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::last_finder(Search, is_iequal(Loc)),
                ::qsboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::nth_finder(Search, Nth),
                ::qsboost::algorithm::const_formatter(Format) );
        }
       ...
       */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::nth_finder(Search, Nth, is_iequal(Loc) ),
                ::qsboost::algorithm::const_formatter(Format) );
        }
...
//  replace_all --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_copy(
            ...
            const Range3T& Format )
        {
            return ::qsboost::algorithm::find_format_all_copy(
                Output,
                Input,
                ::qsboost::algorithm::first_finder(Search),
                ::qsboost::algorithm::const_formatter(Format) );
        ...
        */
        ...
        inline void replace_all( 
            ...
            const Range2T& Format )
        {
            ::qsboost::algorithm::find_format_all( 
                Input, 
                ::qsboost::algorithm::first_finder(Search),
                ::qsboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::head_finder(N),
                ::qsboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::qsboost::algorithm::find_format_copy(
                Output,
                Input,
                ::qsboost::algorithm::tail_finder(N),
                ::qsboost::algorithm::const_formatter(Format) );
        }
