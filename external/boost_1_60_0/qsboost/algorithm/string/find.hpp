...
#ifndef QSBOOST_STRING_FIND_HPP
#define QSBOOST_STRING_FIND_HPP
...
#include <qsboost/algorithm/string/finder.hpp>
#include <qsboost/algorithm/string/compare.hpp>
#include <qsboost/algorithm/string/constants.hpp>
...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::qsboost::begin(lit_input),::qsboost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        inline iterator_range< 
            QSBOOST_STRING_TYPENAME range_iterator<Range1T>::type>
        find_first( 
            Range1T& Input, 
            const Range2T& Search)
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::qsboost::algorithm::find(Input, ::qsboost::algorithm::token_finder(Pred, eCompress));
        }
