...
#ifndef QSBOOST_STRING_SPLIT_HPP
#define QSBOOST_STRING_SPLIT_HPP

#include <qsboost/algorithm/string/config.hpp>

#include <qsboost/algorithm/string/iter_find.hpp>
...
//  find_all  ------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::qsboost::algorithm::iter_find(
                Result,
                Input,
...
//  tokenize  -------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::qsboost::algorithm::iter_split(
                Result,
                Input,
                ::qsboost::algorithm::token_finder( Pred, eCompress ) );         
        }
