...
#ifndef QSBOOST_STRING_TRIM_HPP
#define QSBOOST_STRING_TRIM_HPP
...
#include <qsboost/algorithm/string/detail/trim.hpp>
#include <qsboost/algorithm/string/classification.hpp>
#include <locale>
    ...
    //  left trim  -----------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT trim_left_copy_if( 
            ...
            PredicateT IsSpace)
        {
            iterator_range<QSBOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> lit_range(::qsboost::as_literal(Input));

            std::copy( 
                ::qsboost::algorithm::detail::trim_begin( 
                    ::qsboost::begin(lit_range), 
                    ::qsboost::end(lit_range), 
                    IsSpace ),
                ::qsboost::end(lit_range),
                Output);
        ...
        */
        ...
        {
            return            
                ::qsboost::algorithm::trim_left_copy_if(
                    Input, 
                    is_space(Loc));
        }
        ...
        */
        ...
        {
            ::qsboost::algorithm::trim_left_if( 
                Input, 
                is_space(Loc));
        }
    ...
    //  right trim  -----------------------------------------------//
        ...
        */
            ...
            PredicateT IsSpace )
        {
            ...
            std::copy( 
                ::qsboost::begin(lit_range),
                ::qsboost::algorithm::detail::trim_end( 
                    ::qsboost::begin(lit_range), 
                    ::qsboost::end(lit_range), 
                    IsSpace ),
                Output );
        ...
        */
        ...
        {
            return 
                ::qsboost::algorithm::trim_right_copy_if( 
                    Input, 
                    is_space(Loc));
        }
        ...
        */
        ...
        {
            ::qsboost::algorithm::trim_right_if(
                Input, 
                is_space(Loc) );
        }
    ...
    //  both side trim  -----------------------------------------------//
        ...
        */
            ...
            PredicateT IsSpace)
        {
            ...
            std::copy( 
                detail::trim_begin( 
                    ::qsboost::begin(lit_range), TrimEnd, IsSpace),
                TrimEnd,
                Output
                );
        ...
        */
        ...
        {
            return
                ::qsboost::algorithm::trim_copy_if(
                    Input, 
                    is_space(Loc) );
        }
        ...
        */
        ...
        {
            ::qsboost::algorithm::trim_right_if( Input, IsSpace );
            ::qsboost::algorithm::trim_left_if( Input, IsSpace );
        }
