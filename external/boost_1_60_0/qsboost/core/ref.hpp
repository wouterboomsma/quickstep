#ifndef QSBOOST_CORE_REF_HPP
#define QSBOOST_CORE_REF_HPP
...
#if defined( QSBOOST_MSVC ) && QSBOOST_WORKAROUND( QSBOOST_MSVC, == 1600 )
...
public:
    ...
    */
    QSBOOST_FORCEINLINE explicit reference_wrapper(T& t): t_(qsboost::addressof(t)) {}

#if defined( QSBOOST_MSVC ) && QSBOOST_WORKAROUND( QSBOOST_MSVC, == 1600 )

    QSBOOST_FORCEINLINE explicit reference_wrapper( T & t, ref_workaround_tag ): t_( qsboost::addressof( t ) ) {}
    ...
    */
    QSBOOST_DELETED_FUNCTION(reference_wrapper(T&& t))
public:
#endif
    ...
    /**
     ...
     @remark Does not throw.
    */
    QSBOOST_FORCEINLINE operator T& () const { return *t_; }

    /**
     @return The stored reference.
     @remark Does not throw.
    */
    QSBOOST_FORCEINLINE T& get() const { return *t_; }
    ...
    /**
     ...
     @remark Does not throw.
    */
    QSBOOST_FORCEINLINE T* get_pointer() const { return t_; }
...
/**
 @cond
*/
#if defined( __BORLANDC__ ) && QSBOOST_WORKAROUND( __BORLANDC__, QSBOOST_TESTED_AT(0x581) )
#  define QSBOOST_REF_CONST
#else
#  define QSBOOST_REF_CONST const
#endif
/**
 @endcond
*/
...
/**
 ...
 @remark Does not throw.
*/
template<class T> QSBOOST_FORCEINLINE reference_wrapper<T> QSBOOST_REF_CONST ref( T & t )
{
#if defined( QSBOOST_MSVC ) && QSBOOST_WORKAROUND( QSBOOST_MSVC, == 1600 )
...
/**
 ...
 @remark Does not throw.
*/
template<class T> QSBOOST_FORCEINLINE reference_wrapper<T const> QSBOOST_REF_CONST cref( T const & t )
{
    return reference_wrapper<T const>(t);
}

#undef QSBOOST_REF_CONST
...
#  define QSBOOST_REF_DELETE
#else
#  define QSBOOST_REF_DELETE = delete
#endif
/**
 @endcond
*/
...
/**
 @remark Construction from a temporary object is disabled.
*/
template<class T> void ref(T const&&) QSBOOST_REF_DELETE;

/**
 @remark Construction from a temporary object is disabled.
*/
template<class T> void cref(T const&&) QSBOOST_REF_DELETE;

#undef QSBOOST_REF_DELETE
...
/**
 ...
 @remark Does not throw.
*/
template<class T> QSBOOST_FORCEINLINE typename unwrap_reference<T>::type& unwrap_ref( T & t )
{
    return t;
}
...
/**
 @cond
*/
template<class T> QSBOOST_FORCEINLINE T* get_pointer( reference_wrapper<T> const & r )
{
