#ifndef QSBOOST_CORE_TYPEINFO_HPP_INCLUDED
#define QSBOOST_CORE_TYPEINFO_HPP_INCLUDED
...
{
    static qsboost::core::typeinfo ti_;
...
template<class T> qsboost::core::typeinfo core_typeid_< T >::ti_ = core_typeid_< T >::name();
#else
template<class T> qsboost::core::typeinfo core_typeid_< T >::ti_(core_typeid_< T >::name());
#endif
...
#define QSBOOST_CORE_TYPEID(T) (qsboost::detail::core_typeid_<T>::ti_)
...
#if defined( QSBOOST_NO_STD_TYPEINFO )
...
#define QSBOOST_CORE_TYPEID(T) typeid(T)
