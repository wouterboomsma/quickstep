...
#ifndef QSBOOST_FUSION_ALGORITHM_ITERATION_REVERSE_FOLD_HPP
#define QSBOOST_FUSION_ALGORITHM_ITERATION_REVERSE_FOLD_HPP

#include <qsboost/fusion/support/config.hpp>
#include <qsboost/fusion/algorithm/iteration/reverse_fold_fwd.hpp>
...
#define QSBOOST_FUSION_REVERSE_FOLD

#if !defined(QSBOOST_FUSION_DONT_USE_PREPROCESSED_FILES)
#include <qsboost/fusion/algorithm/iteration/detail/preprocessed/reverse_fold.hpp>
#else
...
#undef QSBOOST_FUSION_REVERSE_FOLD
