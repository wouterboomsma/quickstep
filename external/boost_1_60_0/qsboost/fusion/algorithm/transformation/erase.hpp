...
#include <qsboost/fusion/view/joint_view/joint_view.hpp>
#include <qsboost/fusion/view/iterator_range/iterator_range.hpp>
...
namespace qsboost { namespace fusion
{
    namespace result_of
    {
        ...
        struct erase
        {
            ...
            typedef typename result_of::end<Sequence>::type seq_last_type;
            QSBOOST_STATIC_ASSERT((!result_of::equal_to<seq_first_type, seq_last_type>::value));
