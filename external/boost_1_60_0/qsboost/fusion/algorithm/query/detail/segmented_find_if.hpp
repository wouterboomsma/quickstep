...
==============================================================================*/
#if !defined(QSBOOST_FUSION_SEGMENTED_FIND_IF_HPP_INCLUDED)
#define QSBOOST_FUSION_SEGMENTED_FIND_IF_HPP_INCLUDED

#include <qsboost/fusion/support/config.hpp>
#include <qsboost/mpl/eval_if.hpp>
#include <qsboost/mpl/identity.hpp>
#include <qsboost/fusion/algorithm/query/find_if_fwd.hpp>
