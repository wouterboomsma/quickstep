...
#include <qsboost/fusion/view/transform_view/transform_view_iterator.hpp>
#include <qsboost/fusion/view/transform_view/transform_view_fwd.hpp>
#include <qsboost/fusion/view/transform_view/detail/begin_impl.hpp>
#include <qsboost/fusion/view/transform_view/detail/end_impl.hpp>
#include <qsboost/fusion/view/transform_view/detail/at_impl.hpp>
#include <qsboost/fusion/view/transform_view/detail/value_at_impl.hpp>
#include <qsboost/fusion/view/detail/strictest_traversal.hpp>
#include <qsboost/fusion/container/vector/vector10.hpp>
...
namespace qsboost { namespace fusion
{
    ...
    {
        QSBOOST_STATIC_ASSERT(result_of::size<Sequence1>::value == result_of::size<Sequence2>::value);
