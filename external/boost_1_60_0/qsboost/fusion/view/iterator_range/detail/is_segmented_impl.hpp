...
==============================================================================*/
#if !defined(QSBOOST_FUSION_ITERATOR_RANGE_IS_SEGMENTED_HPP_INCLUDED)
#define QSBOOST_FUSION_ITERATOR_RANGE_IS_SEGMENTED_HPP_INCLUDED
