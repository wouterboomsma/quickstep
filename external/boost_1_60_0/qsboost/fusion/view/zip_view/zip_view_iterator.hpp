...
#include <qsboost/fusion/view/zip_view/zip_view_iterator_fwd.hpp>
#include <qsboost/fusion/support/iterator_base.hpp>
#include <qsboost/fusion/view/zip_view/detail/deref_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/next_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/prior_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/advance_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/distance_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/value_of_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/equal_to_impl.hpp>
...
namespace std
{
    ...
    struct iterator_traits< ::qsboost::fusion::zip_view_iterator<IteratorSequence, Traversal> >
    { };
}
#endif
