...
#include <qsboost/fusion/view/zip_view/detail/begin_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/end_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/size_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/at_impl.hpp>
#include <qsboost/fusion/view/zip_view/detail/value_at_impl.hpp>
#include <qsboost/fusion/container/vector/convert.hpp>
#include <qsboost/fusion/algorithm/query/find_if.hpp>
#include <qsboost/fusion/sequence/intrinsic/end.hpp>
#include <qsboost/fusion/sequence/intrinsic/size.hpp>
#include <qsboost/fusion/mpl.hpp>
#include <qsboost/fusion/algorithm/transformation/remove.hpp>

#include <qsboost/mpl/assert.hpp>
#include <qsboost/mpl/not.hpp>
#include <qsboost/mpl/placeholders.hpp>
#include <qsboost/mpl/transform_view.hpp>
...
namespace qsboost { namespace fusion {
    ...
    struct zip_view : sequence_base< zip_view<Sequences> >
    {
        ...
        QSBOOST_MPL_ASSERT((detail::all_references<Sequences>));
