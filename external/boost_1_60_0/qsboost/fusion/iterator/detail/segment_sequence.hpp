...
==============================================================================*/
#if !defined(QSBOOST_FUSION_SEGMENTED_SEQUENCE_HPP_INCLUDED)
#define QSBOOST_FUSION_SEGMENTED_SEQUENCE_HPP_INCLUDED
...
namespace qsboost { namespace fusion { namespace detail
{
        ...
        : sequence_base<segment_sequence<Sequence> >
    {
        ...
        QSBOOST_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED explicit segment_sequence(Sequence const & seq)
            : sequence(seq)
        {}
    };
}
