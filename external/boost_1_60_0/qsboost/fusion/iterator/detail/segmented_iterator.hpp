...
==============================================================================*/
#if !defined(QSBOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED)
#define QSBOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED
...
#include <qsboost/fusion/iterator/key_of.hpp>
#include <qsboost/fusion/iterator/value_of.hpp>
#include <qsboost/fusion/iterator/value_of_data.hpp>
#include <qsboost/fusion/iterator/detail/segmented_equal_to.hpp>
...
namespace qsboost { namespace fusion
{
    ...
    {
        QSBOOST_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED explicit segmented_iterator(Context const& ctx)
          : context(ctx)
        {}
