...
#include <qsboost/fusion/iterator/detail/advance.hpp>
...
namespace qsboost { namespace fusion
{
    ...
    struct iterator_facade : iterator_base<Derived>
    {
        ...
        struct advance :
            ...
            >::type
        {
            QSBOOST_MPL_ASSERT_NOT((traits::is_random_access<Iterator>));
        };
...
{
    template <typename Derived, typename Category>
    struct iterator_traits< ::qsboost::fusion::iterator_facade<Derived, Category> >
    { };
}
#endif
