...
==============================================================================*/
#if !defined(QSBOOST_FUSION_MAP_IMPL_02032013_2233)
#define QSBOOST_FUSION_MAP_IMPL_02032013_2233
...
namespace qsboost { namespace fusion { namespace detail
{
    ...
    struct map_impl<index_>
    {
        ...
        map_impl() QSBOOST_NOEXCEPT {}

        template <typename Iterator>
        QSBOOST_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED
        map_impl(Iterator const&, map_impl_from_iterator) QSBOOST_NOEXCEPT
        {}

        template <typename Iterator>
        QSBOOST_CXX14_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED
        void assign(Iterator const&, map_impl_from_iterator) QSBOOST_NOEXCEPT
        {}
    ...
    struct map_impl<index_, Pair, T...> : map_impl<index_ + 1, T...>
    {
        ...
        map_impl(map_impl&& rhs)
          : rest_type(QSBOOST_FUSION_FWD_ELEM(rest_type, *static_cast<rest_type*>(&rhs)))
          , element(QSBOOST_FUSION_FWD_ELEM(Pair, rhs.element))
        {}
        ...
        map_impl(Pair&& element_, T&&... rest)
          : rest_type(QSBOOST_FUSION_FWD_ELEM(T, rest)...)
          , element(QSBOOST_FUSION_FWD_ELEM(Pair, element_))
        {}
