...
#include <qsboost/fusion/support/detail/pp_round.hpp>
...
#define FUSION_MAX_VECTOR_SIZE_STR QSBOOST_PP_STRINGIZE(QSBOOST_FUSION_PP_ROUND_UP(FUSION_MAX_VECTOR_SIZE))
