...
# endif
        ...
        vector1(
          ...
          , typename qsboost::disable_if<is_convertible<Sequence, T0> >::type* = 0
            )
...
# endif
        ...
        QSBOOST_CXX14_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED typename add_reference<T0>::type at_impl(mpl::int_<0>) { return this->m0; } QSBOOST_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED typename add_reference<typename add_const<T0>::type>::type at_impl(mpl::int_<0>) const { return this->m0; }
        template<typename I>
        QSBOOST_CXX14_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED
