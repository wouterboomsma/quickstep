...
==============================================================================*/
#if !defined(QSBOOST_FUSION_VECTOR10_FWD_HPP_INCLUDED)
#define QSBOOST_FUSION_VECTOR10_FWD_HPP_INCLUDED
...
#include <qsboost/fusion/container/vector/detail/cpp03/preprocessed/vector10_fwd.hpp>
#else
...
namespace qsboost { namespace fusion
{
    ...
    #define QSBOOST_PP_FILENAME_1 <qsboost/fusion/container/vector/detail/cpp03/vector10_fwd.hpp>
