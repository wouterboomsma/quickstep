...
#include <qsboost/fusion/container/vector/detail/deref_impl.hpp>
#include <qsboost/fusion/container/vector/detail/value_of_impl.hpp>
#include <qsboost/fusion/container/vector/detail/next_impl.hpp>
#include <qsboost/fusion/container/vector/detail/prior_impl.hpp>
#include <qsboost/fusion/container/vector/detail/equal_to_impl.hpp>
#include <qsboost/fusion/container/vector/detail/distance_impl.hpp>
#include <qsboost/fusion/container/vector/detail/advance_impl.hpp>
...
{
    template <typename Vector, int N>
    struct iterator_traits< ::qsboost::fusion::vector_iterator<Vector, N> >
    { };
}
#endif
