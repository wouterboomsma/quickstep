...
==============================================================================*/
#ifndef QSBOOSTFUSION_VECTOR_11052014_1625
#define QSBOOSTFUSION_VECTOR_11052014_1625
...
# include <qsboost/fusion/container/vector/detail/cpp03/vector.hpp>
#else
...
namespace qsboost { namespace fusion
{
    ...
    namespace vector_detail
    {
        ...
        struct is_convertible_to_first
            : qsboost::is_convertible<Sequence, typename result_of::value_at_c<This, 0>::type>
        {};
        ...
        inline each_elem
        dispatch(T const&...) QSBOOST_NOEXCEPT { return each_elem(); }

        template <typename This>
        QSBOOST_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED
        inline copy_or_move
        dispatch(This const&) QSBOOST_NOEXCEPT { return copy_or_move(); }
        ...
        inline from_sequence<
            ...
            >::type
        >
        dispatch(Sequence&&) QSBOOST_NOEXCEPT
            ...
            , sequence_base<vector_data<detail::index_sequence<I...>, T...> >
        {
            ...
            static QSBOOST_CXX14_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED
            ...
            template <std::size_t N, typename U>
            static QSBOOST_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED
            ...
            template <std::size_t N, typename U>
            static QSBOOST_FUSION_GPU_ENABLED
        ...
        : vector_detail::trim_void<T...>::type
    {
        ...
        /* BOOST_CONSTEXPR */ QSBOOST_FUSION_GPU_ENABLED
        vector(U&&... u)
