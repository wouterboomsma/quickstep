...
#ifndef QSBOOST_FUSION_SUPPORT_DETAIL_INDEX_SEQUENCE_06232015_1038
#define QSBOOST_FUSION_SUPPORT_DETAIL_INDEX_SEQUENCE_06232015_1038
...
namespace qsboost { namespace fusion { namespace detail
{
    ...
    struct index_sequence
    {
        ...
        static std::size_t size() QSBOOST_NOEXCEPT
        { return sizeof...(Ints); }
