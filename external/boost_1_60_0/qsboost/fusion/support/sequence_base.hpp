...
namespace qsboost { namespace fusion
{
    ...
    struct sequence_base
    {
        ...
        Sequence const&
        derived() const QSBOOST_NOEXCEPT
        {
        ...
        Sequence&
        derived() QSBOOST_NOEXCEPT
        {
            return static_cast<Sequence&>(*this);
        }

        QSBOOST_CONSTEXPR QSBOOST_FUSION_GPU_ENABLED
        operator detail::from_sequence_convertible_type() const QSBOOST_NOEXCEPT
        {
...
namespace qsboost { namespace mpl
{
    ...
    template<> struct begin_impl< qsboost::fusion::fusion_sequence_tag >;
}}
