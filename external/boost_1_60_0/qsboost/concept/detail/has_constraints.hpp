...
#ifndef QSBOOST_CONCEPT_DETAIL_HAS_CONSTRAINTS_DWA2006429_HPP
# define QSBOOST_CONCEPT_DETAIL_HAS_CONSTRAINTS_DWA2006429_HPP
...
#if QSBOOST_WORKAROUND(__SUNPRO_CC, <= 0x580) || defined(__CUDACC__)
