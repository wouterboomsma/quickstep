...
#ifndef QSBOOST_PREDEF_HARDWARE_SIMD_ARM_VERSIONS_H
#define QSBOOST_PREDEF_HARDWARE_SIMD_ARM_VERSIONS_H
 ...
 */
#define QSBOOST_HW_SIMD_ARM_NEON_VERSION QSBOOST_VERSION_NUMBER(1, 0, 0)
