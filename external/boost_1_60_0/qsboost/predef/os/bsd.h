...
#ifndef QSBOOST_PREDEF_OS_BSD_H
#define QSBOOST_PREDEF_OS_BSD_H
...
#include <qsboost/predef/os/bsd/bsdi.h>
#include <qsboost/predef/os/bsd/dragonfly.h>
#include <qsboost/predef/os/bsd/free.h>
#include <qsboost/predef/os/bsd/open.h>
#include <qsboost/predef/os/bsd/net.h>

#ifndef QSBOOST_OS_BSD
#define QSBOOST_OS_BSD QSBOOST_VERSION_NUMBER_NOT_AVAILABLE
#endif
...
#   undef QSBOOST_OS_BSD
#   include <sys/param.h>
#   if !defined(QSBOOST_OS_BSD) && defined(BSD4_4)
#       define QSBOOST_OS_BSD QSBOOST_VERSION_NUMBER(4,4,0)
#   endif
#   if !defined(QSBOOST_OS_BSD) && defined(BSD4_3)
#       define QSBOOST_OS_BSD QSBOOST_VERSION_NUMBER(4,3,0)
#   endif
#   if !defined(QSBOOST_OS_BSD) && defined(BSD4_2)
#       define QSBOOST_OS_BSD QSBOOST_VERSION_NUMBER(4,2,0)
#   endif
#   if !defined(QSBOOST_OS_BSD) && defined(BSD)
#       define QSBOOST_OS_BSD QSBOOST_PREDEF_MAKE_10_VVRR(BSD)
#   endif
#   if !defined(QSBOOST_OS_BSD)
...
#define QSBOOST_OS_BSD_NAME "BSD"
...
QSBOOST_PREDEF_DECLARE_TEST(QSBOOST_OS_BSD,QSBOOST_OS_BSD_NAME)
