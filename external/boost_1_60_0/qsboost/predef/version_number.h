...
#ifndef QSBOOST_PREDEF_VERSION_NUMBER_H
#define QSBOOST_PREDEF_VERSION_NUMBER_H
...
*/
#define QSBOOST_VERSION_NUMBER(major,minor,patch) \
    ( (((major)%100)*10000000) + (((minor)%100)*100000) + ((patch)%100000) )

#define QSBOOST_VERSION_NUMBER_MAX \
    QSBOOST_VERSION_NUMBER(99,99,99999)

#define QSBOOST_VERSION_NUMBER_ZERO \
    QSBOOST_VERSION_NUMBER(0,0,0)

#define QSBOOST_VERSION_NUMBER_MIN \
    QSBOOST_VERSION_NUMBER(0,0,1)

#define QSBOOST_VERSION_NUMBER_AVAILABLE \
    QSBOOST_VERSION_NUMBER_MIN

#define QSBOOST_VERSION_NUMBER_NOT_AVAILABLE \
    QSBOOST_VERSION_NUMBER_ZERO
