...
#ifndef QSBOOST_PROPERTY_TREE_STREAM_TRANSLATOR_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_STREAM_TRANSLATOR_HPP_INCLUDED

#include <qsboost/property_tree/ptree_fwd.hpp>

#include <qsboost/optional.hpp>
#include <qsboost/optional/optional_io.hpp>
...
namespace qsboost { namespace property_tree
{
    ...
    namespace detail
    {
        ...
        struct is_inexact_impl
        {
            ...
            struct test
            {
                typedef qsboost::false_type type;
            };
        };
        template <>
        struct is_inexact_impl<true>
        {
            ...
            struct test
            {
              typedef qsboost::integral_constant<bool,
        ...
        struct is_inexact
        {
            typedef typename qsboost::decay<F>::type decayed;
            typedef typename is_inexact_impl<
                std::numeric_limits<decayed>::is_specialized
            >::QSBOOST_NESTED_TEMPLATE test<decayed>::type type;
    ...
    struct customize_stream<Ch, Traits, F,
        typename qsboost::enable_if< detail::is_inexact<F> >::type
    >
    {
        static void insert(std::basic_ostream<Ch, Traits>& s, const F& e) {
#ifndef QSBOOST_NO_CXX11_NUMERIC_LIMITS 
    ...
    public:
        ...
        qsboost::optional<E> get_value(const internal_type &v) {
            std::basic_istringstream<Ch, Traits, Alloc> iss(v);
            iss.imbue(m_loc);
            E e;
            customized::extract(iss, e);
            if(iss.fail() || iss.bad() || iss.get() != Traits::eof()) {
                return qsboost::optional<E>();
            }
            return e;
        }
        qsboost::optional<internal_type> put_value(const E &v) {
            ...
            return qsboost::optional<internal_type>();
        }
