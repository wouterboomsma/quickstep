...
// ----------------------------------------------------------------------------
#ifndef QSBOOST_PROPERTY_TREE_XML_PARSER_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_XML_PARSER_HPP_INCLUDED

#include <qsboost/property_tree/ptree.hpp>
#include <qsboost/property_tree/detail/xml_parser_write.hpp>
#include <qsboost/property_tree/detail/xml_parser_error.hpp>
#include <qsboost/property_tree/detail/xml_parser_writer_settings.hpp>
#include <qsboost/property_tree/detail/xml_parser_flags.hpp>
#include <qsboost/property_tree/detail/xml_parser_read_rapidxml.hpp>
...
namespace qsboost { namespace property_tree { namespace xml_parser
{
    ...
    {
        QSBOOST_ASSERT(validate_flags(flags));
        std::basic_ifstream<typename Ptree::key_type::value_type>
            stream(filename.c_str());
        if (!stream)
            QSBOOST_PROPERTY_TREE_THROW(xml_parser_error(
