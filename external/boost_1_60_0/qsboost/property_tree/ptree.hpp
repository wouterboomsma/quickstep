...
#ifndef QSBOOST_PROPERTY_TREE_PTREE_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_PTREE_HPP_INCLUDED

#include <qsboost/property_tree/ptree_fwd.hpp>
#include <qsboost/property_tree/string_path.hpp>
#include <qsboost/property_tree/stream_translator.hpp>
#include <qsboost/property_tree/exceptions.hpp>
#include <qsboost/property_tree/detail/ptree_utils.hpp>

#include <qsboost/multi_index_container.hpp>
#include <qsboost/multi_index/indexed_by.hpp>
#include <qsboost/multi_index/sequenced_index.hpp>
#include <qsboost/multi_index/ordered_index.hpp>
#include <qsboost/multi_index/member.hpp>
...
namespace qsboost { namespace property_tree
{
    ...
    class basic_ptree
    {
#if defined(QSBOOST_PROPERTY_TREE_DOXYGEN_INVOKED)
    public:
#endif
        // Internal types
        /**
...
#include <qsboost/property_tree/detail/ptree_implementation.hpp>
