...
#ifndef QSBOOST_PROPERTY_TREE_ID_TRANSLATOR_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_ID_TRANSLATOR_HPP_INCLUDED
...
namespace qsboost { namespace property_tree
{
    ...
    struct id_translator
    {
        ...
        qsboost::optional<T> get_value(const T &v) { return v; }
        qsboost::optional<T> put_value(const T &v) { return v; }
    };
