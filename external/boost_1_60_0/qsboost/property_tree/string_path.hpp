...
#ifndef QSBOOST_PROPERTY_TREE_STRING_PATH_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_STRING_PATH_HPP_INCLUDED

#include <qsboost/property_tree/ptree_fwd.hpp>
#include <qsboost/property_tree/id_translator.hpp>
...
namespace qsboost { namespace property_tree
{
    ...
    class string_path
    {
        QSBOOST_STATIC_ASSERT((is_same<String,
    ...
    public:
        ...
        string_path& operator /=(const string_path &o) {
            ...
            QSBOOST_ASSERT((m_separator == o.m_separator
                          || o.empty()
                          || o.single())
                         && "Incompatible paths.");
            if(!o.empty()) {
    ...
    {
        QSBOOST_ASSERT(!empty() && "Reducing empty path");
        ...
        QSBOOST_PROPERTY_TREE_THROW(ptree_bad_path("Path syntax error", *this));
    }
