...
// ----------------------------------------------------------------------------
#ifndef QSBOOST_PROPERTY_TREE_DETAIL_PTREE_UTILS_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_DETAIL_PTREE_UTILS_HPP_INCLUDED
...
namespace qsboost { namespace property_tree { namespace detail
{
    ...
    struct is_character : public qsboost::false_type {};
    template <>
    struct is_character<char> : public qsboost::true_type {};
    template <>
    struct is_character<wchar_t> : public qsboost::true_type {};


    QSBOOST_MPL_HAS_XXX_TRAIT_DEF(internal_type)
    QSBOOST_MPL_HAS_XXX_TRAIT_DEF(external_type)
    template <typename T>
    struct is_translator : public qsboost::mpl::and_<
