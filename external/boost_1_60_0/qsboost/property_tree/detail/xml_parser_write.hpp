...
// ----------------------------------------------------------------------------
#ifndef QSBOOST_PROPERTY_TREE_DETAIL_XML_PARSER_WRITE_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_DETAIL_XML_PARSER_WRITE_HPP_INCLUDED
...
namespace qsboost { namespace property_tree { namespace xml_parser
{
                            ...
                            const xml_writer_settings<typename Ptree::key_type> & settings)
    {
        ...
        if (!stream)
            QSBOOST_PROPERTY_TREE_THROW(xml_parser_error("write error", filename, 0));
    }
