...
// ----------------------------------------------------------------------------
#ifndef QSBOOST_PROPERTY_TREE_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
...
namespace qsboost { namespace property_tree
{
    ...
    {
        return qsboost::any_cast<D>(m_data);
    }
    ...
    {
        return qsboost::any_cast<P>(m_path);
    }
