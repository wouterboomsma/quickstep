...
// ----------------------------------------------------------------------------
#ifndef QSBOOST_PROPERTY_TREE_PTREE_FWD_HPP_INCLUDED
#define QSBOOST_PROPERTY_TREE_PTREE_FWD_HPP_INCLUDED
...
namespace qsboost { namespace property_tree
{
    ...
    concept PropertyTreeTranslator<class Tr> {
        ...
        qsboost::optional<external_type> Tr::get_value(internal_type);
        qsboost::optional<internal_type> Tr::put_value(external_type);
    }
#endif
...
#   define QSBOOST_PROPERTY_TREE_THROW(e) QSBOOST_THROW_EXCEPTION(e)
#endif
