...
#ifndef QSBOOST_FOREACH_FWD_HPP
#define QSBOOST_FOREACH_FWD_HPP

// This must be at global scope, hence the uglified name
enum qsboost_foreach_argument_dependent_lookup_hack
{
...
namespace foreach
{
    ...
    // boost::foreach::tag
    //
    typedef qsboost_foreach_argument_dependent_lookup_hack tag;
