...
#ifndef QSBOOST_TYPE_INDEX_HPP
#define QSBOOST_TYPE_INDEX_HPP
...
#if defined(QSBOOST_TYPE_INDEX_USER_TYPEINDEX)
#   include QSBOOST_TYPE_INDEX_USER_TYPEINDEX
#   ifdef QSBOOST_HAS_PRAGMA_DETECT_MISMATCH
#       pragma detect_mismatch( "boost__type_index__abi", "user defined type_index class is used: " QSBOOST_STRINGIZE(QSBOOST_TYPE_INDEX_USER_TYPEINDEX))
#   endif
#elif (!defined(QSBOOST_NO_RTTI) && !defined(QSBOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)) || defined(QSBOOST_MSVC)
#   include <qsboost/type_index/stl_type_index.hpp>
#   if defined(QSBOOST_NO_RTTI) || defined(QSBOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)
#       include <qsboost/type_index/detail/stl_register_class.hpp>
#       ifdef QSBOOST_HAS_PRAGMA_DETECT_MISMATCH
...
#   include <qsboost/type_index/detail/ctti_register_class.hpp>
#   ifdef QSBOOST_HAS_PRAGMA_DETECT_MISMATCH
#       pragma detect_mismatch( "boost__type_index__abi", "RTTI is off - using CTTI")
#   endif
#endif

#ifndef QSBOOST_TYPE_INDEX_REGISTER_CLASS
...
#define QSBOOST_TYPE_INDEX_FUNCTION_SIGNATURE QSBOOST_CURRENT_FUNCTION
...
#define QSBOOST_TYPE_INDEX_CTTI_USER_DEFINED_PARSING (0, 0, false, "")
...
#elif defined(QSBOOST_TYPE_INDEX_USER_TYPEINDEX)
    // Nothing to do
#elif (!defined(QSBOOST_NO_RTTI) && !defined(QSBOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)) || defined(QSBOOST_MSVC)
    typedef qsboost::typeindex::stl_type_index type_index;
#else 
    typedef qsboost::typeindex::ctti_type_index type_index;
#endif
...
#define QSBOOST_TYPE_INDEX_USER_TYPEINDEX <full/absolute/path/to/header/with/type_index.hpp>
...
/// \endcode
#define QSBOOST_TYPE_INDEX_REGISTER_CLASS nothing-or-some-virtual-functions
...
#define QSBOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY
...
template <class T>
inline type_index type_id() QSBOOST_NOEXCEPT {
...
/// \return boost::typeindex::type_index with information about the specified type T.
template <class T>
inline type_index type_id_with_cvr() QSBOOST_NOEXCEPT {
...
template <class T>
inline type_index type_id_runtime(const T& runtime_val) QSBOOST_NOEXCEPT {
