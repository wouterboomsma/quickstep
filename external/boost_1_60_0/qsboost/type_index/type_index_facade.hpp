...
#ifndef QSBOOST_TYPE_INDEX_TYPE_INDEX_FACADE_HPP
#define QSBOOST_TYPE_INDEX_TYPE_INDEX_FACADE_HPP
...
private:
    /// @cond
    const Derived & derived() const QSBOOST_NOEXCEPT {
...
public:
    ...
    inline bool equal(const Derived& rhs) const QSBOOST_NOEXCEPT {
    ...
    inline bool before(const Derived& rhs) const QSBOOST_NOEXCEPT {
        const char* const left = derived().raw_name();
        const char* const right = rhs.raw_name();
    ...
    inline std::size_t hash_code() const QSBOOST_NOEXCEPT {
        ...
        return qsboost::hash_range(name_raw, name_raw + std::strlen(name_raw));
    }
...
protected:
    ...
    template <class T>
    static Derived type_id() QSBOOST_NOEXCEPT;
    ...
    /// \return type_index for type T.
    template <class T>
    static Derived type_id_with_cvr() QSBOOST_NOEXCEPT;
    ...
    template <class T>
    static Derived type_id_runtime(const T& variable) QSBOOST_NOEXCEPT;
...
/// @cond
template <class Derived, class TypeInfo>
inline bool operator == (const type_index_facade<Derived, TypeInfo>& lhs, const type_index_facade<Derived, TypeInfo>& rhs) QSBOOST_NOEXCEPT {
...
template <class Derived, class TypeInfo>
inline bool operator == (const TypeInfo& lhs, const type_index_facade<Derived, TypeInfo>& rhs) QSBOOST_NOEXCEPT {
...
template <class Derived, class TypeInfo>
inline bool operator == (const type_index_facade<Derived, TypeInfo>& lhs, const TypeInfo& rhs) QSBOOST_NOEXCEPT {
...
#ifndef QSBOOST_NO_IOSTREAM
#ifdef QSBOOST_NO_TEMPLATED_IOSTREAMS
/// @cond
...
/// \note <boost/functional/hash.hpp> has to be included if this function is used.
template <class Derived, class TypeInfo>
inline std::size_t hash_value(const type_index_facade<Derived, TypeInfo>& lhs) QSBOOST_NOEXCEPT {
