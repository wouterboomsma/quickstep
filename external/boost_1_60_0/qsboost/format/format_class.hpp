...
#ifndef QSBOOST_FORMAT_CLASS_HPP
#define QSBOOST_FORMAT_CLASS_HPP


#include <vector>
#include <string>

#include <qsboost/optional.hpp> // to store locale when needed

#include <qsboost/format/format_fwd.hpp>
#include <qsboost/format/internals_fwd.hpp>
#include <qsboost/format/internals.hpp>
#include <qsboost/format/alt_sstream.hpp>
...
namespace qsboost {
    ...
    private:
        ...
        qsboost::optional<io::detail::locale_t>     loc_;
    }; // class basic_format
