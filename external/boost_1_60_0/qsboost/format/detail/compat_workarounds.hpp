...
#ifndef QSBOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
#define QSBOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
...
#include <qsboost/format/detail/config_macros.hpp>
   // sets-up macros and load compiler-specific workarounds headers.

#if !defined(QSBOOST_FORMAT_STREAMBUF_DEFINED)
// workarounds-gcc-2.95 might have defined own streambuf
#include <streambuf>
#endif

#if !defined(QSBOOST_FORMAT_OSTREAM_DEFINED)
