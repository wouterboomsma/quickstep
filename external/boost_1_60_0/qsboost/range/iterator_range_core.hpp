...
// to function types.
//
#ifndef QSBOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED
#define QSBOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED

#include <qsboost/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <qsboost/range/functions.hpp>
...
#include <qsboost/range/detail/safe_bool.hpp>
...
namespace qsboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( qsboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( qsboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( qsboost::begin(l),
                                                 qsboost::end(l),
                                                 qsboost::begin(r),
                                                 qsboost::end(r) );
        }
...
incrementable_t test_traversal_tag(qsboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(qsboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(qsboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef qsboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef qsboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef qsboost::random_access_traversal_tag type;
};
...
{
    typedef
        QSBOOST_DEDUCED_TYPENAME iterator_traversal<IteratorT>::type
    traversal_t;
    ...
    typedef
        QSBOOST_DEDUCED_TYPENAME pure_iterator_traversal_impl<traversal_i>::type
    type;
};
...
public:
    typedef QSBOOST_DEDUCED_TYPENAME
...
public:
   ...
   {
       QSBOOST_ASSERT(n >= difference_type());
...
public:
    typedef QSBOOST_DEDUCED_TYPENAME base_type::difference_type difference_type;
    typedef QSBOOST_DEDUCED_TYPENAME base_type::reference reference;

    reference back() const
    {
        QSBOOST_ASSERT(!this->empty());
        return *qsboost::prior(this->m_End);
    }
...
public:
    typedef QSBOOST_DEDUCED_TYPENAME
        qsboost::mpl::if_<
            qsboost::mpl::or_<
                qsboost::is_abstract<
                    QSBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                qsboost::is_array<
                    QSBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                ...
                >
            >,
            QSBOOST_DEDUCED_TYPENAME base_type::reference,
            QSBOOST_DEDUCED_TYPENAME base_type::value_type
    ...
    // type.
    typedef QSBOOST_DEDUCED_TYPENAME base_type::difference_type difference_type;
    typedef QSBOOST_DEDUCED_TYPENAME base_type::size_type size_type;
    typedef QSBOOST_DEDUCED_TYPENAME base_type::reference reference;
...
public:
    ...
    {
        QSBOOST_ASSERT(at >= 0);
        QSBOOST_ASSERT(static_cast<typename base_type::size_type>(at) < size());
    ...
    QSBOOST_DEDUCED_TYPENAME base_type::size_type size() const
    {
        ...
        */
        ...
        class iterator_range
            : public iterator_range_detail::iterator_range_base<
                    IteratorT,
                    QSBOOST_DEDUCED_TYPENAME iterator_range_detail::pure_iterator_traversal<IteratorT>::type
                >
        {
            ...
            struct is_compatible_range_
              : is_convertible<
                    QSBOOST_DEDUCED_TYPENAME mpl::eval_if<
                        ...
                        mpl::identity<void>
                    >::type,
                    QSBOOST_DEDUCED_TYPENAME base_type::iterator
                >
            {
            };
        ...
        public:
            ...
            iterator_range& advance_begin(
                QSBOOST_DEDUCED_TYPENAME base_type::difference_type n)
            {
                std::advance(this->m_Begin, n);
                return *this;
            }
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline QSBOOST_DEDUCED_TYPENAME qsboost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline QSBOOST_DEDUCED_TYPENAME qsboost::enable_if<
            mpl::not_<qsboost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, qsboost::next(first, n));
        }
        ...
        {
            return iterator_range< QSBOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( qsboost::begin( r ), qsboost::end( r ) );
        }
        ...
        */
        template< class ForwardRange >
        inline iterator_range< QSBOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type >
        make_iterator_range( ForwardRange& r )
        {
           return iterator_range< QSBOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type >
                ( r, iterator_range_detail::range_tag() );
        }

        template< class ForwardRange >
        inline iterator_range< QSBOOST_DEDUCED_TYPENAME range_iterator<const ForwardRange>::type >
        make_iterator_range( const ForwardRange& r )
        {
           return iterator_range< QSBOOST_DEDUCED_TYPENAME range_iterator<const ForwardRange>::type >
        ...
        namespace iterator_range_detail
        {
            ...
            make_range_impl( Range& r,
                             QSBOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_begin,
                             QSBOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                //
                ...
                QSBOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = qsboost::begin( r ),
                    new_end   = qsboost::end( r );
        ...
        template< class Range >
        inline iterator_range< QSBOOST_DEDUCED_TYPENAME range_iterator<const Range>::type >
        ...
        */
        ...
        {
            return SeqT( qsboost::begin( r ), qsboost::end( r ) );
        }
