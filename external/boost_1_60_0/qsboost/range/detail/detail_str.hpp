...
#ifndef QSBOOST_RANGE_DETAIL_DETAIL_STR_HPP
#define QSBOOST_RANGE_DETAIL_DETAIL_STR_HPP
...
namespace qsboost 
{
    ...
    namespace range_detail
    {
        ...
        { 
            ...
            struct pts
            {
                 typedef QSBOOST_RANGE_DEDUCED_TYPENAME 
        ...
        { 
            ...
            struct pts
            {
                typedef const QSBOOST_RANGE_DEDUCED_TYPENAME 
                    remove_extent<T>::type* type;
            };
        };
...
#include <qsboost/range/detail/size_type.hpp>
#include <qsboost/range/detail/value_type.hpp>
...
namespace qsboost 
{
    ...
    namespace range_detail
    {
        ...
        str_begin( C& c )
        {
            return range_detail::range_begin< QSBOOST_RANGE_DEDUCED_TYPENAME 
        ...
        struct range_end<char_array_>
        {
            ...
            static T* fun( T QSBOOST_RANGE_ARRAY_REF()[sz] )
            {
                return qsboost::range_detail::array_end( qsboost_range_array );
            }
        };
        ...
        struct range_end<char_ptr_>
        {
            static char* fun( char* s )
            {
                return qsboost::range_detail::str_end( s );
            }
        };
        ...
        str_end( C& c )
        {
            return range_detail::range_end< QSBOOST_RANGE_DEDUCED_TYPENAME 
                range_detail::range<C>::type >::fun( c );
        }
