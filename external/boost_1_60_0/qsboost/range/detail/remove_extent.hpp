...
#ifndef QSBOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP
#define QSBOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP

#include <qsboost/config.hpp>  // MSVC, NO_INTRINSIC_WCHAR_T, put size_t in std.
#include <cstddef>
...
namespace qsboost 
{
    namespace range_detail
    {
        ...
        struct remove_extent {
            static T* ar;
            QSBOOST_STATIC_CONSTANT(std::size_t, size = sizeof(*ar) / sizeof((*ar)[0]));
