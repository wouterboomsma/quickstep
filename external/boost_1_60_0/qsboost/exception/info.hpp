...
#ifndef QSBOOSTUUID_8D22C4CA9CC811DCAA9133D256D89593
#define QSBOOSTUUID_8D22C4CA9CC811DCAA9133D256D89593
...
#include <qsboost/exception/to_string_stub.hpp>
#include <qsboost/exception/detail/error_info_impl.hpp>
...
qsboost
    ...
    exception_detail
        ...
        error_info_container_impl:
            ...
            get( type_info_ const & ti ) const
                ...
                if( info_.end()!=i )
                    ...
                    QSBOOST_ASSERT( *QSBOOST_EXCEPTION_DYNAMIC_TYPEID(*p).type_==*ti.type_ );
#endif
                    return p;
                    }
            ...
            friend class qsboost::exception;
        ...
        set_info( E const & x, error_info<Tag,T> const & v )
            ...
            c->set(p,QSBOOST_EXCEPTION_STATIC_TYPEID(error_info_tag_t));
            return x;
            }

        template <class T>
        struct
        derives_qsboost_exception
            {
            enum e { value = (sizeof(dispatch_qsboost_exception((T*)0))==sizeof(large_size)) };
            };
        }

    template <class E,class Tag,class T>
    inline
    typename enable_if<exception_detail::derives_qsboost_exception<E>,E const &>::type
