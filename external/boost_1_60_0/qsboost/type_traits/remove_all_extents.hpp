...
#ifndef QSBOOST_TT_REMOVE_ALL_EXTENTS_HPP_INCLUDED
#define QSBOOST_TT_REMOVE_ALL_EXTENTS_HPP_INCLUDED
...
#if !QSBOOST_WORKAROUND(__BORLANDC__, QSBOOST_TESTED_AT(0x610)) && !defined(__IBMCPP__) &&  !QSBOOST_WORKAROUND(__DMC__, QSBOOST_TESTED_AT(0x840))
