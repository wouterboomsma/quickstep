...
#ifndef QSBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
#define QSBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
#define PP2 <qsboost/preprocessor/enum_params.hpp>
#define PP3 <qsboost/preprocessor/comma_if.hpp>
#include PP1
#include PP2
#include PP3
#undef PP1
...
no_type QSBOOST_TT_DECL is_function_ptr_tester(...);
...
#define QSBOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "qsboost/type_traits/detail/is_function_ptr_tester.hpp"))
...
yes_type is_function_ptr_tester(R (*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));
...
@#ifdef QSBOOST_TT_TEST_MS_FUNC_SIGS
template <class R QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));
@#ifndef _MANAGED
template <class R QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));
@#endif
template <class R QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));
@#endif
