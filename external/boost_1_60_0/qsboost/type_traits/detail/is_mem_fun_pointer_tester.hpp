...
#ifndef QSBOOST_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
#define QSBOOST_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
...
//
#define PPI <qsboost/preprocessor/iterate.hpp>
#include PPI
#undef PPI
#define PPI <qsboost/preprocessor/enum_params.hpp>
#include PPI
#undef PPI
#define <qsboost/preprocessor/comma_if.hpp>
#include PPI
#undef
#endif
...
no_type QSBOOST_TT_DECL is_mem_fun_pointer_tester(...);
...
template <class R, class T >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)( ...) const volatile);
#ifdef QSBOOST_TT_TEST_MS_FUNC_SIGS
template <class R, class T >
...
#define QSBOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "qsboost/type_traits/detail/is_mem_fun_pointer_tester.hpp"))
...
template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) volatile);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const volatile);
...
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T) ...) const volatile);
@#endif
@#ifdef QSBOOST_TT_TEST_MS_FUNC_SIGS // Other calling conventions used by MS compatible compilers:
template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) volatile);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const volatile);

@#ifndef _MANAGED
template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) volatile);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const volatile);

@#endif

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)));

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) volatile);

template <class R, class T QSBOOST_PP_COMMA_IF(QSBOOST_PP_COUNTER) QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(QSBOOST_PP_ENUM_PARAMS(QSBOOST_PP_COUNTER,T)) const volatile);
