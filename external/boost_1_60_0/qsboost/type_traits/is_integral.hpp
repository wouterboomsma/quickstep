...
#ifndef QSBOOST_TT_IS_INTEGRAL_HPP_INCLUDED
#define QSBOOST_TT_IS_INTEGRAL_HPP_INCLUDED
...
template<> struct is_integral< ::qsboost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::qsboost::long_long_type> : public true_type{};
...
template<> struct is_integral<qsboost::int128_type> : public true_type{};
template<> struct is_integral<qsboost::uint128_type> : public true_type{};
#endif
