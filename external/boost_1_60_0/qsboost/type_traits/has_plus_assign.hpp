...
#ifndef QSBOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED
#define QSBOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED

#define QSBOOST_TT_TRAIT_NAME has_plus_assign
...
#define QSBOOST_TT_FORBIDDEN_IF\
   (\
      ...
      (\
         ::qsboost::is_pointer< Rhs_noref >::value && \
         ::qsboost::is_fundamental< Lhs_nocv >::value && \
         (!  ::qsboost::is_same< Lhs_nocv, bool >::value )\
      ) || \
      ...
      (\
         ...
         ::qsboost::is_const< Lhs_noref >::value\
      )\
      )
