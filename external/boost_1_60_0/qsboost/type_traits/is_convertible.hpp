...
#ifndef QSBOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED
#define QSBOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED

#include <qsboost/type_traits/intrinsics.hpp>
#include <qsboost/type_traits/integral_constant.hpp>
#ifndef QSBOOST_IS_CONVERTIBLE
...
#if !defined(QSBOOST_NO_SFINAE_EXPR) && !defined(QSBOOST_NO_CXX11_RVALUE_REFERENCES) && !(defined(QSBOOST_GCC) && (QSBOOST_GCC < 40700))

   // This is a C++11 conforming version, place this first and use it wherever possible:

#  define QSBOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<qsboost::is_void<From>, qsboost::is_function<To>, qsboost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(qsboost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::qsboost::type_traits::no_type QSBOOST_TT_DECL _m_check(...);
        static ::qsboost::type_traits::yes_type QSBOOST_TT_DECL _m_check(T);
    };
...
template <typename T> struct checker
{
    static qsboost::type_traits::no_type _m_check(any_conversion ...);
    static qsboost::type_traits::yes_type _m_check(T, int);
};
...
#if !defined(QSBOOST_NO_CXX11_RVALUE_REFERENCES) && ((__GNUC__ > 4) || ((__GNUC__ == 4) && (__GNUC_MINOR__ > 6)))
    static bool const value =
        sizeof( qsboost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::qsboost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( qsboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::qsboost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::qsboost::type_traits::no_type QSBOOST_TT_DECL _m_check(any_conversion ...);
    static ::qsboost::type_traits::yes_type QSBOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    QSBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::qsboost::type_traits::yes_type)
        );
#else
    QSBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::qsboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::qsboost::type_traits::no_type QSBOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::qsboost::type_traits::yes_type QSBOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef QSBOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::qsboost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::qsboost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::qsboost::type_traits::no_type QSBOOST_TT_DECL _m_check(...);
    static ::qsboost::type_traits::yes_type QSBOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef QSBOOST_NO_CXX11_RVALUE_REFERENCES
    QSBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::qsboost::type_traits::yes_type)
        );
#else
    QSBOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::qsboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::qsboost::is_function<typename ::qsboost::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::qsboost::detail::is_convertible_basic_impl<From,To>::value && ! ::qsboost::is_array<To>::value && ! ::qsboost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   QSBOOST_STATIC_CONSTANT(bool, value = ( ::qsboost::detail::is_convertible_basic_impl<From, To>::value && !::qsboost::is_array<To>::value && !::qsboost::is_function<To>::value));
};
#endif
...
{
#if !QSBOOST_WORKAROUND(__HP_aCC, < 60700)
   typedef is_convertible_impl_select< 
      ::qsboost::is_arithmetic<From>::value, 
      ::qsboost::is_arithmetic<To>::value,
#if !defined(QSBOOST_NO_IS_ABSTRACT) && !defined(QSBOOST_TT_CXX11_IS_CONVERTIBLE)
      // We need to filter out abstract types, only if we don't have a strictly conforming C++11 version:
      ::qsboost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::qsboost::detail::is_convertible_impl_dispatch<From, To>::value> {};

#else

template <class From, class To>
struct is_convertible : public integral_constant<bool, QSBOOST_IS_CONVERTIBLE(From, To)> {};
