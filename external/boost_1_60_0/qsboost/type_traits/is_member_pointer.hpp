...
#ifndef QSBOOST_TT_IS_MEMBER_POINTER_HPP_INCLUDED
#define QSBOOST_TT_IS_MEMBER_POINTER_HPP_INCLUDED
...
#else
template <class T> struct is_member_pointer : public integral_constant<bool, ::qsboost::is_member_function_pointer<T>::value>{};
template <class T, class U> struct is_member_pointer<U T::* > : public true_type{};

#if !QSBOOST_WORKAROUND(__MWERKS__,<=0x3003) && !QSBOOST_WORKAROUND(__IBMCPP__, <=600)
