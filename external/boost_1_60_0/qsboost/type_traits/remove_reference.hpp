...
#ifndef QSBOOST_TT_REMOVE_REFERENCE_HPP_INCLUDED
#define QSBOOST_TT_REMOVE_REFERENCE_HPP_INCLUDED
...
template <class T> struct remove_reference{ typedef typename qsboost::detail::remove_rvalue_ref<T>::type type; };
template <class T> struct remove_reference<T&>{ typedef T type; };

#if defined(QSBOOST_ILLEGAL_CV_REFERENCES)
