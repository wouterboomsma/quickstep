...
#ifndef QSBOOST_TT_DECAY_HPP_INCLUDED
#define QSBOOST_TT_DECAY_HPP_INCLUDED

#include <qsboost/type_traits/is_array.hpp>
#include <qsboost/type_traits/is_function.hpp>
#include <qsboost/type_traits/remove_bounds.hpp>
...
namespace qsboost 
{
   ...
   namespace detail
   {
    ...
    public:
       typedef typename qsboost::detail::decay_imp<Ty, qsboost::is_array<Ty>::value, qsboost::is_function<Ty>::value>::type type;
    };
