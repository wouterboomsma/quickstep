...
#ifndef QSBOOST_TYPE_TRAITS_DECLVAL_HPP_INCLUDED
#define QSBOOST_TYPE_TRAITS_DECLVAL_HPP_INCLUDED
...
namespace qsboost {
    ...
    template <typename T>
    typename add_rvalue_reference<T>::type declval() QSBOOST_NOEXCEPT; // as unevaluated operand
