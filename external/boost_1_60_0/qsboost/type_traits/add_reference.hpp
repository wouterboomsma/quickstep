...
#ifndef QSBOOST_TT_ADD_REFERENCE_HPP_INCLUDED
#define QSBOOST_TT_ADD_REFERENCE_HPP_INCLUDED
...
{
   typedef typename qsboost::detail::add_reference_impl<T>::type type;
};
