...
#ifndef QSBOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
#define QSBOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
...
{
    QSBOOST_STATIC_CONSTANT(std::size_t, value = A < S ? A : S);
};
...
struct alignment_of_impl
{
    ...
    QSBOOST_STATIC_CONSTANT(std::size_t, value =
        (::qsboost::detail::alignment_logic<
            sizeof(::qsboost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
#elif !defined(QSBOOST_ALIGNMENT_OF)
    QSBOOST_STATIC_CONSTANT(std::size_t, value =
        (::qsboost::detail::alignment_logic<
            sizeof(::qsboost::detail::alignment_of_hack<T>) - sizeof(T),
            sizeof(T)
   ...
   //
   QSBOOST_STATIC_CONSTANT(std::size_t, value = QSBOOST_ALIGNMENT_OF(T));
#endif
};

} // namespace detail

template <class T> struct alignment_of : public integral_constant<std::size_t, ::qsboost::detail::alignment_of_impl<T>::value>{};
