...
#ifndef QSBOOST_TT_IS_DEFAULT_CONSTRUCTIBLE_HPP_INCLUDED
#define QSBOOST_TT_IS_DEFAULT_CONSTRUCTIBLE_HPP_INCLUDED

#include <qsboost/type_traits/integral_constant.hpp>
#include <qsboost/detail/workaround.hpp>

#if !defined(QSBOOST_NO_CXX11_DECLTYPE) && !QSBOOST_WORKAROUND(QSBOOST_MSVC, < 1800) && !QSBOOST_WORKAROUND(QSBOOST_GCC_VERSION, < 40500)
...
namespace qsboost{
   ...
   template <class T> struct is_default_constructible : public integral_constant<bool, sizeof(detail::is_default_constructible_imp::test<T>(0)) == sizeof(qsboost::type_traits::yes_type)>{};
