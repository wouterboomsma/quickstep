...
#ifndef QSBOOST_TT_IS_POD_HPP_INCLUDED
#define QSBOOST_TT_IS_POD_HPP_INCLUDED
...
#ifndef QSBOOST_IS_POD
#define QSBOOST_INTERNAL_IS_POD(T) false
#else
#define QSBOOST_INTERNAL_IS_POD(T) QSBOOST_IS_POD(T)
#endif
...
template <typename T> struct is_pod
: public integral_constant<bool, ::qsboost::is_scalar<T>::value || ::qsboost::is_void<T>::value || QSBOOST_INTERNAL_IS_POD(T)>
{};
