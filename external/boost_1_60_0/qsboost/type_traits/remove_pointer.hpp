...
#ifndef QSBOOST_TT_REMOVE_POINTER_HPP_INCLUDED
#define QSBOOST_TT_REMOVE_POINTER_HPP_INCLUDED
...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename qsboost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::qsboost::is_pointer<T>::value>::type type;
   };
}

template <class T> struct remove_pointer{ typedef typename qsboost::detail::remove_pointer_imp2<T>::type type; };
