...
#ifndef QSBOOST_UNITS_HETEROGENEOUS_SYSTEM_HPP
#define QSBOOST_UNITS_HETEROGENEOUS_SYSTEM_HPP
...
#include <qsboost/mpl/divides.hpp>
#include <qsboost/mpl/negate.hpp>
#include <qsboost/mpl/less.hpp>
#include <qsboost/mpl/size.hpp>
#include <qsboost/mpl/begin.hpp>
...
#include <qsboost/units/detail/push_front_if.hpp>
#include <qsboost/units/detail/push_front_or_add.hpp>
#include <qsboost/units/detail/linear_algebra.hpp>
#include <qsboost/units/detail/unscale.hpp>
...
/// INTERNAL ONLY
#define QSBOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(BaseUnit, Dimensions)   \
    qsboost::units::unit<                                             \
        Dimensions,                                                 \
        qsboost::units::heterogeneous_system<                         \
            qsboost::units::heterogeneous_system_impl<                \
                qsboost::units::list<                       \
                    qsboost::units::heterogeneous_system_dim<         \
                        BaseUnit,                                   \
                        qsboost::units::static_rational<1>            \
                    >,                                              \
                    qsboost::units::dimensionless_type                \
                >,                                                  \
                Dimensions,                                         \
                qsboost::units::no_scale                              \
            >                                                       \
        >                                                           \
    >
...
QSBOOST_TYPEOF_REGISTER_TEMPLATE(qsboost::units::heterogeneous_system_impl, (class)(class)(class))
QSBOOST_TYPEOF_REGISTER_TEMPLATE(qsboost::units::heterogeneous_system, (class))
QSBOOST_TYPEOF_REGISTER_TEMPLATE(qsboost::units::heterogeneous_system_dim, (class)(class))
...
/// INTERNAL ONLY
template<>
struct less_impl<qsboost::units::heterogeneous_system_dim_tag, qsboost::units::heterogeneous_system_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<qsboost::units::heterogeneous_system_dim_tag, qsboost::units::heterogeneous_system_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef qsboost::units::heterogeneous_system_dim<
...
/// INTERNAL ONLY
template<>
struct times_impl<qsboost::units::heterogeneous_system_dim_tag, qsboost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct divides_impl<qsboost::units::heterogeneous_system_dim_tag, qsboost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct negate_impl<qsboost::units::heterogeneous_system_dim_tag>
{
    template<class T>
    struct apply
    {
        typedef qsboost::units::heterogeneous_system_dim<typename T::tag_type, typename mpl::negate<typename T::value_type>::type> type;
    };
};
...
struct make_heterogeneous_system
{
    ...
    QSBOOST_MPL_ASSERT_MSG((!qsboost::is_same<exponents, inconsistent>::value), the_specified_dimension_is_not_representible_in_the_given_system, (types<Dimensions, System>));
