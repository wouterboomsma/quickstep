...
#ifndef QSBOOST_UNITS_QUANTITY_HPP
#define QSBOOST_UNITS_QUANTITY_HPP
...
#include <qsboost/units/homogeneous_system.hpp>
...
template<class T>
struct is_base_unit<T, typename T::qsboost_units_is_base_unit_type> : mpl::true_ {};
...
struct is_non_narrowing_conversion :
    mpl::and_<
        qsboost::is_convertible<Source, Destination>,
        mpl::not_<
            mpl::and_<
                qsboost::is_arithmetic<Source>,
                qsboost::is_arithmetic<Destination>,
                mpl::or_<
                    mpl::and_<
...
class quantity
{
        ...
        QSBOOST_MPL_ASSERT_NOT((detail::is_base_unit<Unit>));
    ...
    public:
        ...
        quantity() : val_() 
        { 
            QSBOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
        }
        ...
        quantity(const quantity<Unit,YY>& source,
            typename qsboost::enable_if<detail::is_non_narrowing_conversion<YY, Y> >::type* = 0) :
            val_(source.value())
        { 
            QSBOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
        }
        ...
        explicit quantity(const quantity<Unit,YY>& source,
            typename qsboost::disable_if<detail::is_non_narrowing_conversion<YY, Y> >::type* = 0) :
        ...
        { 
            QSBOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            QSBOOST_STATIC_ASSERT((qsboost::is_convertible<YY, Y>::value == true));
        }
        ...
        this_type& operator=(const quantity<Unit2,YY>& source)
        {
            ...
            QSBOOST_STATIC_ASSERT((is_implicitly_convertible<Unit2,unit_type>::value == true));
            QSBOOST_STATIC_ASSERT((qsboost::is_convertible<YY,Y>::value == true));
        ...
        this_type& operator+=(const quantity<Unit2, YY>& source)
        {
            QSBOOST_STATIC_ASSERT((qsboost::is_same<typename add_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ += source.value();
            return *this;
        }  
        ...
        this_type& operator-=(const quantity<Unit2, YY>& source)
        {
            QSBOOST_STATIC_ASSERT((qsboost::is_same<typename subtract_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ -= source.value();
            return *this;
        }  
        ...
        this_type& operator*=(const quantity<Unit2, YY>& source)
        {
            QSBOOST_STATIC_ASSERT((qsboost::is_same<typename multiply_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ *= source.value();
            return *this;
        }  
        ...
        this_type& operator/=(const quantity<Unit2, YY>& source)
        {
            QSBOOST_STATIC_ASSERT((qsboost::is_same<typename divide_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ /= source.value();
            return *this;
        }
...
class quantity<QSBOOST_UNITS_DIMENSIONLESS_UNIT(System),Y>
{
    public:
        ...
        quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            ...
            >::type* = 0
        #else
            typename qsboost::enable_if<detail::is_non_narrowing_conversion<Y2, Y> >::type* = 0,
            typename detail::disable_if_is_same<System, System2>::type* = 0,
            typename qsboost::enable_if<detail::is_dimensionless_system<System2> >::type* = 0
        #endif
            ) :
            val_(source.value()) 
        {
        ...
        explicit quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            ...
            typename qsboost::enable_if<
                qsboost::mpl::and_<
                    qsboost::mpl::not_<detail::is_non_narrowing_conversion<Y2, Y> >,
                    detail::is_dimensionless_system<System2>
                > 
            >::type* = 0
        #else
            typename qsboost::disable_if<detail::is_non_narrowing_conversion<Y2, Y> >::type* = 0,
            typename detail::disable_if_is_same<System, System2>::type* = 0,
            typename qsboost::enable_if<detail::is_dimensionless_system<System2> >::type* = 0
        #endif
            ) :
        ...
        {
            QSBOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            QSBOOST_STATIC_ASSERT((qsboost::is_convertible<Y2, Y>::value == true));
        }
        ...
        template<class System2, class Y2> 
        explicit quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            typename qsboost::disable_if<detail::is_dimensionless_system<System2> >::type* = 0) :
        ...
        this_type& operator=(const quantity<QSBOOST_UNITS_DIMENSIONLESS_UNIT(System2),Y>& source)
        {
            *this = this_type(source);
...
QSBOOST_TYPEOF_REGISTER_TEMPLATE(qsboost::units::quantity, 2)
