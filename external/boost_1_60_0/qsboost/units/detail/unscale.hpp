...
#ifndef QSBOOST_UNITS_DETAIL_UNSCALE_HPP_INCLUDED
#define QSBOOST_UNITS_DETAIL_UNSCALE_HPP_INCLUDED
...
/// INTERNAL ONLY
template<>
struct less_impl<qsboost::units::scale_dim_tag, qsboost::units::scale_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<qsboost::units::scale_dim_tag, qsboost::units::scale_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef qsboost::units::scale_list_dim<
            qsboost::units::scale<
                (T0::base),
...
/// INTERNAL ONLY
template<>
struct negate_impl<qsboost::units::scale_dim_tag>
{
    template<class T0>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct times_impl<qsboost::units::scale_dim_tag, qsboost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
