...
#ifndef QSBOOST_UNITS_DETAIL_PUSH_FRONT_OR_ADD_HPP
#define QSBOOST_UNITS_DETAIL_PUSH_FRONT_OR_ADD_HPP
...
{
    typedef typename push_front_or_add_impl<qsboost::is_same<typename T::tag_type, typename Sequence::item::tag_type>::value>::template apply<
        Sequence,
        T
    >::type type;
};
