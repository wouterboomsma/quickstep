...
#ifndef QSBOOST_UNITS_DETAIL_CONVERSION_IMPL_HPP
#define QSBOOST_UNITS_DETAIL_CONVERSION_IMPL_HPP
...
#include <qsboost/units/heterogeneous_system.hpp>
#include <qsboost/units/homogeneous_system.hpp>
#include <qsboost/units/reduce_unit.hpp>
#include <qsboost/units/static_rational.hpp>
#include <qsboost/units/units_fwd.hpp>
#include <qsboost/units/detail/dimension_list.hpp>
#include <qsboost/units/detail/heterogeneous_conversion.hpp>
...
struct base_unit_converter_base<Source, QSBOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Source, typename Source::dimension_type)>
{
...
#define QSBOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, Dest)\
    base_unit_converter<\
...
template<class Source, class Dest>
struct call_base_unit_converter : call_base_unit_converter_impl<QSBOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, Dest)>::template apply<Source, Dest>
{
};

template<class Source, class Dest>
struct call_base_unit_converter<Source, QSBOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Dest, typename Source::dimension_type)> :
    call_base_unit_converter_base_unit_impl<
        QSBOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, typename Dest::unit_type),
        QSBOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Dest, typename Source::unit_type)
