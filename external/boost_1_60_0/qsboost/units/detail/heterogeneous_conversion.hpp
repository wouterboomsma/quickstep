...
#ifndef QSBOOST_UNITS_DETAIL_HETEROGENEOUS_CONVERSION_HPP
#define QSBOOST_UNITS_DETAIL_HETEROGENEOUS_CONVERSION_HPP
...
struct try_add_unit_impl {
    ...
    struct apply {
        ...
        QSBOOST_STATIC_ASSERT((next::size::value - 1 == type::size::value));
    };
};
