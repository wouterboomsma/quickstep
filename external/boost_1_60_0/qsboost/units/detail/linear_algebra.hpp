...
#ifndef QSBOOST_UNITS_DETAIL_LINEAR_ALGEBRA_HPP
#define QSBOOST_UNITS_DETAIL_LINEAR_ALGEBRA_HPP
...
#include <qsboost/units/detail/sort.hpp>
...
struct add_zeroes_impl {
    ...
    QSBOOST_MPL_ASSERT_MSG((N > 0), base_units_are_probably_not_linearly_independent, (void));
    template<class T>
    struct apply {
        typedef list<
            static_rational<0>,
