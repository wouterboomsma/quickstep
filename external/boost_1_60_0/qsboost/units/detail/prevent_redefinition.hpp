...
#ifndef QSBOOST_UNITS_DETAIL_PREVENT_REDEFINITION_HPP
#define QSBOOST_UNITS_DETAIL_PREVENT_REDEFINITION_HPP
...
template<class T>
detail::no 
qsboost_units_is_registered(const T&) 
{ detail::no result; return(result); }

/// INTERNAL ONLY
template<class T>
detail::no 
qsboost_units_unit_is_registered(const T&) 
{ detail::no result; return(result); }
