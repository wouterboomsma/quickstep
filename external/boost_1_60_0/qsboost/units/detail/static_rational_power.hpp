...
#ifndef QSBOOST_UNITS_DETAIL_STATIC_RATIONAL_POWER_HPP
#define QSBOOST_UNITS_DETAIL_STATIC_RATIONAL_POWER_HPP
...
struct typeof_pow
{
#if defined(QSBOOST_UNITS_HAS_QSBOOST_TYPEOF)
    QSBOOST_TYPEOF_NESTED_TYPEDEF_TPL(nested, pow(typeof_::make<Y>(), 0.0))
    typedef typename nested::type type;
#elif defined(QSBOOST_UNITS_HAS_MWERKS_TYPEOF)
    typedef __typeof__(pow(typeof_::make<Y>(), 0.0)) type;
#elif defined(QSBOOST_UNITS_HAS_GNU_TYPEOF)
