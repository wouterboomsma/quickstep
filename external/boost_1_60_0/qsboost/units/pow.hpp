...
#ifndef QSBOOST_UNITS_POW_HPP 
#define QSBOOST_UNITS_POW_HPP

#include <qsboost/math_fwd.hpp>
...
{ 
    typedef typename mpl::if_<qsboost::is_integral<T>, double, T>::type internal_type;
