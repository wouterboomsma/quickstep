...
#ifndef QSBOOST_UNITS_IO_HPP
#define QSBOOST_UNITS_IO_HPP
...
#include <qsboost/units/detail/utility.hpp>
...
inline void serialize(Archive& ar,qsboost::units::unit<Dim,System>&,const unsigned int /*version*/)
{ }

/// Boost Serialization library support for quantities.
template<class Archive,class Unit,class Y>
inline void serialize(Archive& ar,qsboost::units::quantity<Unit,Y>& q,const unsigned int /*version*/)
{
    ar & qsboost::serialization::make_nvp("value", units::quantity_cast<Y&>(q));
}
...
template<class T, bool C = qsboost::is_arithmetic<T>::value>
