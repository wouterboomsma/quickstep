...
#ifndef QSBOOST_UNITS_PLANE_ANGLE_BASE_DIMENSION_HPP
#define QSBOOST_UNITS_PLANE_ANGLE_BASE_DIMENSION_HPP
...
struct plane_angle_base_dimension : 
    qsboost::units::base_dimension<plane_angle_base_dimension,-2> 
{ };               
...
QSBOOST_TYPEOF_REGISTER_TYPE(qsboost::units::plane_angle_base_dimension)
