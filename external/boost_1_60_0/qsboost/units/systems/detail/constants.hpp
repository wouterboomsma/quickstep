...
#ifndef QSBOOST_UNITS_CONSTANTS_HPP
#define QSBOOST_UNITS_CONSTANTS_HPP

#include <qsboost/config/no_tr1/cmath.hpp>
#include <iosfwd>
#include <iomanip>

#include <qsboost/io/ios_state.hpp>
...
#define QSBOOST_UNITS_DEFINE_HELPER(name, symbol, template_name)  \
                                                                \
...
QSBOOST_UNITS_DEFINE_HELPER(add, +, unit)
QSBOOST_UNITS_DEFINE_HELPER(add, +, quantity)
QSBOOST_UNITS_DEFINE_HELPER(subtract, -, unit)
QSBOOST_UNITS_DEFINE_HELPER(subtract, -, quantity)
QSBOOST_UNITS_DEFINE_HELPER(multiply, *, unit)
QSBOOST_UNITS_DEFINE_HELPER(multiply, *, quantity)
QSBOOST_UNITS_DEFINE_HELPER(divide, /, unit)
QSBOOST_UNITS_DEFINE_HELPER(divide, /, quantity)

#undef QSBOOST_UNITS_DEFINE_HELPER

#define QSBOOST_UNITS_DEFINE_HELPER(name, symbol)                     \
                                                                    \
...
QSBOOST_UNITS_DEFINE_HELPER(add, +)
QSBOOST_UNITS_DEFINE_HELPER(subtract, -)
QSBOOST_UNITS_DEFINE_HELPER(multiply, *)
QSBOOST_UNITS_DEFINE_HELPER(divide, /)
...
#define QSBOOST_UNITS_PHYSICAL_CONSTANT(name, type, value_, uncertainty_) \
struct name ## _t {                                                     \
...
QSBOOST_UNITS_STATIC_CONSTANT(name, qsboost::units::constant<qsboost::units::physical_constant<name ## _t> >) = { }
...
{
    qsboost::io::ios_precision_saver precision_saver(os);
    //boost::io::ios_width_saver width_saver(os);
    qsboost::io::ios_flags_saver flags_saver(os);
