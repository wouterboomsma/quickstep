...
#ifndef QSBOOST_UNITS_CGS_KINEMATIC_VISCOSITY_HPP
#define QSBOOST_UNITS_CGS_KINEMATIC_VISCOSITY_HPP
...
QSBOOST_UNITS_STATIC_CONSTANT(stoke,kinematic_viscosity);           
QSBOOST_UNITS_STATIC_CONSTANT(stokes,kinematic_viscosity);    
