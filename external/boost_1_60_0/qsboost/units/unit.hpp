...
#ifndef QSBOOST_UNITS_UNIT_HPP
#define QSBOOST_UNITS_UNIT_HPP
...
#include <qsboost/units/is_dimension_list.hpp>
...
class unit
{
    public:
        ...
        #ifdef __SUNPRO_CC
        ~unit() {
            QSBOOST_MPL_ASSERT((detail::check_system<System, Dim>));
            QSBOOST_MPL_ASSERT((is_dimension_list<Dim>));
        }
        #else
    private:
        QSBOOST_MPL_ASSERT((detail::check_system<System, Dim>));
...
QSBOOST_TYPEOF_REGISTER_TEMPLATE(qsboost::units::unit, 2)
...
struct is_implicitly_convertible :
    qsboost::is_same<typename reduce_unit<S1>::type, typename reduce_unit<S2>::type>
{ };
...
{
    QSBOOST_STATIC_ASSERT((qsboost::is_same<System1,System2>::value == true));
...
operator==(const unit<Dim1,System1>&,const unit<Dim2,System2>&)
{
    return qsboost::is_same<typename reduce_unit<unit<Dim1,System1> >::type, typename reduce_unit<unit<Dim2,System2> >::type>::value;
}
