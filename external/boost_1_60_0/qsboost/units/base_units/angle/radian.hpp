...
#ifndef QSBOOST_UNITS_ANGLE_RADIAN_BASE_UNIT_HPP
#define QSBOOST_UNITS_ANGLE_RADIAN_BASE_UNIT_HPP

#include <string>

#include <qsboost/units/config.hpp>
#include <qsboost/units/base_unit.hpp>
#include <qsboost/units/physical_dimensions/plane_angle.hpp>
...
QSBOOST_TYPEOF_REGISTER_TYPE(qsboost::units::angle::radian_base_unit)
