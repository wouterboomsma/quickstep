...
#ifndef QSBOOST_UNITS_ANGLE_STERADIAN_BASE_UNIT_HPP
#define QSBOOST_UNITS_ANGLE_STERADIAN_BASE_UNIT_HPP
...
QSBOOST_TYPEOF_REGISTER_TYPE(qsboost::units::angle::steradian_base_unit)
