...
#ifndef QSBOOST_UNITS_SI_CANDELA_BASE_UNIT_HPP
#define QSBOOST_UNITS_SI_CANDELA_BASE_UNIT_HPP
...
QSBOOST_TYPEOF_REGISTER_TYPE(qsboost::units::si::candela_base_unit)
