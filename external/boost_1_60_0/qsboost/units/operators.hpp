...
#ifndef QSBOOST_UNITS_OPERATORS_HPP 
#define QSBOOST_UNITS_OPERATORS_HPP
...
{
    QSBOOST_TYPEOF_NESTED_TYPEDEF_TPL(nested, (+typeof_::make<X>()))
...
{
    QSBOOST_TYPEOF_NESTED_TYPEDEF_TPL(nested, (typeof_::make<X>()+typeof_::make<Y>()))
    typedef typename nested::type type;
};
...
#elif (QSBOOST_UNITS_HAS_GNU_TYPEOF) || defined(QSBOOST_UNITS_DOXYGEN)
...
template<typename X,typename Y> struct add_typeof_helper        { QSBOOST_STATIC_ASSERT((is_same<X,Y>::value == true)); typedef X type; };
template<typename X,typename Y> struct subtract_typeof_helper   { QSBOOST_STATIC_ASSERT((is_same<X,Y>::value == true)); typedef X type; };
template<typename X,typename Y> struct multiply_typeof_helper   { QSBOOST_STATIC_ASSERT((is_same<X,Y>::value == true)); typedef X type; };
template<typename X,typename Y> struct divide_typeof_helper     { QSBOOST_STATIC_ASSERT((is_same<X,Y>::value == true)); typedef X type; };
