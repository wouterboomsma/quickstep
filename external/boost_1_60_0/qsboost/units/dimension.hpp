...
#ifndef QSBOOST_UNITS_DIMENSION_HPP
#define QSBOOST_UNITS_DIMENSION_HPP
...
#include <qsboost/units/detail/dimension_impl.hpp>
...
template<>
struct plus_impl<qsboost::units::detail::dimension_list_tag,qsboost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        QSBOOST_STATIC_ASSERT((qsboost::is_same<T0,T1>::value == true));
        typedef T0 type;
    };
};

template<>
struct minus_impl<qsboost::units::detail::dimension_list_tag,qsboost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
template<>
struct times_impl<qsboost::units::detail::dimension_list_tag,qsboost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef typename qsboost::units::detail::merge_dimensions<T0,T1>::type type;
    };
};

template<>
struct divides_impl<qsboost::units::detail::dimension_list_tag,qsboost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef typename qsboost::units::detail::merge_dimensions<
            T0,
            typename qsboost::units::detail::static_inverse_impl<
                T1::size::value
            >::template apply<
                T1
            >::type
...
template<>
struct negate_impl<qsboost::units::detail::dimension_list_tag>
{
    template<class T0>
    struct apply
    {
