...
#ifndef QSBOOST_PROTO_DEEP_COPY_HPP_EAN_11_21_2006
#define QSBOOST_PROTO_DEEP_COPY_HPP_EAN_11_21_2006
...
namespace qsboost { namespace proto
{
      ...
      : proto::transform<_deep_copy>
    {
        ...
        struct impl
          : detail::deep_copy_impl<QSBOOST_PROTO_UNCVREF(E)>
        {};
    };
    ...
    namespace detail
    {
        ...
        #include <qsboost/proto/detail/deep_copy.hpp>
    }
