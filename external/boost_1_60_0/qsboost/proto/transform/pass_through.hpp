...
#ifndef QSBOOST_PROTO_TRANSFORM_PASS_THROUGH_HPP_EAN_12_26_2006
#define QSBOOST_PROTO_TRANSFORM_PASS_THROUGH_HPP_EAN_12_26_2006
...
#include <qsboost/proto/detail/ignore_unused.hpp>
...
namespace qsboost { namespace proto
{
    namespace detail
    {
        ...
        #include <qsboost/proto/transform/detail/pass_through_impl.hpp>
          ...
          : transform_impl<Expr, State, Data>
        {
            ...
            /// \throw nothrow
            QSBOOST_FORCEINLINE
            QSBOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(result_type, typename pass_through_impl::expr_param)
            operator()(
