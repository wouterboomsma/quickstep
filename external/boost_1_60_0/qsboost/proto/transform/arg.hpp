...
#ifndef QSBOOST_PROTO_TRANSFORM_ARG_HPP_EAN_11_01_2007
#define QSBOOST_PROTO_TRANSFORM_ARG_HPP_EAN_11_01_2007
...
#include <qsboost/proto/transform/env.hpp>
...
namespace qsboost { namespace proto
{
    ...
    struct _state : transform<_state>
    {
        ...
        struct impl : transform_impl<Expr, State, Data>
        {
            ...
            /// \return \c s
            /// \throw nothrow
            QSBOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(result_type, typename impl::state_param)
            operator ()(
    ...
    struct _child_c : transform<_child_c<N> >
    {
        ...
        struct impl : transform_impl<Expr, State, Data>
        {
            ...
            /// \throw nothrow
            #ifdef QSBOOST_PROTO_STRICT_RESULT_OF
            result_type
            #else
    ...
    struct _byref : callable
    {
        ...
        {
            typedef qsboost::reference_wrapper<T const> const type;
        };

        template<typename This, typename T>
        struct result<This(T &)>
        {
            typedef qsboost::reference_wrapper<T> const type;
        };
        ...
        /// \throw nothrow
        template<typename T>
        qsboost::reference_wrapper<T> const operator ()(T &t) const
        {
            return qsboost::reference_wrapper<T>(t);
        }

        /// \overload
        ///
        template<typename T>
        qsboost::reference_wrapper<T const> const operator ()(T const &t) const
        {
            return qsboost::reference_wrapper<T const>(t);
        }
    };
    ...
    struct _byval : callable
    {
        ...
        template<typename This, typename T>
        struct result<This(qsboost::reference_wrapper<T>)>
          : result<This(T)>
        {};
        ...
        ///
        template<typename T>
        T operator ()(qsboost::reference_wrapper<T> const &t) const
        {
            return t;
        }
    };
