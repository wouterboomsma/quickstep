...
#ifndef QSBOOST_PROTO_TRANSFORM_CALL_HPP_EAN_11_02_2007
#define QSBOOST_PROTO_TRANSFORM_CALL_HPP_EAN_11_02_2007
...
#include <qsboost/proto/detail/as_lvalue.hpp>
...
namespace qsboost { namespace proto
{
    ...
    struct call<Fun()> : transform<call<Fun()> >
    {
        ...
        {
            typedef typename QSBOOST_PROTO_RESULT_OF<Fun()>::type result_type;
    ...
    #include <qsboost/proto/transform/detail/call.hpp>
