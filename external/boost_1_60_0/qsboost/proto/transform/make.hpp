...
#ifndef QSBOOST_PROTO_TRANSFORM_MAKE_HPP_EAN_12_02_2007
#define QSBOOST_PROTO_TRANSFORM_MAKE_HPP_EAN_12_02_2007
...
namespace qsboost { namespace proto
{
    namespace detail
    {
        ...
        template<
          ...
          , typename Expr, typename State, typename Data
            QSBOOST_PROTO_TEMPLATE_ARITY_PARAM(long Arity = detail::template_arity<R>::value)
        >
        struct make_
        {
            typedef R type;
        ...
        struct construct_
        {
            ...
            #include <qsboost/proto/transform/detail/construct_funop.hpp>
        };
        ...
        struct construct_<Type, true>
        {
            ...
            // Other overloads generated by the preprocessor
            #include <qsboost/proto/transform/detail/construct_pod_funop.hpp>
        };
    ...
    #include <qsboost/proto/transform/detail/make.hpp>
    #include <qsboost/proto/transform/detail/make_gcc_workaround.hpp>
