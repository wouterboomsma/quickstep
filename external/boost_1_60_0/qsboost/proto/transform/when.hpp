...
#ifndef QSBOOST_PROTO_TRANSFORM_WHEN_HPP_EAN_10_29_2007
#define QSBOOST_PROTO_TRANSFORM_WHEN_HPP_EAN_10_29_2007
...
namespace qsboost { namespace proto
{
    ...
    namespace envns_
    {
        ...
        QSBOOST_PROTO_DEFINE_ENV_VAR(transforms_type, transforms);
    }
    ...
    /// \endcode
    template<QSBOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(QSBOOST_MPL_LIMIT_MAP_SIZE, typename T, mpl::na)>
    struct external_transforms
    {
        typedef mpl::map<QSBOOST_PP_ENUM_PARAMS(QSBOOST_MPL_LIMIT_MAP_SIZE, T)> map_type;
    ...
    #include <qsboost/proto/transform/detail/when.hpp>
