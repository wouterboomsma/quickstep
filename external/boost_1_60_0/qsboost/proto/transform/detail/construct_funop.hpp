    ...
    #include <qsboost/proto/transform/detail/preprocessed/construct_funop.hpp>
    ...
    #define QSBOOST_PP_ITERATION_PARAMS_1                                                         \
        (3, (1, QSBOOST_PROTO_MAX_ARITY, <qsboost/proto/transform/detail/construct_funop.hpp>))
    ...
    {
        return Type(QSBOOST_PP_ENUM_PARAMS(N, a));
    }
