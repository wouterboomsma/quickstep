...
#ifndef QSBOOST_PROTO_DOMAIN_HPP_EAN_02_13_2007
#define QSBOOST_PROTO_DOMAIN_HPP_EAN_02_13_2007
...
#include <qsboost/proto/detail/as_expr.hpp>
#include <qsboost/proto/detail/deduce_domain.hpp>
...
namespace qsboost { namespace proto
{
    ...
    ///
    template<typename T>
    struct domain_of<qsboost::reference_wrapper<T>, void>
    {
        typedef typename domain_of<T>::type type;
    };
    ...
    ///
    template<typename T>
    struct domain_of<qsboost::reference_wrapper<T> const, void>
    {
        typedef typename domain_of<T>::type type;
    };
