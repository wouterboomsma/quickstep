...
#ifndef QSBOOST_PROTO_ARG_TRAITS_HPP_EAN_04_01_2005
#define QSBOOST_PROTO_ARG_TRAITS_HPP_EAN_04_01_2005
...
#include <qsboost/proto/detail/template_arity.hpp>
...
namespace qsboost { namespace proto
{
    namespace detail
    {
        ...
        template<typename T QSBOOST_PROTO_TEMPLATE_ARITY_PARAM(long Arity = qsboost::proto::detail::template_arity<T>::value)>
        struct is_callable_
          : is_callable2_<T>
        {};
      ...
      : proto::transform<terminal<T>, int>
    {
        ...
        struct impl : transform_impl<Expr, State, Data>
        {
            ...
            /// \throw nothrow
            QSBOOST_FORCEINLINE
            QSBOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(result_type, typename impl::expr_param)
            operator ()(
...
#define QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(Op)                                               \
    template<typename T>                                                                        \
    struct Op                                                                                   \
...
#define QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(Op)                                              \
    ...
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(unary_plus)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(negate)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(dereference)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(complement)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(address_of)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(logical_not)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(pre_inc)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(pre_dec)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(post_inc)
    QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION(post_dec)

    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_left)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_right)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(multiplies)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(divides)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(modulus)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(plus)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(minus)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(less)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(greater)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(less_equal)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(greater_equal)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(equal_to)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(not_equal_to)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(logical_or)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(logical_and)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_or)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_and)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_xor)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(comma)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(mem_ptr)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_left_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_right_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(multiplies_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(divides_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(modulus_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(plus_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(minus_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_or_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_and_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_xor_assign)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(subscript)
    QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION(member)

    #undef QSBOOST_PROTO_DEFINE_UNARY_METAFUNCTION
    #undef QSBOOST_PROTO_DEFINE_BINARY_METAFUNCTION

    #include <qsboost/proto/detail/traits.hpp>
    ...
    as_expr(T &t QSBOOST_PROTO_DISABLE_IF_IS_CONST(T) QSBOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
    {
    ...
    as_child(T &t QSBOOST_PROTO_DISABLE_IF_IS_CONST(T) QSBOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
    {
    ...
    QSBOOST_FORCEINLINE
    typename result_of::child<Expr &, N>::type
    child(Expr &e QSBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return result_of::child<Expr &, N>::call(e);
    }
    ...
    child(Expr2 &expr2 QSBOOST_PROTO_DISABLE_IF_IS_CONST(Expr2))
    {
    ...
    QSBOOST_FORCEINLINE
    typename result_of::child_c<Expr &, N>::type
    child_c(Expr &e QSBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return result_of::child_c<Expr &, N>::call(e);
    }
    ...
    QSBOOST_FORCEINLINE
    typename result_of::value<Expr &>::type
    value(Expr &e QSBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return e.proto_base().child0;
    }
    ...
    QSBOOST_FORCEINLINE
    typename result_of::left<Expr &>::type
    left(Expr &e QSBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return e.proto_base().child0;
    }
    ...
    QSBOOST_FORCEINLINE
    typename result_of::right<Expr &>::type
    right(Expr &e QSBOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
    {
        return e.proto_base().child1;
    }
