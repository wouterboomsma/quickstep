...
#ifndef QSBOOST_PROTO_MAKE_EXPR_HPP_EAN_04_01_2005
#define QSBOOST_PROTO_MAKE_EXPR_HPP_EAN_04_01_2005
...
#include <qsboost/proto/detail/deprecated.hpp>
...
#define QSBOOST_PROTO_AS_CHILD_TYPE(Z, N, DATA)                                                   \
    typename qsboost::proto::detail::protoify<                                                    \
        QSBOOST_PP_CAT(QSBOOST_PP_TUPLE_ELEM(3, 0, DATA), N)                                        \
      , QSBOOST_PP_TUPLE_ELEM(3, 2, DATA)                                                         \
    >::result_type                                                                              \
    /**/
...
#define QSBOOST_PROTO_AS_CHILD(Z, N, DATA)                                                        \
    qsboost::proto::detail::protoify<                                                             \
        QSBOOST_PP_CAT(QSBOOST_PP_TUPLE_ELEM(3, 0, DATA), N)                                        \
      , QSBOOST_PP_TUPLE_ELEM(3, 2, DATA)                                                         \
    >()(QSBOOST_PP_CAT(QSBOOST_PP_TUPLE_ELEM(3, 1, DATA), N))                                       \
    /**/
    ...
    namespace detail
    {
        ...
        template<typename T, typename Domain>
        struct protoify<qsboost::reference_wrapper<T>, Domain>
          : Domain::template as_child<T>
        {};

        template<typename T, typename Domain>
        struct protoify<qsboost::reference_wrapper<T> const, Domain>
          : Domain::template as_child<T>
        {};

        // Definition of detail::unpack_expr_
        #include <qsboost/proto/detail/unpack_expr_.hpp>

        // Definition of detail::make_expr_
        #include <qsboost/proto/detail/make_expr_.hpp>
    }
    ...
    namespace result_of
    {
        ...
        template<
            typename Tag
          , QSBOOST_PP_ENUM_PARAMS(QSBOOST_PROTO_MAX_ARITY, typename A)
          , typename Void1  // = void
          , typename Void2  // = void
        >
        struct make_expr
        {
            ...
            typedef
                typename detail::make_expr_<
                    Tag
                  , deduce_domain
                    QSBOOST_PP_ENUM_TRAILING_PARAMS(QSBOOST_PROTO_MAX_ARITY, A)
                >::result_type
            type;
        };
        ...
        template<
            typename Tag
          , typename Domain
            QSBOOST_PP_ENUM_TRAILING_PARAMS(QSBOOST_PROTO_MAX_ARITY, typename A)
        >
        struct make_expr<
            Tag
          , Domain
    ...
    namespace functional
    {
        ...
        struct make_expr
        {
            ...
            #include <qsboost/proto/detail/make_expr_funop.hpp>
    ...
    // Additional overloads generated by the preprocessor...
    #include <qsboost/proto/detail/make_expr.hpp>
