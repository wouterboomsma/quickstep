...
#ifndef QSBOOST_PROTO_DETAIL_DECLTYPE_HPP_EAN_04_04_2008
#define QSBOOST_PROTO_DETAIL_DECLTYPE_HPP_EAN_04_04_2008
...
#if !defined(QSBOOST_NO_CXX11_DECLTYPE) && !QSBOOST_WORKAROUND(QSBOOST_MSVC, QSBOOST_TESTED_AT(1700))
# define QSBOOST_PROTO_DECLTYPE_(EXPR, TYPE) typedef decltype((EXPR)) TYPE;
#else
# define QSBOOST_PROTO_DECLTYPE_NESTED_TYPEDEF_TPL_(NESTED, EXPR)                                     \
    QSBOOST_TYPEOF_NESTED_TYPEDEF_TPL(QSBOOST_PP_CAT(nested_and_hidden_, NESTED), EXPR)                 \
    static int const QSBOOST_PP_CAT(sz, NESTED) = sizeof(qsboost::proto::detail::check_reference(EXPR));\
    struct NESTED                                                                                   \
      : qsboost::mpl::if_c<                                                                           \
            1 == QSBOOST_PP_CAT(sz, NESTED)                                                           \
          , typename QSBOOST_PP_CAT(nested_and_hidden_, NESTED)::type &                               \
          , typename QSBOOST_PP_CAT(nested_and_hidden_, NESTED)::type                                 \
        >                                                                                           \
    {};
# define QSBOOST_PROTO_DECLTYPE_(EXPR, TYPE)                                                          \
    QSBOOST_PROTO_DECLTYPE_NESTED_TYPEDEF_TPL_(QSBOOST_PP_CAT(nested_, TYPE), (EXPR))                   \
    typedef typename QSBOOST_PP_CAT(nested_, TYPE)::type TYPE;
#endif
...
namespace qsboost { namespace proto
{
    namespace detail
    {
        ...
        #include <qsboost/proto/detail/class_member_traits.hpp>
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        #define QSBOOST_PROTO_USE_GET_POINTER()                                                       \
        using namespace qsboost::proto::detail::get_pointerns                                         \
        /**/

        #define QSBOOST_PROTO_GET_POINTER(Type, Obj)                                                  \
        qsboost::proto::detail::proto_get_pointer<Type>(                                              \
            qsboost::proto::detail::lvalue(Obj)                                                       \
          , (true ? 0 : get_pointer(Obj))                                                           \
          , (true ? 0 : qsboost::addressof(qsboost::proto::detail::lvalue(Obj)))                        \
        )                                                                                           \
        /**/
        ...
        namespace get_pointerns
        {
            ...
            struct result_of_<T U::*(V), typename enable_if_c<is_member_object_pointer<T U::*>::value>::type>
            {
                ...
                static const bool is_ptr_to_const = 2 == sizeof(test_ptr_to_const(QSBOOST_PROTO_GET_POINTER(U, make<V>())));
            ...
            struct mem_ptr_fun<T, U, true>
            {
                ...
                QSBOOST_PROTO_DECLTYPE_(
                    QSBOOST_PROTO_GET_POINTER(V, proto::detail::make_mutable<T>()) ->* proto::detail::make<U>()
                  , result_type
                )
                ...
                {
                    return QSBOOST_PROTO_GET_POINTER(V, t) ->* u;
                }
            };
        }
        ...
        struct comma_result
        {
            QSBOOST_PROTO_DECLTYPE_((proto::detail::make<A0>(), proto::detail::make<A1>()), type)
        };
        ...
        struct memfun
        {
            ...
            result_type operator()() const
            {
                ...
                return (QSBOOST_PROTO_GET_POINTER(V, obj) ->* pmf)();
            }

            // Other overloads generated by the preprocessor
            #include <qsboost/proto/detail/memfun_funop.hpp>
