    ...
    #include <qsboost/proto/detail/preprocessed/vararg_matches_impl.hpp>
    ...
    #define QSBOOST_PP_ITERATION_PARAMS_1                                                             \
        (3, (2, QSBOOST_PROTO_MAX_ARITY, <qsboost/proto/detail/vararg_matches_impl.hpp>))
    ...
    struct vararg_matches_impl<Args, Back, N, To>
      : and_2<
            matches_<
                typename detail::expr_traits<typename Args::QSBOOST_PP_CAT(child, QSBOOST_PP_DEC(N))>::value_type::proto_derived_expr
              , typename detail::expr_traits<typename Args::QSBOOST_PP_CAT(child, QSBOOST_PP_DEC(N))>::value_type::proto_grammar
              , Back
            >::value
