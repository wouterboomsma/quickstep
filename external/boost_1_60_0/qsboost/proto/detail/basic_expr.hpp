    ...
    #include <qsboost/proto/detail/preprocessed/basic_expr.hpp>
    ...
    #define QSBOOST_PP_ITERATION_PARAMS_1 (3, (0, 0, <qsboost/proto/detail/basic_expr.hpp>))
    #include QSBOOST_PP_ITERATE()

    #undef QSBOOST_PROTO_DEFINE_TERMINAL
    #define QSBOOST_PP_ITERATION_PARAMS_1 (3, (1, QSBOOST_PROTO_MAX_ARITY, <qsboost/proto/detail/basic_expr.hpp>))
    #include QSBOOST_PP_ITERATE()
    ...
    struct basic_expr<Tag, QSBOOST_PP_CAT(list, QSBOOST_PP_ITERATION())<QSBOOST_PP_ENUM_PARAMS(ARG_COUNT, Arg)>, QSBOOST_PP_ITERATION() >
    #endif
    {
        ...
        QSBOOST_FORCEINLINE
        static basic_expr const make(QSBOOST_PP_ENUM_BINARY_PARAMS(ARG_COUNT, A, const &a))
        {
            basic_expr that = {QSBOOST_PP_ENUM_PARAMS(ARG_COUNT, a)};
            return that;
        }
    #endif
