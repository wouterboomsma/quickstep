...
#ifndef QSBOOST_PROTO_DEDUCE_DOMAIN_HPP_EAN_05_22_2010
#define QSBOOST_PROTO_DEDUCE_DOMAIN_HPP_EAN_05_22_2010
...
#ifndef QSBOOST_PROTO_ASSERT_VALID_DOMAIN
# define QSBOOST_PROTO_ASSERT_VALID_DOMAIN(DOM) QSBOOST_MPL_ASSERT_NOT((qsboost::is_same<DOM, qsboost::proto::detail::not_a_domain>))
#endif
...
namespace qsboost
{
    namespace proto
    {
        namespace detail
        {
            ...
            #include <qsboost/proto/detail/deduce_domain_n.hpp>
        }
    }
}
