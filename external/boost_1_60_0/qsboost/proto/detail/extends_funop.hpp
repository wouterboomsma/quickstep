    ...
    #else
        #include <qsboost/proto/detail/preprocessed/extends_funop.hpp>
    #endif

#else

    #define QSBOOST_PP_LOCAL_MACRO(N)                                                                 \
        QSBOOST_PROTO_DEFINE_FUN_OP(1, N, ~)                                                          \
        /**/

    #if defined(__WAVE__) && defined(QSBOOST_PROTO_CREATE_PREPROCESSED_FILES) && !defined(QSBOOST_PROTO_NO_WAVE_OUTPUT)
