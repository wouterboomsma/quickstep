...
#ifndef QSBOOST_PROTO_FUNCTIONAL_STD_ITERATOR_HPP_EAN_27_08_2012
#define QSBOOST_PROTO_FUNCTIONAL_STD_ITERATOR_HPP_EAN_27_08_2012
...
namespace qsboost { namespace proto { namespace functional
{
        ...
        struct result<This(InputIter1, InputIter2)>
        {
            typedef
                typename std::iterator_traits<
                    typename qsboost::remove_const<
                        typename qsboost::remove_reference<InputIter1>::type
                    >::type
                >::difference_type
            type;
        };
    ...
    struct next
    {
        ...
        struct result<This(ForwardIterator)>
        {
            typedef
                typename qsboost::remove_const<
                    typename qsboost::remove_reference<ForwardIterator>::type
                >::type
            type;
        };
    ...
    struct prior
    {
        ...
        struct result<This(BidirectionalIterator)>
        {
            typedef
                typename qsboost::remove_const<
                    typename qsboost::remove_reference<BidirectionalIterator>::type
                >::type
            type;
        };
