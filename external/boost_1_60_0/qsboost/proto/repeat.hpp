...
#ifndef QSBOOST_PROTO_REPEAT_HPP_EAN_11_24_2008
#define QSBOOST_PROTO_REPEAT_HPP_EAN_11_24_2008
...
#include <qsboost/proto/proto_fwd.hpp> // for BOOST_PROTO_MAX_ARITY

////////////////////////////////////////////
/// INTERNAL ONLY
#define QSBOOST_PROTO_ref_a_aux(Z, N, DATA)\
  qsboost::ref(QSBOOST_PP_CAT(proto_a, N))

/// \brief Generates a sequence like <tt>typename A0, typename A1, ...</tt>
///
#define QSBOOST_PROTO_typename_A(N)\
  QSBOOST_PP_ENUM_PARAMS(N, typename proto_A)

/// \brief Generates a sequence like <tt>A0 const &, A1 const &, ...</tt>
///
#define QSBOOST_PROTO_A_const_ref(N)\
  QSBOOST_PP_ENUM_BINARY_PARAMS(N, proto_A, const & QSBOOST_PP_INTERCEPT)

/// \brief Generates a sequence like <tt>A0 &, A1 &, ...</tt>
///
#define QSBOOST_PROTO_A_ref(N)\
  QSBOOST_PP_ENUM_BINARY_PARAMS(N, proto_A, & QSBOOST_PP_INTERCEPT)

/// \brief Generates a sequence like <tt>A0, A1, ...</tt>
///
#define QSBOOST_PROTO_A(N)\
  QSBOOST_PP_ENUM_PARAMS(N, proto_A)

/// \brief Generates a sequence like <tt>A0 const, A1 const, ...</tt>
///
#define QSBOOST_PROTO_A_const(N)\
  QSBOOST_PP_ENUM_PARAMS(N, const proto_A)

/// \brief Generates a sequence like <tt>A0 const &a0, A1 const &a0, ...</tt>
///
#define QSBOOST_PROTO_A_const_ref_a(N)\
  QSBOOST_PP_ENUM_BINARY_PARAMS(N, proto_A, const &proto_a)

/// \brief Generates a sequence like <tt>A0 &a0, A1 &a0, ...</tt>
///
#define QSBOOST_PROTO_A_ref_a(N)\
  QSBOOST_PP_ENUM_BINARY_PARAMS(N, proto_A, &proto_a)

/// \brief Generates a sequence like <tt>boost::ref(a0), boost::ref(a1), ...</tt>
///
#define QSBOOST_PROTO_ref_a(N)\
  QSBOOST_PP_ENUM(N, QSBOOST_PROTO_ref_a_aux, ~)
...
////////////////////////////////////////////
/// INTERNAL ONLY
#define QSBOOST_PROTO_invoke(Z, N, DATA)\
  QSBOOST_PP_TUPLE_ELEM(5,0,DATA)(N, QSBOOST_PP_TUPLE_ELEM(5,1,DATA), QSBOOST_PP_TUPLE_ELEM(5,2,DATA), QSBOOST_PP_TUPLE_ELEM(5,3,DATA), QSBOOST_PP_TUPLE_ELEM(5,4,DATA))
...
/// \endcode
#define QSBOOST_PROTO_REPEAT_FROM_TO_EX(FROM, TO, MACRO, typename_A, A, A_a, a)\
  QSBOOST_PP_REPEAT_FROM_TO(FROM, TO, QSBOOST_PROTO_invoke, (MACRO, typename_A, A, A_a, a))
...
/// \endcode
#define QSBOOST_PROTO_REPEAT_FROM_TO(FROM, TO, MACRO)\
  QSBOOST_PROTO_REPEAT_FROM_TO_EX(FROM, TO, MACRO, QSBOOST_PROTO_typename_A, QSBOOST_PROTO_A_const_ref, QSBOOST_PROTO_A_const_ref_a, QSBOOST_PROTO_ref_a)
...
/// \endcode
#define QSBOOST_PROTO_REPEAT_EX(MACRO, typename_A, A, A_a, a)\
  QSBOOST_PROTO_REPEAT_FROM_TO_EX(1, QSBOOST_PP_INC(QSBOOST_PROTO_MAX_ARITY), MACRO, QSBOOST_PROTO_typename_A, QSBOOST_PROTO_A_const_ref, QSBOOST_PROTO_A_const_ref_a, QSBOOST_PROTO_ref_a)
...
/// \endcode
#define QSBOOST_PROTO_REPEAT(MACRO)\
  QSBOOST_PROTO_REPEAT_FROM_TO(1, QSBOOST_PP_INC(QSBOOST_PROTO_MAX_ARITY), MACRO)
...
/// \li BOOST_PROTO_LOCAL_A_a
/// \li BOOST_PROTO_LOCAL_a
#define QSBOOST_PROTO_LOCAL_ITERATE() <qsboost/proto/detail/local.hpp>
